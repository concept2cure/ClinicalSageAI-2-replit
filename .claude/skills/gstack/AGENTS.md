...
- `concept2cure-v2` is the only repository branch. Every agent, skill, worktree,
  commit, and push must use it; never create or maintain feature or agent branches.
