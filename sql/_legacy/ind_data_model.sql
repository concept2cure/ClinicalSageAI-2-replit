-- ============================================================================
-- ARCHIVED 2026-09-10 (WO-1, ADR-0006) — a IND data-model dump on NO applier.
-- ============================================================================
-- This file defined `ind_cross_references` a second time. It was never applied by anything:
...
-- of the file.
--
-- The canonical creator is migrations/20260614_ind_cross_references.sql,
-- which is on install-fresh. That was not taken on trust: `ind_cross_references`
