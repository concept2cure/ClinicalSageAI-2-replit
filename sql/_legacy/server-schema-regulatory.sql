...
--
-- Defined a second time here: see db/migrations/_legacy/README.md
-- Real creator: nothing — every table it defines exists on no database, and the file has zero references from any .ts/.js/.mjs/.sh/.yml
--
