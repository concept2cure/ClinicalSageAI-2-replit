/* global React, I, AUDIT_KIND_META, PATHWAY_TABS_DATA, K510_ESTAR */
...
/* ─────────────────────────────────────────────────────────────
   ...
   ───────────────────────────────────────────────────────────── */
function AuditTrailPane({ pathway, events, onOpenSection }) {
...
function CorrespondencePane({ pathway, items, onOpenSection, onAskAna, onDraftResponse }) {
  ...
  const corrLabel = PATHWAY_TABS_DATA[pathway].corrLabel;
