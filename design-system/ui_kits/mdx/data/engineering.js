...
window.ENG_RISK_SEVERITY = ENG_RISK_SEVERITY;
window.ENG_RISK_PROB = ENG_RISK_PROB;
window.ENG_RISK_ACCEPT = ENG_RISK_ACCEPT;
window.ENG_RISKS = ENG_RISKS;
window.ENG_ECRS = ENG_ECRS;
window.ENG_ISSUES = ENG_ISSUES;
