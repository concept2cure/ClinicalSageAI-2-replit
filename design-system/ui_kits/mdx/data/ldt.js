...
window.LDT_PHASES = LDT_PHASES;
window.LDT_KPIS = LDT_KPIS;
window.LDT_INVENTORY = LDT_INVENTORY;
window.LDT_MILESTONES = LDT_MILESTONES;

const LDT_DOC_FRAMEWORKS = [
...
window.LDT_DOC_FRAMEWORKS = LDT_DOC_FRAMEWORKS;
window.LDT_DOCUMENTS = LDT_DOCUMENTS;
