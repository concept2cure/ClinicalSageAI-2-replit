...
window.MEM_CATEGORIES = MEM_CATEGORIES;
window.MEM_IMPORTANCE = MEM_IMPORTANCE;
window.MEM_ATOMS = MEM_ATOMS;
window.MEM_INGEST = MEM_INGEST;
window.MEM_EFFECTS = MEM_EFFECTS;
