...
/** The commit this client bundle was built from — env override first (CI),
 *  then git; 'unknown' when neither answers. Mirrors scripts/build-server.mjs
 *  so the served page and the API report the same checkable fact. */
