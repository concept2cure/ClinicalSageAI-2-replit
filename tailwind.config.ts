  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Tailwind / shadcn semantic colors. Read --shadcn-* tokens
        // (defined in client/src/index.css) so they don't collide with
        // the canonical design-system tokens (--border, --accent, etc.)
        // that the Phase 3 Projects prototype CSS consumes directly.
        // Audit 2026-04-29 found `var(--border)` resolving to an HSL
        // triple that's invalid as a direct color value, breaking
        // borders on Phase 3. Renaming these to --shadcn-* fixes that.
        ...
        sidebar: {
          DEFAULT: 'hsl(var(--shadcn-sidebar-background))',
          foreground: 'hsl(var(--shadcn-sidebar-foreground))',
          primary: 'hsl(var(--shadcn-sidebar-primary))',
          'primary-foreground': 'hsl(var(--shadcn-sidebar-primary-foreground))',
          accent: 'hsl(var(--shadcn-sidebar-accent))',
          'accent-foreground': 'hsl(var(--shadcn-sidebar-accent-foreground))',
          border: 'hsl(var(--shadcn-sidebar-border))',
          ring: 'hsl(var(--shadcn-sidebar-ring))',
        },
      },
      borderRadius: {
