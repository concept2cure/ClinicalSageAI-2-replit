...
0. **An eSTAR with one attachment, added in Acrobat and saved** (added 2026-09-07). The
   single most useful artifact anyone can hand this stream. Open the vendored
