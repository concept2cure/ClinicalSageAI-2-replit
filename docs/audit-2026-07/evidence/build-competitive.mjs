...
S.push('')
S.push('1. **Reachability.** 5 of 96 registered surfaces are in the global navigation (Chapter 09). A capability a buyer cannot click to does not score, however good the code behind it is. Several categories here are scored near-zero on surfaces that demonstrably exist in the codebase.')
