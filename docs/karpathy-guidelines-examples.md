# Karpathy Guidelines — Worked Examples

> Adapted from [forrestchang/andrej-karpathy-skills](https://github.com/forrestchang/andrej-karpathy-skills)
> (MIT License, © 2026 Forrest Chang). Paired with the skill file at
> `.claude/skills/karpathy-coding-discipline.md` and the CLAUDE.md
> "PART A — Karpathy Coding Discipline" section.
