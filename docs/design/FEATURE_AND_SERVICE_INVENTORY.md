...
- **eCTD export (ZIP)** — `ectd-export.ts`, `ectdExportService.ts` · ✅ · ICH M8 v4.0 structure (m1–m5 + STF), SHA-256 · ops: `POST /api/ectd/export/:submissionId` · UI: region/type dialog, validation report, download.
