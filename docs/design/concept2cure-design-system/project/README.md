...
- `ui_kits/home/` — front-door Home screen: 10-item rail, time-of-day greeting + composer, AnA proactive briefing, at-a-glance dashboard, module launcher, domain scope switcher, ⌘K palette
