...
| c2c_evidence_objects | Evidence — object drawer (mounted) | verify pending | sibling blob for the same surface (seed 90-evidence-objects); trace route + consumer next |
