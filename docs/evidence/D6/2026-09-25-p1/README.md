...
| IAM-18 residuals (4)(5)(9)(10) | detector mounted before auth; enterprise sign-in admitted inactive accounts; AI prefixes metered as API; AI-assistance mount ungated | see `git log -- server/services/audit/audit-api-authority.ts` (neighbouring commits) | yes; (6)(7)(8) written up in the folder, (8) then closed with P1-2 part 2, (7) with the IAM-18-7 commit (`IAM-18-7/`: the 50 MB Concept2Cure parser behind the boundary), (6) with the IAM-18-6 commit (`IAM-18-6/`: the SSO session in the URL fragment; SAML replay mode `always`) | `P1-17-residuals/` |
