...
| P1-1 (server half) | IAM-06 no inactivity logoff, no session lifetime; a refresh renewed any session | commit of 2026-09-26 | server half: idle window (tenant-set, 15 min default) and 12-hour lifetime at both authenticators, the verifier and the refresh; client timer, OQ step and concurrent-session limit follow | `P1-1/` |
...
- **Larger items** left with their acceptance tests in the plan: P1-1's client timer, OQ step and concurrent-session
  limit (its server half landed), P1-22 (retention and legal hold), P1-19/P1-24/P1-25 (D5), P1-7/P1-8 (D3), the Terraform and workflow items (W2), the founder's (P1-10, P1-11,
