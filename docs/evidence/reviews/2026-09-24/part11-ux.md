...
| Q5 | gap (V1) | Vault | Filing / "Move to…" confirm captures no reason. Write is audited, atomic, reversible — affordance gap only. | `client/src/concept2cure/v2/surfaces/Vault.tsx:1422-1450` | §11.10(e) | open — a reason field on the filing / move confirm; next in this stream |
