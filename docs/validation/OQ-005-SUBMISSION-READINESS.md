...
## 3. Result of the local execution (2026-09-23, production posture with production authentication — VSR-001 §13)
...
### 3.1 Result of the local execution (2026-09-22, production posture — VSR-001 §12; superseded by the 2026-09-23 execution)
...
### 3.2 Result of the local execution (2026-09-21, version 0.2 — worker WF, superseded)
...
### 3.3 Result of the local execution (2026-09-21, version 0.1 — W3a, superseded)
