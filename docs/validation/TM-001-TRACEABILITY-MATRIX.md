...
|---|---|
| Document ID | TM-001 |
| Version | generated 2026-09-23T16:34:06.717Z |
...
| Sources | URS-001…006 requirement tables · RA-001 rows · docs/evidence/W3/2026-09-23c/OQ-*/result.json · IQ/iq-results.json |
...
- Requirements: **70** — pass 69 · partial 1 · fail 0 · open 0 · uncovered 0
- OQ steps executed: **101** — pass 100 · fail 0 · deviation 1 · not-executed 0
- IQ-001: 12 pass · 0 fail · 3 deviation (executed 2026-09-23T16:27:14.289Z)

| App | Requirements | Pass | Partial | Fail | Open | Uncovered |
|---|---|---|---|---|---|---|
| Projects | 12 | 12 | 0 | 0 | 0 | 0 |
| Vault | 10 | 10 | 0 | 0 | 0 | 0 |
...
|---|---|---|---|---|---|---|---|
| OQ-003 | Authoring | 2026-09-23T16:29:16.569Z | 23 | 0 | 1 | 0 | `docs/evidence/W3/2026-09-23c/OQ-AUTHORING/` |
| OQ-001 | Projects | 2026-09-23T16:27:30.597Z | 19 | 0 | 0 | 0 | `docs/evidence/W3/2026-09-23c/OQ-PROJECTS/` |
| OQ-006 | QMS controlled documents | 2026-09-23T16:30:38.882Z | 20 | 0 | 0 | 0 | `docs/evidence/W3/2026-09-23c/OQ-QMS/` |
| OQ-004 | Submission Center | 2026-09-23T16:29:45.823Z | 15 | 0 | 0 | 0 | `docs/evidence/W3/2026-09-23c/OQ-SUBMISSION-CENTER/` |
| OQ-005 | Submission Readiness | 2026-09-23T16:30:14.457Z | 11 | 0 | 0 | 0 | `docs/evidence/W3/2026-09-23c/OQ-SUBMISSION-READINESS/` |
| OQ-002 | Vault | 2026-09-23T16:29:02.394Z | 12 | 0 | 0 | 0 | `docs/evidence/W3/2026-09-23c/OQ-VAULT/` |
...
| URS-PROJ-004 | Program creation is attributable: the activity feed shows who created it and when, the write is entered in the hash-chained audit log, and the organisation's audit ledger surface shows governed writes. | §11.10(e) | high | scripted | OQ-PROJ-06 (pass)<br>OQ-PROJ-06b (pass) | **pass** |
...
| URS-SUBC-009 | The dossier map answers per-module (M1–M5) completeness for the program open in the shell. | none | medium | scripted | OQ-SUBC-10 (pass) | **pass** |
...
| URS-SRDY-008 | The Orchestration and Inconsistency boards are not in this release: with launch scope enforced, the navigation payload marks both not entitled with source `launch-scope` while the dispatch gate's surface is entitled, and a deep link to either renders the launch-scope gate instead of the board. | §11.10(d) | medium | scripted | OQ-SRDY-08 (pass) | **pass** |
...
| URS-QMS-004 | Approval moves a draft/in-review document to `effective`, stamps approver and approval time, sets the effective date, records an audit row, and is refused (409) for a document not in an approvable state. | §11.10(e) | high | scripted | OQ-QMS-05 (pass)<br>OQ-QMS-06d (pass) | **pass** |
| URS-QMS-005 | Approval of a controlled document is an electronic signature: it verifies a credential the approver alone holds (PIN or password re-authentication), records the signature meaning, and is refused without them. | §11.50 §11.200 | high | scripted (negative) | OQ-QMS-05 (pass)<br>OQ-QMS-05b (pass)<br>OQ-QMS-06 (pass)<br>OQ-QMS-06b (pass)<br>OQ-QMS-06c (pass) | **pass** |
