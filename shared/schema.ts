...
export const sharepoint_files = pgTable('sharepoint_files', {
  id: serial('id').primaryKey(),
...
export const sharepoint_file_versions = pgTable('sharepoint_file_versions', {
  id: serial('id').primaryKey(),
  fileId: integer('file_id').notNull().references(() => sharepoint_files.id),
...
export const sharepoint_audit_log = pgTable('sharepoint_audit_log', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id').notNull().references(() => organizations.id),
  ...
  orgTimestampIdx: index('sharepoint_audit_org_timestamp_idx').on(table.organizationId, table.timestamp),
...
export const sharepoint_comments = pgTable('sharepoint_comments', {
  id: serial('id').primaryKey(),
  fileId: integer('file_id').notNull().references(() => sharepoint_files.id),
...
export const sharepoint_locks = pgTable('sharepoint_locks', {
  id: serial('id').primaryKey(),
  fileId: integer('file_id').notNull().references(() => sharepoint_files.id).unique(),
  userId: text('user_id').notNull(),
  userName: text('user_name').notNull(),
...
export const leafCitations = pgTable('leaf_citations', {
  id: serial('id').primaryKey(),
  leafId: text('leaf_id').notNull().references(() => leaves.leafId),
  factId: text('fact_id').notNull().references(() => facts.factId),
...
export const insertLeafSchema = createInsertSchema(leaves).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertLeafCitationSchema = createInsertSchema(leafCitations).omit({
  id: true,
  createdAt: true,
});

export const insertLeafPatchSchema = createInsertSchema(leafPatches).omit({
  id: true,
  createdAt: true,
});

export const insertValidationFindingSchema = createInsertSchema(validationFindings).omit({
  id: true,
  createdAt: true,
});
...
export const moduleSubscriptions = pgTable('module_subscriptions', {
  ...
  moduleId: text('module_id').notNull().references(() => availableModules.moduleId, { onDelete: 'cascade' }),
...
export const insertAvailableModuleSchema = createInsertSchema(availableModules).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertModuleSubscriptionSchema = createInsertSchema(moduleSubscriptions).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const sectionLinks = pgTable('section_links', {
  id: serial('id').primaryKey(),
  leafId: text('leaf_id').notNull().references(() => leaves.leafId),
  sectionId: text('section_id').notNull().references(() => sections.sectionId),
  organizationId: integer('organization_id').references(() => organizations.id),
  projectId: integer('project_id'),
...
export const sectionPatches = pgTable('section_patches', {
  id: serial('id').primaryKey(),
  sectionId: text('section_id').notNull().references(() => sections.sectionId),
...
export const sectionPropagations = pgTable('section_propagations', {
  id: serial('id').primaryKey(),
...
export const insertSectionLinkSchema = createInsertSchema(sectionLinks).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertSectionPatchSchema = createInsertSchema(sectionPatches).omit({
  id: true,
  createdAt: true,
});

export const insertSectionPropagationSchema = createInsertSchema(sectionPropagations).omit({
  id: true,
  scheduledAt: true,
});
...
export const supplyChainSuppliers = pgTable('supply_chain_suppliers', {
  id: serial('id').primaryKey(),
  ...
  qualificationStatus: varchar('qualification_status', { length: 50 }).default('pending').notNull(), // pending, qualified, disqualified, suspended
  ...
  supplierCodeOrg: uniqueIndex('supplier_code_org_idx').on(table.supplierCode, table.organizationId),
  qualificationStatusIdx: index('supplier_qualification_status_idx').on(table.qualificationStatus),
...
export const supplyChainMaterials = pgTable('supply_chain_materials', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  ...
  materialCodeOrg: uniqueIndex('material_code_org_idx').on(table.materialCode, table.organizationId),
...
export const supplyChainBatches = pgTable('supply_chain_batches', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const insertClientWorkspaceSettingsSchema = createInsertSchema(clientWorkspaceSettings).omit(
  {
    id: true,
    createdAt: true,
    updatedAt: true,
...
export const insertClientSecuritySettingsSchema = createInsertSchema(clientSecuritySettings).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const documents = pgTable('documents', {
  ...
  documentCodeOrg: uniqueIndex('document_code_org_idx').on(table.documentCode, table.organizationId),
...
export const documentVersions = pgTable('document_versions', {
  ...
  documentVersionIdx: uniqueIndex('document_version_idx').on(table.documentId, table.versionNumber),
...
export const insertDocumentSessionSchema = createInsertSchema(documentSessions).omit({
  id: true,
  startedAt: true,
  lastActivityAt: true,
});
...
export const insertUserFollowingSchema = createInsertSchema(userFollowing).omit({
  id: true,
  followedAt: true,
});
...
export const cerv2510kSections = pgTable('cerv2_510k_sections', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const cerv2SectionVersions = pgTable('cerv2_section_versions', {
  id: serial('id').primaryKey(),
...
export const cerv2DocumentSessions = pgTable('cerv2_document_sessions', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const deviceSubmissionDocuments = pgTable('device_submission_documents', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  ...
  submissionDocIdx: index('device_docs_submission_idx').on(table.submissionType, table.submissionId),
  statusDocIdx: index('device_docs_status_idx').on(table.status),
}));

// Medical Device Workflow Tracking
export const deviceSubmissionWorkflows = pgTable('device_submission_workflows', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  ...
  submissionWorkflowIdx: index('device_workflow_submission_idx').on(table.submissionType, table.submissionId),
}));

// 21 CFR Part 11 Audit Trail for Medical Devices
export const deviceAuditTrail = pgTable('device_audit_trail', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const dataLineageTracking = pgTable('data_lineage_tracking', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const fdaIntegrationLogs = pgTable('fda_integration_logs', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const insertStabilityStudySchema = createInsertSchema(stabilityStudies).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertQcTestingSchema = createInsertSchema(qcTesting).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCmcChangeControlSchema = createInsertSchema(cmcChangeControl).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertDrugSubstanceSchema = createInsertSchema(drugSubstances).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertDrugProductSchema = createInsertSchema(drugProducts).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertSimpleDocumentVersionSchema = createInsertSchema(simpleDocumentVersions).omit({
  id: true,
  createdAt: true,
});
...
export const insertCerReportSchema = createInsertSchema(cerReports).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCerSectionSchema = createInsertSchema(cerSections).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCerFaersDataSchema = createInsertSchema(cerFaersData).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCerLiteratureSchema = createInsertSchema(cerLiterature).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCerComplianceCheckSchema = createInsertSchema(cerComplianceChecks).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCerWorkflowSchema = createInsertSchema(cerWorkflows).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCerExportSchema = createInsertSchema(cerExports).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCroClientSchema = createInsertSchema(croClients).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCroStudySchema = createInsertSchema(croStudies).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCroRegulatorySubmissionSchema = createInsertSchema(
...
export const insertCroTeamAssignmentSchema = createInsertSchema(croTeamAssignments).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCroMilestoneSchema = createInsertSchema(croMilestones).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertSimpleDocumentSchema = createInsertSchema(simpleDocuments).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
 ...
 */
export const unifiedTasks = pgTable('unified_tasks', {
  id: serial('id').primaryKey(),
...
export const insertUnifiedTaskSchema = createInsertSchema(unifiedTasks).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
 ...
 */
export const crossModuleTaskLinks = pgTable('cross_module_task_links', {
  id: serial('id').primaryKey(),
...
export const insertCrossModuleTaskLinkSchema = createInsertSchema(crossModuleTaskLinks).omit({
  id: true,
  createdAt: true,
});
...
export const insertTaskAutomationSchema = createInsertSchema(taskAutomation).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertRecentDocumentSchema = createInsertSchema(recentDocuments).omit({
  id: true,
  createdAt: true,
});
...
export const insertMultiAgencyValidationSessionSchema = createInsertSchema(
...
export const insertAgencyValidationResultSchema = createInsertSchema(agencyValidationResults).omit({
  id: true,
  createdAt: true,
});
...
export const insertValidationHarmonizationOpportunitySchema = createInsertSchema(
...
export const insertObligationUpdateSchema = createInsertSchema(obligationUpdates).omit({
  id: true,
  createdAt: true,
});

export const insertAgencyCommunicationSchema = createInsertSchema(agencyCommunications).omit({
  id: true,
  createdAt: true,
});
...
export const insertRegObligationSchema = createInsertSchema(regObligations).omit({
  oblId: true,
  createdAt: true,
  updatedAt: true,
});

export const insertRegObligationEventSchema = createInsertSchema(regObligationEvents).omit({
  evtId: true,
  createdAt: true,
});

export const insertRegObligationTemplateSchema = createInsertSchema(regObligationTemplates).omit({
  tplId: true,
});
...
// DOE Insert Schemas
export const insertDoeStudySchema = createInsertSchema(doeStudies).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertDoeFactorSchema = createInsertSchema(doeFactors).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertDoeResponseSchema = createInsertSchema(doeResponses).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertDoeExperimentSchema = createInsertSchema(doeExperiments).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertDoeAnalysisResultSchema = createInsertSchema(doeAnalysisResults).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertSupplyChainOrganizationSchema = createInsertSchema(supplyChainOrganizations).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const batchGenealogy = pgTable(
  ...
  table => {
    return {
      ...
      uniqueRelation: uniqueIndex('batch_genealogy_unique').on(table.childBatchId, table.parentBatchId),
    };
  }
);

// Batch Genealogy Insert Schema
export const insertBatchGenealogySchema = createInsertSchema(batchGenealogy).omit({
  id: true,
  createdAt: true,
});
...
export const supplyChainShipments = pgTable('supply_chain_shipments', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  ...
  destinationSupplierId: integer('destination_supplier_id').references(() => supplyChainSuppliers.id),
  ...
  shipmentNumberOrg: uniqueIndex('shipment_number_org_idx').on(table.shipmentNumber, table.organizationId),
...
export const supplyChainTemperatureReadings = pgTable('supply_chain_temperature_readings', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  ...
  shipmentTimeIdx: index('temp_reading_shipment_time_idx').on(table.shipmentId, table.readingTime),
...
export const supplyChainCOAs = pgTable('supply_chain_coas', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const deviations = pgTable('deviations', {
  ...
  deviationNumberOrg: uniqueIndex('deviation_number_org_idx').on(table.deviationNumber, table.organizationId),
...
export const auditEvents = pgTable('audit_events', {
  ...
  entityEventIdx: index('audit_entity_event_idx').on(table.entityType, table.entityId, table.eventType),
...
export const regulatoryAgencies = pgTable('regulatory_agencies', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const agencyCorrespondence = pgTable('agency_correspondence', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  submissionId: integer('submission_id')
    .references(() => regulatorySubmissions.id),
  ...
  correspondenceNumberOrg: uniqueIndex('correspondence_number_org_idx').on(table.correspondenceNumber, table.organizationId),
...
export const regulatoryChangeControl = pgTable('regulatory_change_control', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  ...
  changeControlNumberOrg: uniqueIndex('change_control_number_org_idx').on(table.changeControlNumber, table.organizationId),
...
export const postApprovalCommitments = pgTable('post_approval_commitments', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  ...
  commitmentNumberOrg: uniqueIndex('commitment_number_org_idx').on(table.commitmentNumber, table.organizationId),
...
export const regulatoryCalendar = pgTable('regulatory_calendar', {
  ...
  commitmentId: integer('commitment_id')
    .references(() => postApprovalCommitments.id),
  priority: varchar('priority', { length: 20 }).default('medium'),
...
export const regAttachments = pgTable('reg_attachments', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  correspondenceId: integer('correspondence_id')
    .references(() => agencyCorrespondence.id),
  ...
  correspondenceAttachmentIdx: index('reg_attachment_correspondence_idx').on(table.correspondenceId),
...
export const regQuestions = pgTable('reg_questions', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const regResponses = pgTable('reg_responses', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
// Insert Schemas
export const insertRegAttachmentSchema = createInsertSchema(regAttachments).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertRegQuestionSchema = createInsertSchema(regQuestions).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertRegResponseSchema = createInsertSchema(regResponses).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertRegMessageSchema = createInsertSchema(regMessages).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const indPackagePlans = pgTable('ind_package_plans', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const indPackagePlanRegions = pgTable('ind_package_plan_regions', {
  id: serial('id').primaryKey(),
...
export const indPackagePlanModalities = pgTable('ind_package_plan_modalities', {
  id: serial('id').primaryKey(),
  planId: integer('plan_id')
    .notNull()
    .references(() => indPackagePlans.id),
  ...
  complexityMultiplier: decimal('complexity_multiplier', { precision: 3, scale: 2 }).default('1.0'),
...
export const indPackagePlanRequirements = pgTable('ind_package_plan_requirements', {
  id: serial('id').primaryKey(),
  planId: integer('plan_id')
    .notNull()
    .references(() => indPackagePlans.id),
...
export const indPackagePlanTimelines = pgTable('ind_package_plan_timelines', {
  id: serial('id').primaryKey(),
  planId: integer('plan_id')
    .notNull()
    .references(() => indPackagePlans.id),
...
export const indPackagePlanDocuments = pgTable('ind_package_plan_documents', {
  id: serial('id').primaryKey(),
  planId: integer('plan_id')
    .notNull()
    .references(() => indPackagePlans.id),
  ...
  regionModalityIdx: index('document_region_modality_idx').on(table.regionCode, table.modalityCode),
}));

// Insert Schemas for Package Planning
export const insertIndPackagePlanSchema = createInsertSchema(indPackagePlans).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertIndPackagePlanRegionSchema = createInsertSchema(indPackagePlanRegions).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertIndPackagePlanModalitySchema = createInsertSchema(indPackagePlanModalities).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertIndPackagePlanRequirementSchema = createInsertSchema(indPackagePlanRequirements).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertIndPackagePlanTimelineSchema = createInsertSchema(indPackagePlanTimelines).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertIndPackagePlanDocumentSchema = createInsertSchema(indPackagePlanDocuments).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const sectionGraphNodes = pgTable('section_graph_nodes', {
  id: serial('id').primaryKey(),
  slug: text('slug').notNull().unique(),
  title: text('title').notNull(),
...
export const sectionLeaves = pgTable('section_leaves', {
  id: serial('id').primaryKey(),
...
export const linkEdges = pgTable('link_edges', {
  id: serial('id').primaryKey(),
...
export const insertSectionGraphNodeSchema = createInsertSchema(sectionGraphNodes).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertSectionLeafSchema = createInsertSchema(sectionLeaves).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertLinkEdgeSchema = createInsertSchema(linkEdges).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
 ...
 */
export const indProjects = pgTable('ind_projects', {
  id: serial('id').primaryKey(),
 ...
 */
export const indTemplates = pgTable('ind_templates', {
  id: serial('id').primaryKey(),
  templateId: text('template_id').notNull().unique(),
  organizationId: integer('organization_id')
    .references(() => organizations.id),
 ...
 */
export const indSubmissions = pgTable('ind_submissions', {
  id: serial('id').primaryKey(),
...
export const coauthorSections = pgTable('coauthor_sections', {
  ...
  sectionOrgUnique: uniqueIndex('coauthor_section_lookup_idx').on(table.sectionId, table.organizationId),
}));

export const coauthorAnnotations = pgTable('coauthor_annotations', {
  id: serial('id').primaryKey(),
  sectionId: integer('section_id')
    .notNull()
 ...
 */
export const coauthorDocuments = pgTable('coauthor_documents', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
 ...
 */
export const coauthorDocumentVersions = pgTable('coauthor_document_versions', {
  id: serial('id').primaryKey(),
  documentId: integer('document_id')
    .notNull()
  ...
  uniqueDocumentVersion: unique('unique_document_version').on(table.documentId, table.versionNumber),
}));
 ...
 */
export const coauthorStatusHistory = pgTable('coauthor_status_history', {
  id: serial('id').primaryKey(),
  documentId: integer('document_id')
    .notNull()
...
export const componentVersions = pgTable('component_versions', {
  ...
  versionIdx: uniqueIndex('component_version_unique_idx').on(table.componentId, table.versionNumber),
...
export const documentComponents = pgTable('document_components', {
  ...
  componentVersionId: integer('component_version_id')
 ...
 */
export const componentCrossReferences = pgTable('component_cross_references', {
  id: serial('id').primaryKey(),
 ...
 */
export const componentSequenceReferences = pgTable('component_sequence_references', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  ...
  documentId: integer('document_id')
    .references(() => coauthorDocuments.id, { onDelete: 'set null' }),
  documentTitle: text('document_title'),
  moduleContext: text('module_context'), // e.g., "Module 3.2.S - Drug Substance"
  sectionNumber: text('section_number'), // e.g., "3.2.S.4.1"
...
export const insertComponentSequenceReferenceSchema = createInsertSchema(componentSequenceReferences).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export type InsertComponentSequenceReference = z.infer<typeof insertComponentSequenceReferenceSchema>;
...
export const insertCoauthorStatusHistorySchema = createInsertSchema(coauthorStatusHistory).omit({
  id: true,
  changedAt: true,
});
 ...
 */
export const coauthorImportHistory = pgTable('coauthor_import_history', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const insertCoauthorImportHistorySchema = createInsertSchema(coauthorImportHistory).omit({
  id: true,
  startedAt: true,
});
...
export const coauthorValidationRules = pgTable('coauthor_validation_rules', {
  id: serial('id').primaryKey(),
...
export const coauthorValidationHistory = pgTable('coauthor_validation_history', {
  id: serial('id').primaryKey(),
...
export const insertCoauthorValidationRuleSchema = createInsertSchema(coauthorValidationRules).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCoauthorValidationHistorySchema = createInsertSchema(coauthorValidationHistory).omit({
  id: true,
  performedAt: true,
});
...
export const insertIndProjectSchema = createInsertSchema(indProjects).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertIndTemplateSchema = createInsertSchema(indTemplates).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertIndTemplateUsageLogSchema = createInsertSchema(indTemplateUsageLogs).omit({
  id: true,
  createdAt: true,
});

export const insertIndSubmissionSchema = createInsertSchema(indSubmissions).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCoauthorSectionSchema = createInsertSchema(coauthorSections).omit({
  createdAt: true,
  updatedAt: true,
});

export const insertCoauthorAnnotationSchema = createInsertSchema(coauthorAnnotations).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertRegulatorySubmissionSchema = createInsertSchema(regulatorySubmissions).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertRegulatoryTaskSchema = createInsertSchema(regulatoryTasks).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertRegulatoryAuditLogSchema = createInsertSchema(regulatoryAuditLogs).omit({
  id: true,
  timestamp: true,
});
...
export const cdiscPrmStudies = pgTable('cdisc_prm_studies', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscPrmStudyArms = pgTable('cdisc_prm_study_arms', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscPrmEpochs = pgTable('cdisc_prm_epochs', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscPrmVisits = pgTable('cdisc_prm_visits', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscPrmEndpoints = pgTable('cdisc_prm_endpoints', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscCdashForms = pgTable('cdisc_cdash_forms', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscCdashFields = pgTable('cdisc_cdash_fields', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscCdashSdtmMappings = pgTable('cdisc_cdash_sdtm_mappings', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
  ...
  cdashSdtmIdx: uniqueIndex('cdash_sdtm_idx').on(table.cdashDomain, table.cdashVariable, table.sdtmVariable),
}));
...
export const cdiscCsrTemplates = pgTable('cdisc_csr_templates', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscCsrTfl = pgTable('cdisc_csr_tfl', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscCsrSap = pgTable('cdisc_csr_sap', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscAdamSpecs = pgTable('cdisc_adam_specs', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscEctdDefineXml = pgTable('cdisc_ectd_define_xml', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscEctdDatasets = pgTable('cdisc_ectd_datasets', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscEctdReviewersGuide = pgTable('cdisc_ectd_reviewers_guide', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscEctdSdsp = pgTable('cdisc_ectd_sdsp', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscIndIntegration = pgTable('cdisc_ind_integration', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscIndSend = pgTable('cdisc_ind_send', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscIndIss = pgTable('cdisc_ind_iss', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscIndIse = pgTable('cdisc_ind_ise', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscComplianceRules = pgTable('cdisc_compliance_rules', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscComplianceResults = pgTable('cdisc_compliance_results', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscComplianceAgencyPrefs = pgTable('cdisc_compliance_agency_prefs', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscComplianceVersions = pgTable('cdisc_compliance_versions', {
  id: serial('id').primaryKey(),
...
export const cdiscDocsRepository = pgTable('cdisc_docs_repository', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscDocsAcrf = pgTable('cdisc_docs_acrf', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscDocsDefineArtifacts = pgTable('cdisc_docs_define_artifacts', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
// Product Quality (PQ) Domains
export const cdiscPqDomains = pgTable('cdisc_pq_domains', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscPqStability = pgTable('cdisc_pq_stability', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscPqManufacturing = pgTable('cdisc_pq_manufacturing', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscDeviceDx = pgTable('cdisc_device_dx', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
  ...
  studySubjectDeviceIdx: index('device_study_subject_idx').on(table.studyId, table.subjectId, table.deviceId),
}));

// Device Events (DE) Domain
export const cdiscDeviceDe = pgTable('cdisc_device_de', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscDeviceRelationships = pgTable('cdisc_device_relationships', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
// CDISC Deliverables
export const cdiscTaskDeliverables = pgTable('cdisc_task_deliverables', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
// CDISC Milestones
export const cdiscTaskMilestones = pgTable('cdisc_task_milestones', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscTaskWorkflows = pgTable('cdisc_task_workflows', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const cdiscTaskValidationQueue = pgTable('cdisc_task_validation_queue', {
  id: serial('id').primaryKey(),
  tenantId: integer('tenant_id')
    .notNull()
    .references(() => organizations.id),
...
export const insertCdiscPrmStudySchema = createInsertSchema(cdiscPrmStudies).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCdiscPrmStudyArmSchema = createInsertSchema(cdiscPrmStudyArms).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCdiscPrmEpochSchema = createInsertSchema(cdiscPrmEpochs).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCdiscPrmVisitSchema = createInsertSchema(cdiscPrmVisits).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCdiscPrmEndpointSchema = createInsertSchema(cdiscPrmEndpoints).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCdiscCdashFormSchema = createInsertSchema(cdiscCdashForms).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCdiscCdashFieldSchema = createInsertSchema(cdiscCdashFields).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCdiscCdashSdtmMappingSchema = createInsertSchema(cdiscCdashSdtmMappings).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCdiscCsrTemplateSchema = createInsertSchema(cdiscCsrTemplates).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCdiscCsrTflSchema = createInsertSchema(cdiscCsrTfl).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCdiscCsrSapSchema = createInsertSchema(cdiscCsrSap).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCdiscAdamSpecSchema = createInsertSchema(cdiscAdamSpecs).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
 ...
 */
export const biomarkerEndpoints = pgTable('biomarker_endpoints', {
 ...
 */
export const clinicalFeedback = pgTable('clinical_feedback', {
  id: uuid('id').defaultRandom().primaryKey(),
  studyId: varchar('study_id', { length: 255 }).notNull(),
 ...
 */
export const translationalPatterns = pgTable('translational_patterns', {
  id: uuid('id').defaultRandom().primaryKey(),
...
export const insertBiomarkerEndpointSchema = createInsertSchema(biomarkerEndpoints).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertClinicalOutcomeSchema = createInsertSchema(clinicalOutcomes).omit({
  id: true,
  createdAt: true,
});

export const insertForesightPredictionSchema = createInsertSchema(foresightPredictions).omit({
  id: true,
  createdAt: true,
});

export const insertClinicalFeedbackSchema = createInsertSchema(clinicalFeedback).omit({
  id: true,
  capturedAt: true,
});

export const insertTranslationalPatternSchema = createInsertSchema(translationalPatterns).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
 ...
 */
export const doseEscalationStudies = pgTable('dose_escalation_studies', {
  id: uuid('id').defaultRandom().primaryKey(),
 ...
 */
export const doseLevels = pgTable('dose_levels', {
  id: uuid('id').defaultRandom().primaryKey(),
  studyId: uuid('study_id').notNull().references(() => doseEscalationStudies.id),
 ...
 */
export const doseCohorts = pgTable('dose_cohorts', {
  id: uuid('id').defaultRandom().primaryKey(),
  studyId: uuid('study_id').notNull().references(() => doseEscalationStudies.id),
  doseLevelId: uuid('dose_level_id').notNull().references(() => doseLevels.id),
 ...
 */
export const dltEvents = pgTable('dlt_events', {
  id: uuid('id').defaultRandom().primaryKey(),
  studyId: uuid('study_id').notNull().references(() => doseEscalationStudies.id),
  cohortId: uuid('cohort_id').notNull().references(() => doseCohorts.id),
  patientId: text('patient_id').notNull(),
 ...
 */
export const indNarratives = pgTable('ind_narratives', {
  id: uuid('id').defaultRandom().primaryKey(),
 ...
 */
export const indNarrativeSections = pgTable('ind_narrative_sections', {
  id: uuid('id').defaultRandom().primaryKey(),
  narrativeId: uuid('narrative_id').notNull().references(() => indNarratives.id),
 ...
 */
export const crossSpeciesPkpd = pgTable('cross_species_pkpd', {
  id: uuid('id').defaultRandom().primaryKey(),
 ...
 */
export const speciesComparisons = pgTable('species_comparisons', {
  id: uuid('id').defaultRandom().primaryKey(),
  analysisId: uuid('analysis_id').notNull().references(() => crossSpeciesPkpd.id),
 ...
 */
export const pkpdCompartments = pgTable('pkpd_compartments', {
  id: uuid('id').defaultRandom().primaryKey(),
  analysisId: uuid('analysis_id').notNull().references(() => crossSpeciesPkpd.id),
...
// Insert schemas for new tables
export const insertDoseEscalationStudySchema = createInsertSchema(doseEscalationStudies).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertDoseLevelSchema = createInsertSchema(doseLevels).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertDoseCohortSchema = createInsertSchema(doseCohorts).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertDltEventSchema = createInsertSchema(dltEvents).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertIndNarrativeSchema = createInsertSchema(indNarratives).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertIndNarrativeSectionSchema = createInsertSchema(indNarrativeSections).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertCrossSpeciesPkpdSchema = createInsertSchema(crossSpeciesPkpd).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertSpeciesComparisonSchema = createInsertSchema(speciesComparisons).omit({
  id: true,
  createdAt: true,
});

export const insertPkpdCompartmentSchema = createInsertSchema(pkpdCompartments).omit({
  id: true,
  createdAt: true,
});
 ...
 */
export const ragKnowledgeGraph = pgTable('rag_knowledge_graph', {
  id: uuid('id').defaultRandom().primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  ...
  relatedIdx: index('rag_knowledge_related_idx').on(table.relatedEntityId, table.relatedEntityType),
 ...
 */
export const ragIngestionJobs = pgTable('rag_ingestion_jobs', {
  id: uuid('id').defaultRandom().primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const insertRagKnowledgeGraphSchema = createInsertSchema(ragKnowledgeGraph).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertRagSourceSchema = createInsertSchema(ragSources).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertRagIngestionJobSchema = createInsertSchema(ragIngestionJobs).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCoauthorDocumentSchema = createInsertSchema(coauthorDocuments).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
...
export const insertCoauthorDocumentVersionSchema = createInsertSchema(coauthorDocumentVersions).omit({
  id: true,
  createdAt: true,
});
...
export const contextMembers = pgTable('context_members', {
  id: uuid('id').primaryKey().default(sql`gen_random_uuid()`),
...
export const replacementRules = pgTable('replacement_rules', {
  id: uuid('id').primaryKey().default(sql`gen_random_uuid()`),
...
export const insertContextGroupSchema = createInsertSchema(contextGroups).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertContextMemberSchema = createInsertSchema(contextMembers).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertReplacementRuleSchema = createInsertSchema(replacementRules).omit({
  id: true,
  createdAt: true,
});
...
export const deviceDataCenter = pgTable('device_data_center', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id').notNull().references(() => organizations.id),
  ...
  contentIdx: index('device_data_content_idx').using('gin', sql`to_tsvector('english', ${table.searchableContent})`),
}));
...
export const deviceComponents = pgTable('device_components', {
  ...
  orgComponentIdx: uniqueIndex('device_components_org_code_idx').on(table.organizationId, table.componentCode),
}));

// Insert schemas for Device Data Center
export const insertDeviceDataCenterSchema = createInsertSchema(deviceDataCenter).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertDeviceDataCategorySchema = createInsertSchema(deviceDataCategories).omit({
  id: true,
  createdAt: true,
});

export const insertDeviceTestStandardSchema = createInsertSchema(deviceTestStandards).omit({
  id: true,
  createdAt: true,
});
...
export const fda510kProjects = pgTable('fda_510k_projects', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  projectId: integer('project_id')
    ...
    .references(() => projects.id),
  submissionId: integer('submission_id')
    .references(() => fda510kSubmissions.id),
...
export const fda510kTemplates = pgTable('fda_510k_templates', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const fda510kDocuments = pgTable('fda_510k_documents', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
  ...
  templateId: integer('template_id')
    .references(() => fda510kTemplates.id),
...
export const fda510kStageProgress = pgTable('fda_510k_stage_progress', {
  id: serial('id').primaryKey(),
  projectId: integer('project_id')
    .notNull()
    .references(() => fda510kProjects.id),
  ...
  projectStageIdx: index('fda_510k_stage_progress_project_idx').on(table.projectId, table.stageName),
}));

// 510k Submission Packages - Final compiled packages for FDA submission
export const fda510kSubmissionPackages = pgTable('fda_510k_submission_packages', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const fda510kDataMappings = pgTable('fda_510k_data_mappings', {
  id: serial('id').primaryKey(),
  organizationId: integer('organization_id')
    .notNull()
    .references(() => organizations.id),
...
export const insertFda510kProjectSchema = createInsertSchema(fda510kProjects).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertFda510kTemplateSchema = createInsertSchema(fda510kTemplates).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertFda510kDocumentSchema = createInsertSchema(fda510kDocuments).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertFda510kStageProgressSchema = createInsertSchema(fda510kStageProgress).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertFda510kSubmissionPackageSchema = createInsertSchema(fda510kSubmissionPackages).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertFda510kDataMappingSchema = createInsertSchema(fda510kDataMappings).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
