...
export const UI_SURFACES: UiSurface[] = [
  ...
  {
    id: 'submission-orchestrator',
    label: 'Submission orchestrator',
    navTier: 'project',
    layoutMode: 'submissions',
    icon: 'workflow',
    group: 'submission',
    uiKit: 'submission',
    apiPrefixes: ['/api/submission-orchestrator', '/api/ectd/export'],
    anaToolFamilies: ['plan_submission', 'validate_submission'],
    sharedContract: '@shared/types/submission-ui',
    discoveryCatalog: null,
    readiness: 'routes-ready',
    compliance: [PART11, A11Y, TONE],
    notes: 'Run launcher, step tree, append-only audit trail, and the verified release-signature record. Skipped steps are reported as never-attempted rather than complete; a failed audit read is reported as unavailable rather than as an empty history.',
    engineering: 'Routes: /api/submission-orchestrator (runs, audit, regenerate) and GET /api/ectd/export/by-run/:runId/signed for the signed-package record. Path-to-GA §C.1.',
  },
  {
