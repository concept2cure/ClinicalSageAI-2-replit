...
const EU_ENTRIES: RegulatoryApplicationType[] = [
  entry('EU_CTA', 'EU', 'European Union', 'EMA', 'clinical_trial', 'CTA', 'Clinical Trial Application (EU CTR)', { synonyms: ['CTA', 'EU Clinical Trial Application', 'CTIS'], productClass: ['small_molecule', 'biologic'], requiredArtifacts: ['protocol', 'investigator_brochure', 'impd'], segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'EU application under Clinical Trial Regulation (EU 536/2014) submitted via CTIS portal; single application covers all member states' }),
  entry('EU_MAA', 'EU', 'European Union', 'EMA', 'marketing_authorization', 'MAA', 'Marketing Authorisation Application', { synonyms: ['MAA', 'centralised procedure'], productClass: ['small_molecule', 'biologic'], requiredArtifacts: ['clinical_overview', 'quality_overall_summary', 'rmp'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'EU centralized procedure application to CHMP; mandatory for biotech products, orphan drugs, advanced therapies' }),
