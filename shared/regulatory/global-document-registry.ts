...
function entry(
  ...
  return {
    ...
    /* Defaults to eCTD, which is right for the pharma majority and WRONG for
       every device row that forgets to say otherwise — US_PMA omitted it and
       was served as an eCTD dossier for exactly that reason (caught by the
       W2-2 assertion in filing-catalog-unification.test.ts, not by review). A
       device entry must state its own standard. */
...
const US_ENTRIES: RegulatoryApplicationType[] = [
  ...
  entry('US_IND', 'US', 'United States', 'FDA', 'clinical_trial', 'IND', 'Investigational New Drug Application', { moduleAuthority: 'ICH M4 (CTD organisation); FDA eCTD Module 1 Specification v2.3 (US regional M1); 21 CFR 312.23 (IND content).', synonyms: ['IND', 'Investigational New Drug'], productClass: ['small_molecule', 'biologic', 'biosimilar', 'vaccine', 'atmp'], requiredArtifacts: ['form_1571', 'form_1572', 'form_3674', 'cover_letter', 'toc', 'clinical_overview', 'quality_overall_summary', 'nonclinical_overview'], lifecycleActions: ['submit', 'amend', 'supplement', 'annual_report', 'withdraw'], segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Application to begin clinical trials; includes CMC (Module 3), nonclinical data (Module 4), clinical protocol and IB (Module 5). Submit 30 days before trial start.' }),
  entry('US_IND_AMENDMENT', 'US', 'United States', 'FDA', 'clinical_trial', 'IND Amendment', 'IND Amendment', { moduleAuthority: 'BP-W1-4 AUDIT FLAG: \'M5\' is too narrow — an information amendment files where its content lives (protocol amendments in M5.3.5.4, chemistry in M3, administrative in M1; 21 CFR 312.31). Recommend \'M1–M5 (content-dependent)\'. SME decision required.', stage: 'amendment', parentApplicationType: 'US_IND', synonyms: ['IND amendment', 'protocol amendment'], segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M5', description: 'Amendment to an active IND; protocol amendments, new investigator additions, chemistry changes, response to clinical hold' }),

  // Marketing Authorization
  entry('US_NDA', 'US', 'United States', 'FDA', 'marketing_authorization', 'NDA', 'New Drug Application', { moduleAuthority: 'ICH M4 Annex (M1–M5 granularity); FDA eCTD Module 1 Specification v2.3; 21 CFR 314.50.', synonyms: ['NDA', '505(b)(1)'], productClass: ['small_molecule'], requiredArtifacts: ['form_356h', 'clinical_overview', 'quality_overall_summary', 'nonclinical_overview', 'csr'], lifecycleActions: ['submit', 'amend', 'supplement', 'annual_report'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Full CTD dossier for new small molecule drugs; Standard review (10 mo) or Priority Review (6 mo). Triggers PDUFA user fee.' }),
  entry('US_BLA', 'US', 'United States', 'FDA', 'marketing_authorization', 'BLA', 'Biologics License Application', { moduleAuthority: 'ICH M4 Annex; FDA eCTD Module 1 Specification v2.3; 21 CFR 601.2 (PHS Act §351(a)).', synonyms: ['BLA', 'Biologics License'], productClass: ['biologic', 'biosimilar', 'vaccine', 'atmp'], requiredArtifacts: ['form_356h', 'clinical_overview', 'quality_overall_summary'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Marketing application for biological products under PHS Act §351(a); biologics-specific CMC requirements' }),
  ...
  entry('US_505B2', 'US', 'United States', 'FDA', 'marketing_authorization', '505(b)(2)', '505(b)(2) Application', { moduleAuthority: 'A 505(b)(2) is an NDA — ICH M4 Annex; FDA eCTD Module 1 Specification v2.3; 21 CFR 314.50.', synonyms: ['505(b)(2)', 'Section 505(b)(2)'], productClass: ['small_molecule'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'NDA pathway relying partially on literature or FDA’s prior findings; commonly used for new formulations, indications, or combinations' }),

  // Supplements
  entry('US_NDA_SUPP', 'US', 'United States', 'FDA', 'supplement', 'NDA Supplement', 'NDA/BLA Supplement (Prior Approval)', { moduleAuthority: 'Supplements follow the parent application\'s CTD structure — ICH M4; FDA eCTD M1 v2.3; 21 CFR 314.70.', stage: 'supplement', parentApplicationType: 'US_NDA', synonyms: ['sNDA', 'NDA supplement', 'PAS'], segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Supplement requiring FDA approval before implementation; new indications, dosage forms, manufacturing site changes' }),
  entry('US_BLA_SUPP', 'US', 'United States', 'FDA', 'supplement', 'BLA Supplement', 'BLA Supplement (sBLA)', { moduleAuthority: 'Supplements follow the parent application\'s CTD structure — ICH M4; FDA eCTD M1 v2.3; 21 CFR 601.12.', stage: 'supplement', parentApplicationType: 'US_BLA', synonyms: ['sBLA', 'BLA supplement'], segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Supplement to an approved BLA requiring FDA approval before implementation' }),
...
const EU_ENTRIES: RegulatoryApplicationType[] = [
  ...
  entry('EU_MAA', 'EU', 'European Union', 'EMA', 'marketing_authorization', 'MAA', 'Marketing Authorisation Application', { moduleAuthority: 'ICH M4; EU Module 1 Specification v3.0 (eCTD EU regional M1); Regulation (EC) 726/2004.', synonyms: ['MAA', 'centralised procedure'], requiredArtifacts: ['clinical_overview', 'quality_overall_summary', 'rmp'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'EU centralized procedure application to CHMP; mandatory for biotech products, orphan drugs, advanced therapies' }),
  entry('EU_ASMF', 'EU', 'European Union', 'EMA', 'master_file', 'ASMF', 'Active Substance Master File', { moduleAuthority: 'EMA ASMF guideline (CHMP/QWP/227/02 rev); the applicant\'s part maps to 3.2.S per ICH M4Q.', synonyms: ['ASMF', 'EU DMF', 'active substance master file'], segment: 'pharma_biotech', category: 'preclinical_pre_ind', submissionFormat: 'eCTD', ctdModule: '3.2.S', description: 'EU equivalent of DMF; confidential manufacturing and quality data for active substances filed by API manufacturers' }),
  entry('EU_VARIATION_IA', 'EU', 'European Union', 'EMA', 'variation', 'Type IA Variation', 'Type IA Variation (Minor)', { moduleAuthority: 'Regulation (EC) 1234/2008 (variations) — affected CTD sections per ICH M4 with EU M1 v3.0 cover documentation.', stage: 'amendment', synonyms: ['Type IA', 'minor variation'], segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'EU post-authorization change: Type IA (minor, notification)' }),
  entry('EU_VARIATION_IB', 'EU', 'European Union', 'EMA', 'variation', 'Type IB Variation', 'Type IB Variation', { moduleAuthority: 'Regulation (EC) 1234/2008 — affected CTD sections per ICH M4 with EU M1 v3.0 cover documentation.', stage: 'amendment', synonyms: ['Type IB'], segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'EU post-authorization change: Type IB (30-day review)' }),
  entry('EU_VARIATION_II', 'EU', 'European Union', 'EMA', 'variation', 'Type II Variation', 'Type II Variation (Major)', { moduleAuthority: 'Regulation (EC) 1234/2008 — affected CTD sections per ICH M4 with EU M1 v3.0 cover documentation.', stage: 'amendment', synonyms: ['Type II', 'major variation'], segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'EU post-authorization change: Type II (major, full CHMP assessment)' }),
  ...
  entry('EU_RMP', 'EU', 'European Union', 'EMA', 'safety_report', 'RMP', 'Risk Management Plan', { moduleAuthority: 'EU Module 1 Specification v3.0 — 1.8.2 risk-management plan; GVP Module V.', synonyms: ['RMP', 'risk management'], segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1.8', description: 'EU mandatory risk management plan: safety specification, pharmacovigilance plan, and risk minimisation measures' }),
  entry('EU_PSUR', 'EU', 'European Union', 'EMA', 'safety_report', 'PSUR/PBRER', 'PSUR / PBRER', { moduleAuthority: 'BP-W1-4 AUDIT FLAG: PSUR/PBRER submissions go to the EU PSUR Repository as standalone sequences (Art 107b Directive 2001/83/EC; ICH E2C(R2)) — they are not Module 5 dossier content. Recommend removing the M5 assignment. SME decision required.', synonyms: ['PSUR', 'PBRER', 'periodic safety'], segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M5', description: 'ICH E2C(R2) harmonized periodic safety report evaluating benefit-risk balance; submitted at defined intervals post-authorization' }),
  entry('EU_RENEWAL', 'EU', 'European Union', 'EMA', 'renewal', 'Renewal', 'Renewal Application', { moduleAuthority: 'Art 24 Directive 2001/83/EC — renewal application under EU M1 v3.0 with updated 2.4/2.5 addenda (the M1 assignment names the administrative core).', stage: 'renewal', segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1', description: 'Application to renew marketing authorization after initial 5-year period; after renewal, authorization is typically unlimited' }),
  entry('EU_CER', 'EU', 'European Union', 'Notified_Body', 'device_approval', 'CER', 'Clinical Evaluation Report (CER)', { synonyms: ['CER', 'clinical evaluation report', 'EU MDR'], productClass: ['medical_device'], dossierStandard: 'regional', segment: 'medical_devices', category: 'device_market_auth_eu_intl', submissionFormat: 'MEDDEV 2.7/1', description: 'Systematic assessment of clinical data demonstrating conformity with General Safety and Performance Requirements' }),
  entry('EU_IVDR', 'EU', 'European Union', 'Notified_Body', 'device_approval', 'IVDR', 'IVDR Technical Documentation', { synonyms: ['IVDR', 'IVD regulation', 'IVDR technical file'], productClass: ['ivd'], dossierStandard: 'regional', segment: 'diagnostics_ivd', category: 'ivd_market_auth_eu', submissionFormat: 'STED', description: 'Complete technical file per IVDR Annexes II–III: device description, GSPR compliance, performance evaluation, labeling, PMS plan' }),
];
...
const UK_ENTRIES: RegulatoryApplicationType[] = [
  ...
  entry('UK_MA', 'UK', 'United Kingdom', 'MHRA', 'marketing_authorization', 'UK MA', 'UK Marketing Authorisation', { moduleAuthority: 'ICH M4; MHRA UK eCTD Module 1 guidance (post-Brexit national procedure).', synonyms: ['UK MA', 'UK marketing authorization'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'National marketing authorisation application to MHRA; UK-specific Module 1 with CTD Modules 2–5' }),
  entry('UK_IRP', 'UK', 'United Kingdom', 'MHRA', 'marketing_authorization', 'IRP', 'International Recognition Procedure', { moduleAuthority: 'ICH M4; MHRA International Recognition Procedure guidance; UK eCTD Module 1.', synonyms: ['IRP'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'MHRA pathway recognising approvals from trusted reference agencies (FDA, EMA, TGA, Health Canada, Swissmedic, etc.)' }),
  entry('UK_VARIATION', 'UK', 'United Kingdom', 'MHRA', 'variation', 'UK Variation', 'UK Marketing Authorisation Variation', { moduleAuthority: 'UK Human Medicines Regulations 2012 (as amended), mirroring Reg (EC) 1234/2008 classification; ICH M4; UK eCTD M1.', stage: 'amendment', segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Post-authorisation change to a UK MA; classified as Type IA, IB, or II mirroring the EU variation system' }),
];
...
const CA_ENTRIES: RegulatoryApplicationType[] = [
  entry('CA_CTA', 'CA', 'Canada', 'Health_Canada', 'clinical_trial', 'CTA', 'Clinical Trial Application (Canada)', { moduleAuthority: 'ICH M4; Health Canada eCTD CA Module 1 specification; Food and Drug Regulations C.05.', synonyms: ['Canadian CTA'], segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Health Canada clinical trial application; CTD format with Canadian Module 1 requirements' }),
  ...
  entry('CA_NDS', 'CA', 'Canada', 'Health_Canada', 'marketing_authorization', 'NDS', 'New Drug Submission (NDS)', { moduleAuthority: 'ICH M4; Health Canada eCTD CA Module 1 specification; Food and Drug Regulations C.08.002.', synonyms: ['NDS'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Canadian marketing authorization application; CTD format with Canada-specific Module 1' }),
  entry('CA_SNDS', 'CA', 'Canada', 'Health_Canada', 'supplement', 'SNDS', 'Supplemental New Drug Submission', { moduleAuthority: 'Supplements follow the parent NDS structure — ICH M4; Health Canada CA Module 1; C.08.003.', stage: 'supplement', parentApplicationType: 'CA_NDS', segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Supplement to an approved NDS for new indications, formulation changes, or manufacturing site changes' }),
  ...
  entry('CA_MF', 'CA', 'Canada', 'Health_Canada', 'master_file', 'MF', 'Master File (Canada)', { moduleAuthority: 'Health Canada Master File guidance; content maps to 3.2.S per ICH M4Q.', synonyms: ['Canadian MF'], segment: 'pharma_biotech', category: 'cmc_quality', submissionFormat: 'eCTD', ctdModule: '3.2.S', description: 'Confidential manufacturing and quality data for APIs or excipients; referenced by NDS/ANDS applicants' }),
];
...
const JP_ENTRIES: RegulatoryApplicationType[] = [
  entry('JP_CTN', 'JP', 'Japan', 'PMDA', 'clinical_trial', 'CTN', 'Clinical Trial Notification', { moduleAuthority: 'ICH M4; PMDA J-eCTD Module 1 specification; PMD Act clinical trial notification.', synonyms: ['CTN', '治験届'], segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Notification to PMDA 30 days before commencing a clinical trial in Japan; Japanese-language Module 1 requirements' }),
  entry('JP_MKT_APPROVAL', 'JP', 'Japan', 'PMDA', 'marketing_authorization', 'Marketing Approval', 'Marketing Approval Application (Japan)', { moduleAuthority: 'ICH M4; PMDA J-eCTD Module 1 specification (J-NDA).', synonyms: ['承認申請', 'JNDA'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Japanese marketing approval application submitted to PMDA; CTD format with Japan-specific Module 1 and potentially Japanese clinical data' }),
  entry('JP_MF', 'JP', 'Japan', 'PMDA', 'master_file', 'MF', 'Master File (Japan)', { moduleAuthority: 'PMDA Master File registration system; content maps to 3.2.S per ICH M4Q.', synonyms: ['Japanese MF', 'MF登録'], segment: 'pharma_biotech', category: 'cmc_quality', submissionFormat: 'eCTD', ctdModule: '3.2.S', description: 'PMDA Master File for APIs and excipients; confidential quality data referenced by marketing approval applicants' }),
  entry('JP_PARTIAL_CHANGE', 'JP', 'Japan', 'PMDA', 'variation', 'Partial Change', 'Partial Change Application', { moduleAuthority: 'PMD Act partial-change approval — affected CTD sections per ICH M4; J-eCTD M1.', stage: 'amendment', synonyms: ['一部変更承認申請'], segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Major post-approval change requiring PMDA approval before implementation; new indications, formulations, manufacturing changes' }),
...
const CN_ENTRIES: RegulatoryApplicationType[] = [
  entry('CN_CTA', 'CN', 'China', 'NMPA', 'clinical_trial', 'CTA', 'Clinical Trial Application (China)', { moduleAuthority: 'NMPA Order 2019 No. 27/CDE CTD adoption; ICH M4 with CN regional Module 1.', synonyms: ['Chinese CTA', '药物临床试验申请'], dossierStandard: 'CTD', segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'CTD', ctdModule: 'M1–M5', description: 'NMPA clinical trial application; 60-day tacit approval. CTD format with China-specific Module 1 requirements.' }),
  entry('CN_MAA', 'CN', 'China', 'NMPA', 'marketing_authorization', 'MAA', 'Marketing Authorization Application (China)', { moduleAuthority: 'NMPA CTD requirements (2019 No. 17 announcement family); ICH M4 with CN regional Module 1.', synonyms: ['Chinese MAA', '药品注册申请'], dossierStandard: 'CTD', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'CTD', ctdModule: 'M1–M5', description: 'NMPA marketing authorization; CTD format with China-specific Module 1, ethnic sensitivity bridging data may be required' }),
  entry('CN_SUPPLEMENT', 'CN', 'China', 'NMPA', 'supplement', 'Supplementary Application', 'Supplementary Application (China)', { moduleAuthority: 'NMPA supplementary application — affected CTD sections per ICH M4; CN regional M1.', stage: 'supplement', dossierStandard: 'CTD', segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'CTD', ctdModule: 'M1–M5', description: 'Post-approval change application to NMPA for new indications, formulations, or manufacturing changes' }),
  entry('CN_RENEWAL', 'CN', 'China', 'NMPA', 'renewal', 'Renewal', 'Registration Renewal (China)', { moduleAuthority: 'NMPA five-year re-registration — administrative dossier in the CN regional Module 1.', stage: 'renewal', dossierStandard: 'CTD', segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'CTD', ctdModule: 'M1', description: 'Five-year registration renewal application to NMPA; includes pharmacovigilance summary and benefit-risk reassessment' }),
];
...
const AU_ENTRIES: RegulatoryApplicationType[] = [
  ...
  entry('AU_CTA', 'AU', 'Australia', 'TGA', 'clinical_trial', 'CTA', 'Clinical Trial Approval (Australia)', { moduleAuthority: 'ICH M4; TGA AU eCTD Module 1 specification (CTA scheme).', synonyms: ['TGA CTA'], segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'TGA Clinical Trial Approval scheme for higher-risk trials; TGA reviews the trial before it can proceed' }),
  entry('AU_CAT1', 'AU', 'Australia', 'TGA', 'marketing_authorization', 'Category 1', 'Category 1 Registration', { moduleAuthority: 'ICH M4; TGA AU eCTD Module 1 specification.', synonyms: ['Cat 1'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'TGA Category 1 application for new chemical entities and biologics; full evaluation with CTD dossier' }),
  entry('AU_CAT2', 'AU', 'Australia', 'TGA', 'marketing_authorization', 'Category 2', 'Category 2 Registration', { moduleAuthority: 'ICH M4; TGA AU eCTD Module 1 specification; Category 2 relies on comparable-regulator reports.', synonyms: ['Cat 2'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'TGA Category 2 (abridged) for products approved by a comparable overseas regulator; relies on foreign assessment reports' }),
];
...
const CH_ENTRIES: RegulatoryApplicationType[] = [
  entry('CH_CTA', 'CH', 'Switzerland', 'Swissmedic', 'clinical_trial', 'CTA', 'Clinical Trial Application (Switzerland)', { moduleAuthority: 'ICH M4; Swissmedic CH eCTD Module 1 specification; ClinO authorisation.', synonyms: ['Swiss CTA'], segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Swissmedic clinical trial authorisation; dual submission to Swissmedic and cantonal ethics committee' }),
  entry('CH_MA', 'CH', 'Switzerland', 'Swissmedic', 'marketing_authorization', 'MA', 'Marketing Authorisation (Switzerland)', { moduleAuthority: 'ICH M4; Swissmedic CH eCTD Module 1 specification; TPA Art 11.', synonyms: ['Swiss MA'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'Swissmedic marketing authorisation; CTD dossier with Swiss-specific Module 1. Fast-track and prior-notification pathways available.' }),
];
...
const BR_ENTRIES: RegulatoryApplicationType[] = [
  entry('BR_DDCM', 'BR', 'Brazil', 'ANVISA', 'clinical_trial', 'DDCM', 'Dossiê de Desenvolvimento Clínico de Medicamento', { moduleAuthority: 'ANVISA RDC 205/750 clinical development dossier; CTD organisation per ICH M4 (ANVISA CTD adoption RDC 753/2022).', synonyms: ['DDCM', 'Brazilian clinical trial'], dossierStandard: 'CTD', segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'CTD', ctdModule: 'M1–M5', description: 'ANVISA clinical development dossier for new drugs; CTD format with Brazil-specific requirements and CEP ethics approval' }),
  ...
  entry('BR_MA', 'BR', 'Brazil', 'ANVISA', 'marketing_authorization', 'MA', 'Marketing Authorization (Brazil)', { moduleAuthority: 'ANVISA registration (registro) — CTD per RDC 753/2022; ICH M4.', synonyms: ['Brazilian MA', 'registro'], dossierStandard: 'CTD', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'CTD', ctdModule: 'M1–M5', description: 'ANVISA registration (registro) for new drugs; CTD format with Brazilian Module 1 requirements. MDSAP accepted for devices.' }),
];
...
const IN_ENTRIES: RegulatoryApplicationType[] = [
  entry('IN_CT04', 'IN', 'India', 'CDSCO', 'clinical_trial', 'CT-04', 'Form CT-04 (New Drug Clinical Trial)', { moduleAuthority: 'CDSCO New Drugs and Clinical Trials Rules 2019 (Form CT-04); CTD organisation per ICH M4.', synonyms: ['CT-04', 'Indian CT application'], dossierStandard: 'CTD', segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'CTD', ctdModule: 'M1–M5', description: 'CDSCO Form CT-04 for new drug clinical trial permission under New Drugs & Clinical Trials Rules 2019; via SUGAM portal' }),
  ...
  entry('IN_CT11', 'IN', 'India', 'CDSCO', 'clinical_trial', 'CT-11', 'Form CT-11 (Clinical Trial Report)', { moduleAuthority: 'CDSCO NDCT Rules 2019 (Form CT-11) — the clinical study report is M5 content per ICH M4.', synonyms: ['CT-11'], dossierStandard: 'CTD', segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'CTD', ctdModule: 'M5', description: 'CDSCO Form CT-11 for clinical trial completion reports; submitted within specified timelines after study completion' }),
  entry('IN_CT18', 'IN', 'India', 'CDSCO', 'marketing_authorization', 'CT-18', 'Form CT-18 (New Drug Marketing)', { moduleAuthority: 'CDSCO NDCT Rules 2019 (Form CT-18); CTD per ICH M4.', synonyms: ['CT-18'], dossierStandard: 'CTD', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'CTD', ctdModule: 'M1–M5', description: 'CDSCO Form CT-18 for marketing approval of new drugs; full CTD dossier submission via SUGAM portal' }),
  entry('IN_CT19', 'IN', 'India', 'CDSCO', 'marketing_authorization', 'CT-19', 'Form CT-19 (Import Registration)', { moduleAuthority: 'CDSCO NDCT Rules 2019 (Form CT-19, import registration); CTD per ICH M4.', synonyms: ['CT-19'], dossierStandard: 'CTD', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'CTD', ctdModule: 'M1–M5', description: 'CDSCO Form CT-19 for import registration of new drugs manufactured outside India; requires GMP certificate from country of origin' }),
  entry('IN_CT21', 'IN', 'India', 'CDSCO', 'marketing_authorization', 'CT-21', 'Form CT-21 (Generic Drug Marketing)', { moduleAuthority: 'BP-W1-4 AUDIT FLAG: same defect class as the corrected ANDA — a generic application scoped M1–M3 leaves no module for the bioequivalence study report, which is 5.3.1 per the ICH M4 Annex. Recommend \'M1–M5 (BE in 5.3.1)\'. SME decision required.', synonyms: ['CT-21'], dossierStandard: 'CTD', productClass: ['generic'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'CTD', ctdModule: 'M1–M3', description: 'CDSCO Form CT-21 for marketing approval of generic drugs; bioequivalence data and abbreviated CMC package' }),
];
...
const KR_ENTRIES: RegulatoryApplicationType[] = [
  entry('KR_IND', 'KR', 'South Korea', 'MFDS', 'clinical_trial', 'IND', 'IND Application (South Korea)', { moduleAuthority: 'ICH M4 (MFDS CTD adoption); KR regional Module 1.', synonyms: ['Korean IND', '임상시험계획승인'], segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'MFDS clinical trial plan approval application; 30-day review with Korean-language Module 1' }),
  entry('KR_MA_NEW', 'KR', 'South Korea', 'MFDS', 'marketing_authorization', 'New Drug MA', 'Marketing Application — New Drug (Korea)', { moduleAuthority: 'ICH M4 (MFDS CTD adoption); KR regional Module 1.', synonyms: ['Korean MA', '품목허가'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'MFDS marketing approval for new drugs; CTD format with Korean-specific requirements. Korean bridging data may be required.' }),
  entry('KR_MA_GENERIC', 'KR', 'South Korea', 'MFDS', 'marketing_authorization', 'Generic MA', 'Marketing Application — Generic (Korea)', { moduleAuthority: 'BP-W1-4 AUDIT FLAG: same defect class as the corrected ANDA — \'M1–M3\' leaves no module for the bioequivalence evidence (5.3.1, ICH M4 Annex). Recommend \'M1–M5 (BE in 5.3.1)\'. SME decision required.', productClass: ['generic'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M3', description: 'MFDS generic drug marketing approval; bioequivalence data and abbreviated CMC package' }),
];
...
const SEG_PHARMA_INVESTIGATIONAL: RegulatoryApplicationType[] = [
  entry('US_IND_SR', 'US', 'United States', 'FDA', 'safety_report', 'IND Safety Report', 'IND Safety Reports (IND-SR)', { moduleAuthority: '21 CFR 312.32 — filed to the IND; report content per ICH M4 M5 conventions. Distinct from a SUSAR E2B transmission (see ICH_SUSAR).', stage: 'post_approval', parentApplicationType: 'US_IND', segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M5', productClass: ['small_molecule', 'biologic'], synonyms: ['IND-SR', 'safety report'], description: 'Expedited safety reports of serious and unexpected adverse reactions within 15 days (7 days for fatal/life-threatening)' }),
  entry('US_IND_ANNUAL', 'US', 'United States', 'FDA', 'safety_report', 'IND Annual Report', 'Annual Report (IND)', { moduleAuthority: 'BP-W1-4 AUDIT FLAG: an eCTD IND annual report files under m1.13 (FDA eCTD M1 v2.3), not M5; 21 CFR 312.33. Recommend \'M1 (m1.13)\'. SME decision required.', stage: 'annual_report', parentApplicationType: 'US_IND', segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M5', synonyms: ['IND annual report'], description: 'Annual summary within 60 days of IND anniversary covering clinical study progress, safety data, CMC changes' }),
  entry('ICH_DSUR', 'GLOBAL', 'Global', 'ICH', 'safety_report', 'DSUR', 'Development Safety Update Report (DSUR)', { moduleAuthority: 'BP-W1-4 AUDIT FLAG: FDA accepts the DSUR as the IND annual report under eCTD m1.13 (FDA eCTD M1 v2.3); in the EU it is a CTIS submission, not dossier content. Current \'M5\' traces to neither. Recommend \'M1 (m1.13, US IND)\' with a regional note. SME decision required. ICH E2F.', stage: 'annual_report', segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M5', synonyms: ['DSUR', 'ICH E2F'], description: 'ICH E2F-harmonized annual safety report covering all ongoing clinical trials globally' }),
  entry('ICH_PROTOCOL', 'GLOBAL', 'Global', 'ICH', 'clinical_document', 'Protocol', 'Protocol & Protocol Amendments', { moduleAuthority: 'ICH M4 Annex — 5.3.5.4 (protocols and amendments file with the study\'s clinical documentation); ICH E6.', segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M5', lifecycleActions: ['submit', 'amend'], synonyms: ['protocol', 'protocol amendment', 'SAP'], description: 'Clinical trial protocol defining study design, endpoints, populations, and SAP; amendments require notification or approval' }),
  ...
  entry('ICH_CSR', 'GLOBAL', 'Global', 'ICH', 'clinical_document', 'Clinical Study Report', 'Clinical Study Report (CSR)', { moduleAuthority: 'ICH M4 Annex — 5.3.5 study reports; ICH E3 structure.', segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'eCTD', ctdModule: 'M5 (5.3.5)', synonyms: ['CSR', 'ICH E3'], description: 'ICH E3-structured comprehensive report of individual clinical study results; foundational efficacy and safety document' }),
  entry('ICH_SAP', 'GLOBAL', 'Global', 'ICH', 'clinical_document', 'Statistical Analysis Plan', 'Statistical Analysis Plan (SAP)', { moduleAuthority: 'ICH E9; the SAP travels as CSR Appendix 16.1.9 (ICH E3) within M5.3.5.', segment: 'pharma_biotech', category: 'investigational', submissionFormat: 'none', dossierStandard: 'none', ctdModule: 'M5', synonyms: ['SAP', 'statistical analysis plan'], description: 'Pre-specified plan detailing statistical methods, analysis populations, multiplicity adjustments, and endpoint definitions' }),
];

// Category: Marketing Authorization (Registration)
const SEG_PHARMA_MARKETING: RegulatoryApplicationType[] = [
  entry('US_351K', 'US', 'United States', 'FDA', 'marketing_authorization', '351(k)', 'Biosimilar Application (351(k))', { moduleAuthority: 'ICH M4 Annex; FDA eCTD M1 v2.3; PHS Act §351(k) — full CTD with the analytical-similarity assessment in M3 and comparative clinical data in M5.', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', productClass: ['biosimilar'], synonyms: ['351(k)', 'biosimilar'], description: 'Application for biosimilar biological products demonstrating biosimilarity to a reference product' }),
  entry('US_ACCEL_APPROVAL', 'US', 'United States', 'FDA', 'marketing_authorization', 'Accelerated Approval', 'Accelerated Approval Application', { moduleAuthority: 'An NDA/BLA under 21 CFR part 314 subpart H / part 601 subpart E — standard CTD M1–M5 (ICH M4; FDA eCTD M1 v2.3).', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', synonyms: ['accelerated approval', 'subpart H'], description: 'NDA/BLA using surrogate or intermediate endpoint; requires post-marketing confirmatory trials' }),
  entry('EU_CMA', 'EU', 'European Union', 'EMA', 'marketing_authorization', 'Conditional MA', 'Conditional Marketing Authorisation', { moduleAuthority: 'A conditional MA is a full MAA under Regulation (EC) 507/2006 — ICH M4; EU M1 v3.0.', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', lifecycleActions: ['submit', 'renew'], synonyms: ['conditional MA', 'CMA'], description: 'EU approval based on less comprehensive data; subject to annual renewal and obligations to provide complete data' }),
  entry('US_ROLLING', 'US', 'United States', 'FDA', 'marketing_authorization', 'Rolling Submission', 'Rolling Submission / Review', { moduleAuthority: 'A rolling review is the same CTD dossier submitted in completed units — ICH M4; FDA eCTD M1 v2.3; FDCA §506(c).', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', synonyms: ['rolling review', 'rolling submission'], description: 'Under Breakthrough or Fast Track; allows completed sections to be submitted before the full application is complete' }),
...
const SEG_PHARMA_POST_APPROVAL: RegulatoryApplicationType[] = [
  entry('US_CBE', 'US', 'United States', 'FDA', 'supplement', 'CBE Supplement', 'CBE-30 / CBE-0 Supplement', { moduleAuthority: '21 CFR 314.70(c)–(d): labeling changes land in M1 (FDA eCTD M1 v2.3 m1.14), CMC changes in M3 (ICH M4Q).', stage: 'supplement', parentApplicationType: 'US_NDA', segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1–M3', synonyms: ['CBE-30', 'CBE-0', 'changes being effected'], description: 'Changes Being Effected supplements: CBE-30 (moderate changes, 30-day); CBE-0 (labeling safety updates, immediate)' }),
  entry('US_NDA_ANNUAL', 'US', 'United States', 'FDA', 'safety_report', 'Annual Report (NDA/BLA)', 'Annual Report (NDA/BLA)', { moduleAuthority: 'FDA eCTD Module 1 Specification v2.3 — m1.13 annual report; 21 CFR 314.81(b)(2).', stage: 'annual_report', parentApplicationType: 'US_NDA', segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1', synonyms: ['annual report'], description: 'Post-approval annual report covering distribution data, labeling changes, manufacturing changes, post-marketing commitments' }),
  entry('US_REMS', 'US', 'United States', 'FDA', 'safety_report', 'REMS', 'Risk Evaluation & Mitigation Strategy (REMS)', { moduleAuthority: 'FDA eCTD Module 1 Specification v2.3 — m1.16 risk management plan; FDCA §505-1.', stage: 'post_approval', segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'none', dossierStandard: 'none', ctdModule: 'M1', synonyms: ['REMS', 'risk mitigation'], description: 'Risk management program for drugs with serious safety concerns; medication guides, ETASU, implementation systems' }),
  entry('US_PMR', 'US', 'United States', 'FDA', 'post_market', 'PMR/PMC', 'Post-Marketing Requirement (PMR) / PMC', { moduleAuthority: 'Status reports travel in the annual report (21 CFR 314.81(b)(2)(vii), M1); completed PMR/PMC study reports file as M5 study reports per ICH M4.', stage: 'post_approval', segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M5', synonyms: ['PMR', 'PMC', 'post-marketing requirement'], description: 'FDA-required or committed post-marketing studies or clinical trials; common for accelerated approval confirmatory trials' }),
  entry('US_SUPAC', 'US', 'United States', 'FDA', 'supplement', 'SUPAC', 'SUPAC Supplement', { moduleAuthority: 'SUPAC-IR/MR/SS guidances — the change documentation is Module 3 content (ICH M4Q granularity).', stage: 'supplement', segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M3', synonyms: ['SUPAC', 'scale-up post-approval changes'], description: 'Scale-Up and Post-Approval Changes for CMC manufacturing process changes, site transfers; classified by level of change' }),
...
const SEG_PHARMA_CMC: RegulatoryApplicationType[] = [
  entry('ICH_M3_DS', 'GLOBAL', 'Global', 'ICH', 'quality_cmc', 'Module 3.2.S', 'Module 3.2.S — Drug Substance', { moduleAuthority: 'ICH M4Q — 3.2.S drug substance.', segment: 'pharma_biotech', category: 'cmc_quality', submissionFormat: 'eCTD', ctdModule: '3.2.S', synonyms: ['3.2.S', 'drug substance'], description: 'Complete drug substance quality package: manufacturing process, characterization, specifications, stability, container closure' }),
  entry('ICH_M3_DP', 'GLOBAL', 'Global', 'ICH', 'quality_cmc', 'Module 3.2.P', 'Module 3.2.P — Drug Product', { moduleAuthority: 'ICH M4Q — 3.2.P drug product.', segment: 'pharma_biotech', category: 'cmc_quality', submissionFormat: 'eCTD', ctdModule: '3.2.P', synonyms: ['3.2.P', 'drug product'], description: 'Complete drug product quality package: formulation, manufacturing process, validation, excipient controls, specifications, stability' }),
  entry('ICH_QOS', 'GLOBAL', 'Global', 'ICH', 'quality_cmc', 'QOS', 'Quality Overall Summary (QOS)', { moduleAuthority: 'ICH M4Q — Module 2.3 Quality Overall Summary.', segment: 'pharma_biotech', category: 'cmc_quality', submissionFormat: 'eCTD', ctdModule: '2.3', synonyms: ['QOS', 'quality overall summary'], description: 'Module 2.3 summary of all quality data; must cross-reference Module 3 data without contradiction' }),
  entry('ICH_COMPARABILITY', 'GLOBAL', 'Global', 'ICH', 'quality_cmc', 'Comparability Protocol', 'Comparability Protocol', { moduleAuthority: 'ICH Q5E (biologics comparability); documented in 3.2.S/3.2.P per ICH M4Q. A US comparability protocol is 21 CFR 314.70(e).', segment: 'pharma_biotech', category: 'cmc_quality', submissionFormat: 'eCTD', ctdModule: '3.2.S/P', synonyms: ['comparability protocol'], description: 'Pre-approved protocol for managing future manufacturing changes with pre-defined acceptance criteria' }),
  entry('US_EA', 'US', 'United States', 'FDA', 'quality_cmc', 'Environmental Assessment', 'Environmental Assessment (EA)', { moduleAuthority: 'FDA eCTD Module 1 Specification v2.3 — m1.12.14 environmental analysis; 21 CFR part 25.', segment: 'pharma_biotech', category: 'cmc_quality', submissionFormat: 'eCTD', ctdModule: 'M1', synonyms: ['EA', 'environmental assessment', 'NEPA'], description: 'NEPA-required environmental impact assessment for drug manufacturing and use' }),
];
...
const SEG_CROSS_CTD: RegulatoryApplicationType[] = [
  entry('ICH_CTD_M1', 'GLOBAL', 'Global', 'ICH', 'dossier_module', 'Module 1', 'Module 1 — Administrative & Regional', { moduleAuthority: 'ICH M4 — Module 1 is regional by definition; content per FDA eCTD M1 v2.3, EU M1 v3.0 and the other regional specifications.', segment: 'cross_cutting', category: 'ctd_ectd', submissionFormat: 'eCTD', ctdModule: 'M1', synonyms: ['Module 1', 'M1', 'administrative'], description: 'Region-specific administrative documents: cover letters, application forms, patent certifications, labeling, environmental assessment' }),
  entry('ICH_CTD_M2', 'GLOBAL', 'Global', 'ICH', 'dossier_module', 'Module 2', 'Module 2 — Summaries & Overviews', { moduleAuthority: 'ICH M4 / M4E / M4Q / M4S — Module 2 summaries.', segment: 'cross_cutting', category: 'ctd_ectd', submissionFormat: 'eCTD', ctdModule: 'M2', synonyms: ['Module 2', 'M2', 'summaries'], description: 'High-level summaries: 2.2 (Introduction), 2.3 (QOS), 2.4 (Nonclinical Overview), 2.5 (Clinical Overview), 2.6 (Nonclinical Summaries), 2.7 (Clinical Summary)' }),
  entry('ICH_CTD_M3', 'GLOBAL', 'Global', 'ICH', 'dossier_module', 'Module 3', 'Module 3 — Quality', { moduleAuthority: 'ICH M4Q — Module 3 quality.', segment: 'cross_cutting', category: 'ctd_ectd', submissionFormat: 'eCTD', ctdModule: 'M3', synonyms: ['Module 3', 'M3', 'quality', 'CMC'], description: 'Complete CMC: 3.2.S (Drug Substance), 3.2.P (Drug Product), 3.2.A (Appendices), 3.2.R (Regional), 3.3 (Literature)' }),
  entry('ICH_CTD_M4', 'GLOBAL', 'Global', 'ICH', 'dossier_module', 'Module 4', 'Module 4 — Nonclinical Study Reports', { moduleAuthority: 'ICH M4S — Module 4 nonclinical study reports.', segment: 'cross_cutting', category: 'ctd_ectd', submissionFormat: 'eCTD', ctdModule: 'M4', synonyms: ['Module 4', 'M4', 'nonclinical'], description: 'Nonclinical reports: 4.2.1 (Pharmacology), 4.2.2 (Pharmacokinetics), 4.2.3 (Toxicology)' }),
  entry('ICH_CTD_M5', 'GLOBAL', 'Global', 'ICH', 'dossier_module', 'Module 5', 'Module 5 — Clinical Study Reports', { moduleAuthority: 'ICH M4E — Module 5 clinical study reports.', segment: 'cross_cutting', category: 'ctd_ectd', submissionFormat: 'eCTD', ctdModule: 'M5', synonyms: ['Module 5', 'M5', 'clinical'], description: 'Clinical data: 5.2 (Study Listing), 5.3.1–5.3.6 (PK, PD, Efficacy, Safety, CSRs, Post-marketing), 5.4 (Literature)' }),
];
...
const ABS_PHARMA: RegulatoryApplicationType[] = [
  ...
  // Marketing authorization
  entry('EU_BIOSIMILAR_MAA', 'EU', 'European Union', 'EMA', 'marketing_authorization', 'Biosimilar MAA', 'Biosimilar MAA', { moduleAuthority: 'ICH M4; EU M1 v3.0; similar-biological-medicinal-products guidelines (CHMP/437/04 rev) for the comparability exercise.', productClass: ['biosimilar'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'EU centralized biosimilar application.' }),
  entry('JP_BIOSIMILAR', 'JP', 'Japan', 'PMDA', 'marketing_authorization', 'Biosimilar', 'Biosimilar (Japan)', { moduleAuthority: 'ICH M4; J-eCTD M1; PMDA biosimilar guideline (comparability against the reference product).', productClass: ['biosimilar'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'PMDA biosimilar application.' }),
  entry('AU_BIOSIMILAR', 'AU', 'Australia', 'TGA', 'marketing_authorization', 'Biosimilar', 'Biosimilar (TGA)', { moduleAuthority: 'ICH M4; TGA AU eCTD M1; TGA biosimilar regulation (comparability against the reference).', productClass: ['biosimilar'], segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'TGA biosimilar medicine registration.' }),
  ...
  entry('ICH_CLIN_OVERVIEW', 'GLOBAL', 'Global', 'ICH', 'clinical_document', 'Clinical Overview', 'Clinical Overview (M2.5)', { moduleAuthority: 'ICH M4E — Module 2.5 clinical overview.', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: '2.5', synonyms: ['M2.5', 'clinical overview'], description: 'Integrated clinical overview across studies.' }),
  entry('ICH_CLIN_SUMMARY', 'GLOBAL', 'Global', 'ICH', 'clinical_document', 'Clinical Summary', 'Clinical Summary (M2.7)', { moduleAuthority: 'ICH M4E — Module 2.7 clinical summary.', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: '2.7', synonyms: ['M2.7', 'clinical summary'], description: 'Integrated summary of clinical data.' }),
  entry('ICH_NONCLIN_OVERVIEW', 'GLOBAL', 'Global', 'ICH', 'clinical_document', 'Nonclinical Overview', 'Nonclinical Overview (M2.4)', { moduleAuthority: 'ICH M4S — Module 2.4 nonclinical overview.', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: '2.4', synonyms: ['M2.4', 'nonclinical overview'], description: 'Integrated nonclinical overview.' }),
  entry('ICH_NONCLIN_SUMMARY', 'GLOBAL', 'Global', 'ICH', 'clinical_document', 'Nonclinical Summary', 'Nonclinical Summary (M2.6)', { moduleAuthority: 'ICH M4S — Module 2.6 nonclinical written and tabulated summaries.', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: '2.6', synonyms: ['M2.6', 'nonclinical written and tabulated summaries'], description: 'Nonclinical written and tabulated summaries.' }),
  entry('ICH_TABULATED_SUMMARIES', 'GLOBAL', 'Global', 'ICH', 'clinical_document', 'Tabulated Summaries', 'Tabulated Summaries (M2.7.4)', { moduleAuthority: 'BP-W1-4 AUDIT FLAG: 2.7.4 is the Summary of Clinical Safety (ICH M4E); nonclinical TABULATED summaries are 2.6.3/2.6.5/2.6.7 (ICH M4S) and individual patient data listings are CSR appendix 16.2 (M5). The current assignment and the description (\'individual patient data listings\') match none of these. SME decision required.', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'eCTD', ctdModule: '2.7.4', description: 'Individual patient data listings.' }),
  // Post-approval lifecycle
  entry('EU_LINE_EXTENSION', 'EU', 'European Union', 'EMA', 'variation', 'Line Extension', 'Line Extension', { moduleAuthority: 'Annex I Regulation (EC) 1234/2008 — a line extension is assessed as an MAA-shaped submission; ICH M4; EU M1 v3.0.', stage: 'amendment', segment: 'pharma_biotech', category: 'post_approval_lifecycle', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'New strength, route, or pharmaceutical form.' }),
  ...
  entry('ICH_STABILITY_PROTOCOL', 'GLOBAL', 'Global', 'ICH', 'quality_cmc', 'Stability Protocol', 'Stability Protocol', { moduleAuthority: 'ICH M4Q — 3.2.P.8.2 (post-approval stability protocol; 3.2.S.7.2 for the substance); ICH Q1A/Q1E.', segment: 'pharma_biotech', category: 'cmc_quality', submissionFormat: 'eCTD', ctdModule: '3.2.P.8', synonyms: ['ICH Q1A', 'stability study design'], description: 'ICH Q1A/Q1E stability study design.' }),
];

const ABS_DEVICES: RegulatoryApplicationType[] = [
  /* The ONLY two places the EMA legitimately touches a device or an IVD, and
     they run the opposite way round from everything above: here the medicinal
     side and the device side must consult each other, so both a Notified Body
     and a medicines agency are genuinely in scope.

     W2-1's scope names them explicitly — "Retain EMA only for MDR Art. 117 and
     IVDR Art. 48(6) consultations" — and neither was modelled, so the
     re-attribution had nothing to retain EMA FOR. */
  entry('EU_MDR_ART117_NBOP', 'EU', 'European Union', 'Notified_Body', 'pre_submission', 'Art. 117 NB Opinion', 'Notified Body Opinion — MDR Art. 117', { stage: 'pre_submission', segment: 'pharma_biotech', category: 'marketing_authorization', submissionFormat: 'none', dossierStandard: 'none', productClass: ['medical_device'], lifecycleActions: ['submit'], synonyms: ['NBOp', 'Article 117', 'integral device'], moduleAuthority: 'MDR (EU) 2017/745 Art. 117, amending Directive 2001/83/EC Annex I §12. The OPINION is issued by a Notified Body; it is then filed with the MAA to the EMA, which is why this is the one device-adjacent row that legitimately reaches a medicines agency.', description: 'Notified Body opinion on the device part of a medicinal product with an integral device (e.g. a prefilled pen), filed with the marketing authorisation application.' }),
  entry('EU_IVDR_ART48_CONSULT', 'EU', 'European Union', 'EMA', 'companion_diagnostic', 'Art. 48(6) Consultation', 'EMA Consultation — IVDR Art. 48(6)', { stage: 'pre_submission', segment: 'diagnostics_ivd', category: 'ivd_companion_dx', submissionFormat: 'none', dossierStandard: 'none', productClass: ['ivd'], lifecycleActions: ['submit'], synonyms: ['Article 48(6)', 'CDx consultation'], moduleAuthority: 'IVDR (EU) 2017/746 Art. 48(6). The Notified Body assessing a companion diagnostic must seek a scientific opinion from the EMA (or the national competent authority that authorised the medicinal product) on the suitability of the CDx to the product concerned.', description: 'Scientific opinion sought from the EMA by the Notified Body assessing a companion diagnostic, on the CDx\'s suitability to the medicinal product.' }),
  ...
  entry('JP_NINTEI', 'JP', 'Japan', 'PMDA', 'device_approval', 'Nintei', 'Nintei Certification', { segment: 'medical_devices', category: 'device_market_auth_eu_intl', submissionFormat: 'regional', dossierStandard: 'regional', productClass: ['medical_device'], synonyms: ['Nintei', '認証'], description: 'PMDA certified medical device.' }),
  entry('CN_DEVICE_REG', 'CN', 'China', 'NMPA', 'device_approval', 'Device Registration', 'Device Registration (NMPA)', { segment: 'medical_devices', category: 'device_market_auth_eu_intl', submissionFormat: 'regional', dossierStandard: 'regional', productClass: ['medical_device'], description: 'NMPA medical device registration for China.' }),
...
const ABS_IVD: RegulatoryApplicationType[] = [
  ...
  entry('JP_CDX', 'JP', 'Japan', 'PMDA', 'companion_diagnostic', 'CDx Approval', 'CDx Approval (PMDA)', { segment: 'diagnostics_ivd', category: 'ivd_companion_dx', submissionFormat: 'regional', dossierStandard: 'regional', productClass: ['ivd'], description: 'PMDA companion diagnostic device approval.' }),
  ...
  entry('JP_IVD_APPROVAL', 'JP', 'Japan', 'PMDA', 'device_approval', 'IVD Approval', 'IVD Approval (PMDA)', { segment: 'diagnostics_ivd', category: 'ivd_market_auth_intl', submissionFormat: 'regional', dossierStandard: 'regional', productClass: ['ivd'], description: 'PMDA IVD medical device approval.' }),
  entry('CN_IVD_REG', 'CN', 'China', 'NMPA', 'device_approval', 'IVD Registration', 'IVD Registration (NMPA)', { segment: 'diagnostics_ivd', category: 'ivd_market_auth_intl', submissionFormat: 'regional', dossierStandard: 'regional', productClass: ['ivd'], description: 'NMPA IVD registration for China.' }),
...
const ABS_CROSS: RegulatoryApplicationType[] = [
  entry('ICH_ECTD_BACKBONE', 'GLOBAL', 'Global', 'ICH', 'dossier_module', 'eCTD Backbone', 'eCTD Backbone Structure', { moduleAuthority: 'ICH eCTD v3.2.2 (backbone/DTD) and eCTD v4.0 (HL7 RPS).', segment: 'cross_cutting', category: 'ctd_ectd', submissionFormat: 'eCTD', ctdModule: 'M1–M5', description: 'ICH eCTD v3.2.2/v4.0 backbone and envelope.' }),
