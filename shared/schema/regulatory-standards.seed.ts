...
export const REGULATORY_STANDARDS_SEED: StandardSeed[] = [
  ...
  {
    standardCode: 'ISO 10993-5:2009',
    standardName: 'Biological evaluation of medical devices — Part 5: Tests for in vitro cytotoxicity',
    standardBody: 'ISO',
    family: 'ISO 10993',
    version: '2009',
    editionYear: 2009,
    ...
    fdaRecognized: true,
    euHarmonized: true,
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'In vitro cytotoxicity testing — the most common biological-safety screening endpoint.',
  },
  {
    standardCode: 'ISO 10993-10:2021',
    standardName: 'Biological evaluation of medical devices — Part 10: Tests for skin sensitization',
    standardBody: 'ISO',
    family: 'ISO 10993',
    version: '2021',
    editionYear: 2021,
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Skin sensitization testing for devices with direct or indirect patient contact.',
  },
  {
    standardCode: 'ISO 10993-23:2021',
    standardName: 'Biological evaluation of medical devices — Part 23: Tests for irritation',
    standardBody: 'ISO',
    family: 'ISO 10993',
    version: '2021',
    editionYear: 2021,
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Irritation testing (replaces the irritation methods formerly in ISO 10993-10).',
  },
  {
    standardCode: 'ISO 10993-18:2020',
    standardName:
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Chemical characterization / extractables-leachables that increasingly underpins biocompatibility.',
  },

  // ── Sterilization (additional methods) ────────────────────────────────
  {
    standardCode: 'ISO 11737-1:2018',
    standardName:
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Bioburden determination, the basis for sterilization-dose setting and validation.',
  },
  {
    standardCode: 'ISO 11737-2:2019',
    standardName:
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Tests of sterility used in sterilization-process validation and maintenance.',
  },
  {
    standardCode: 'ISO 17665:2024',
    standardName:
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Moist-heat (steam) sterilization process validation and routine control.',
  },

  // ── IVD performance (additional) ──────────────────────────────────────
  {
    standardCode: 'ISO 17511:2020',
    standardName:
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Metrological traceability of assigned values — a core IVDR analytical-performance expectation.',
  },
  {
    standardCode: 'ISO 23640:2011',
    standardName: 'In vitro diagnostic medical devices — Evaluation of stability of in vitro diagnostic reagents',
    standardBody: 'ISO',
    family: 'ISO',
    version: '2011',
    editionYear: 2011,
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Stability evaluation (shelf life, in-use, transport) of IVD reagents.',
  },

  // ── Electrical (collateral standards) ─────────────────────────────────
  {
    standardCode: 'IEC 60601-1-11:2015',
    standardName:
      'Medical electrical equipment — Part 1-11: General requirements for basic safety and essential performance — Collateral standard: Requirements for medical electrical equipment used in the home healthcare environment',
    standardBody: 'IEC',
    family: 'IEC 60601',
    version: '2015',
    editionYear: 2015,
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Home-healthcare collateral to IEC 60601-1 (relevant to at-home injectors and monitors).',
  },
  {
    standardCode: 'IEC 60601-1-8:2006/AMD2:2020',
    standardName:
      'Medical electrical equipment — Part 1-8: Collateral standard: General requirements, tests and guidance for alarm systems in medical electrical equipment and medical electrical systems',
    standardBody: 'IEC',
    family: 'IEC 60601',
    version: '2006/AMD2:2020',
    editionYear: 2020,
    region: 'Global',
    domain: 'electrical',
    appliesTo: ['device'],
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Alarm-system requirements collateral to IEC 60601-1.',
  },

  // ── Combination products (drug-device delivery systems) ───────────────
  // The bridge between the pharma/biotech and device standards worlds:
  // autoinjectors, pen injectors and prefilled syringes for biologics and
  // small molecules are regulated as combination products.
  {
    standardCode: 'ISO 11608-1:2022',
    standardName:
    ...
    editionYear: 2022,
    region: 'Global',
    domain: 'combination_product',
    appliesTo: ['combination', 'device'],
    fdaRecognized: true,
    euHarmonized: true,
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary:
      'Requirements and test methods for needle-based injection systems (autoinjectors, pen injectors) — central to biologic/small-molecule delivery combination products.',
  },
  {
    standardCode: 'ISO 11040-4:2015',
    standardName: 'Prefilled syringes — Part 4: Glass barrels for injectables and sterilized subassembled syringes ready for filling',
    standardBody: 'ISO',
    family: 'ISO 11040',
    version: '2015',
    editionYear: 2015,
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Glass barrels for prefilled syringes — the primary container-closure for many injectable biologics.',
  },
  {
    standardCode: 'ISO 20069:2019',
    standardName:
    ...
    jurisdictions: ['US', 'EU', 'UK', 'CA', 'AU', 'JP', 'CH'],
    status: 'active',
    summary: 'Assessing changes to drug-delivery systems across the combination-product lifecycle.',
  },
];
