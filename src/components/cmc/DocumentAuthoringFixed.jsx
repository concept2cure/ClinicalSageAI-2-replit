    ...
    try {
      const response = await fetch('/api/ai/analyze-compliance', {
        ...
        headers: {
          ...
          'x-organization-id': '7', // Current organization
        },
        body: JSON.stringify({
          content,
          templateName,
  ...
  const recomputeWithLimsData = async () => {
    ...
    try {
      ...
      const sectionResponse = await fetch(
        ...
        {
          headers: { 'x-tenant-id': localStorage.getItem('currentOrganization') || '7' },
        }
      );
      ...
      <div className="h-screen flex flex-col bg-gray-50">
        ...
        <div className="bg-white border-b px-6 py-3 flex items-center justify-between shadow-sm">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button variant="ghost" size="sm" title="Compare Versions">
            ...
            <Select defaultValue="DOCX">
              ...
              <SelectContent>
                ...
                <SelectItem value="eCTD">eCTD XML</SelectItem>
              </SelectContent>
            </Select>
            <Button onClick={saveDocument} className="bg-blue-600 hover:bg-blue-700" size="sm">
