 ...
 */
const ProtocolCorrectionSuggestions = ({ csrContext, protocolData }) => {
...
const SuggestionCard = ({ suggestion, onCopy, onAccept, getStatusIcon, getStatusColor }) => {
  return (
    <div className="rounded-lg border p-4">
      ...
      <div className="mt-2">
        ...
        <p className="text-sm mt-1 p-2 bg-slate-50 rounded border border-slate-200">
