    ...
    setMessages([
      {
        role: 'assistant',
        content:
          "Hello! I'm your AI Development Assistant. I can write code, edit files, run commands, and help with your TrialSage project development. What would you like me to help you with?",
  ...
  const executeAgentRequest = async () => {
    ...
    try {
      const response = await fetch('/api/agent/code', {
        ...
        body: JSON.stringify({
          prompt: currentInput,
          context: 'TrialSage regulatory platform development',
          model: agentModel,
        }),
      });
