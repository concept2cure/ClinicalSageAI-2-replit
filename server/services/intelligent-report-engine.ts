...
const REGULATORY_FRAMEWORKS: Record<
  RegulatoryBody,
  {
    name: string;
    country: string;
...
> = {
  FDA: {
    ...
    keyRegulations: [
      ...
      },
      {
        ...
        applicableDomains: ['regulatory_submission', 'clinical_study'],
      },
      {
        code: '21 CFR 314',
        title: 'Applications for FDA Approval to Market a New Drug',
        applicableDomains: ['regulatory_submission'],
      },
      {
        code: '21 CFR 601',
        title: 'Licensing (Biologics)',
        applicableDomains: ['regulatory_submission'],
      },
      {
        code: '21 CFR 807',
        title: 'Establishment Registration and Device Listing',
        applicableDomains: ['device_regulatory'],
      },
      {
        code: '21 CFR 820',
        title: 'Quality System Regulation',
        applicableDomains: ['quality_management', 'device_regulatory', 'cmc_manufacturing'],
      },
      {
        code: '21 CFR 211',
        title: 'cGMP for Finished Pharmaceuticals',
        applicableDomains: ['cmc_manufacturing'],
      },
    ],
    retentionYears: 7,
  ...
  EMA: {
    ...
    keyRegulations: [
      ...
      },
      {
        ...
        applicableDomains: ['compliance_attestation', 'cmc_manufacturing'],
      },
      {
        code: 'GDPR',
        title: 'General Data Protection Regulation',
        applicableDomains: ['clinical_study', 'compliance_attestation'],
      },
    ],
    retentionYears: 15,
  ...
  PMDA: {
    ...
    keyRegulations: [
      {
        code: 'PMD Act',
        title: 'Pharmaceutical and Medical Device Act',
        applicableDomains: ['regulatory_submission', 'device_regulatory'],
      },
  ...
  NMPA: {
    ...
    keyRegulations: [
      {
        code: 'Drug Administration Law',
        title: 'PRC Drug Administration Law (2019)',
        applicableDomains: ['regulatory_submission'],
      },
      {
        code: 'NMPA Order 32',
  ...
  TGA: {
    ...
    keyRegulations: [
      {
        code: 'Therapeutic Goods Act 1989',
        title: 'Australian Therapeutic Goods Act',
        applicableDomains: ['regulatory_submission', 'device_regulatory'],
      },
      {
        code: 'TGO 106',
        title: 'Standards for Clinical Trials',
        applicableDomains: ['clinical_study'],
      },
    ],
    retentionYears: 15,
  ...
  Health_Canada: {
    ...
    keyRegulations: [
      {
        code: 'Food and Drugs Act',
        title: 'Canadian Food and Drugs Act',
        applicableDomains: ['regulatory_submission'],
      },
      {
        code: 'C.05 Division 5',
        title: 'Drugs for Clinical Trials Involving Human Subjects',
        applicableDomains: ['clinical_study'],
      },
      {
        code: 'SOR/98-282',
  ...
  MHRA: {
    ...
    keyRegulations: [
      {
        code: 'UK MDR 2002',
        title: 'UK Medical Devices Regulations',
        applicableDomains: ['device_regulatory'],
      },
      {
        code: 'SI 2004/1031',
        title: 'Medicines for Human Use (Clinical Trials) Regulations',
        applicableDomains: ['clinical_study'],
      },
    ],
    retentionYears: 15,
  ...
  MFDS: {
    ...
    keyRegulations: [
      {
        code: 'Pharmaceutical Affairs Act',
        title: 'Korean Pharmaceutical Affairs Act',
        applicableDomains: ['regulatory_submission'],
      },
      {
        code: 'MFDS Notification 2020-71',
        title: 'Medical Device Clinical Trial Standards',
        applicableDomains: ['clinical_study', 'device_regulatory'],
      },
    ],
    retentionYears: 10,
  ...
  Swissmedic: {
    ...
    keyRegulations: [
      {
        code: 'TPA/HMG',
        title: 'Federal Act on Medicinal Products and Medical Devices',
        applicableDomains: ['regulatory_submission', 'device_regulatory'],
      },
      {
        code: 'ClinO',
        title: 'Ordinance on Clinical Trials',
        applicableDomains: ['clinical_study'],
      },
    ],
    retentionYears: 15,
  ...
  ICH: {
    ...
    keyRegulations: [
      ...
      },
      {
        ...
        applicableDomains: ['cmc_manufacturing', 'quality_management'],
      },
      { code: 'ICH S1-S11', title: 'Safety Guidelines', applicableDomains: ['pharmacovigilance'] },
      {
        code: 'ICH E1-E20',
        title: 'Efficacy Guidelines',
        applicableDomains: ['clinical_study', 'biostatistics'],
      },
    ],
    retentionYears: 15,
  ...
  WHO_PQ: {
    ...
    keyRegulations: [
      {
        code: 'WHO PQ TRS',
        title: 'WHO Technical Report Series (Prequalification)',
        applicableDomains: ['regulatory_submission', 'cmc_manufacturing'],
      },
      {
        code: 'WHO GMP',
        title: 'WHO Good Manufacturing Practices',
        applicableDomains: ['cmc_manufacturing'],
      },
    ],
    retentionYears: 10,
  ...
  CDSCO: {
    ...
    keyRegulations: [
      {
        code: 'New Drugs and Clinical Trials Rules 2019',
        title: 'Indian CT Rules',
        applicableDomains: ['clinical_study', 'regulatory_submission'],
      },
    ],
    retentionYears: 10,
  ...
  HSA: {
    ...
    keyRegulations: [
      {
        code: 'Health Products Act',
        title: 'Singapore Health Products Act',
        applicableDomains: ['regulatory_submission', 'device_regulatory'],
      },
    ],
    retentionYears: 10,
  ...
  SAHPRA: {
    ...
    keyRegulations: [
      {
        code: 'Medicines Act 101',
        title: 'Medicines and Related Substances Act',
        applicableDomains: ['regulatory_submission'],
      },
    ],
    retentionYears: 10,
  ...
  COFEPRIS: {
    ...
    keyRegulations: [
      {
        code: 'General Health Law',
        title: 'Mexican General Health Law',
        applicableDomains: ['regulatory_submission'],
      },
    ],
    retentionYears: 10,
  ...
  multi_regional: {
    ...
    keyRegulations: [
      {
        code: 'ICH M4/M8',
        title: 'Common Technical Document (global)',
        applicableDomains: ['regulatory_submission'],
      },
...
const DOMAIN_BLUEPRINTS: Record<
  ReportDomain,
  {
    label: string;
    subtypes: string[];
...
export class IntelligentReportEngine {
  ...
  async generateReport(request: ReportGenerationRequest): Promise<GeneratedReport> {
    ...
    const complianceFrameworks =
      request.complianceFrameworks || blueprint.defaultComplianceFrameworks;
    ...
    const eventHash = this.hashContent(
      this.canonicalize({
        reportId: record.id,
    ...
    const [sealEvent] = await db
      .insert(reportSealEvents)
      .values({
        reportId: record.id,
        organizationId: request.organizationId,
        eventType: 'report_generated',
  ...
  async sealReport(
    ...
    await db
      .update(indemnificationAttestations)
  ...
  async verifyReportIntegrity(reportId: number): Promise<{
    ...
    if (!merkleRootValid)
      details.push('Merkle root mismatch — one or more sections may have been altered');

    // 3. Verify seal event chain
    const sealEvents = await db
      .select()
      .from(reportSealEvents)
      .where(eq(reportSealEvents.reportId, reportId))
      ...
      try {
        ...
        if (atom) {
          const currentHash = this.hashContent(
            JSON.stringify(atom.content || atom.structuredData || '')
          );
  ...
  async runComplianceValidation(
    ...
    checks.push({
      ...
      passed: !((report.sections as any[]) || []).some(
        (s: any) => s.content?.status === 'awaiting_content'
      ),
      severity: 'critical',
      details:
        ((report.sections as any[]) || [])
          .filter((s: any) => s.content?.status === 'awaiting_content')
          .map((s: any) => s.sectionId)
          .join(', ') || 'All sections populated',
    });
    ...
    checks.push({
      ...
      passed:
        ((report.atomReferences as any[]) || []).length > 0 ||
        report.reportDomain === 'strategic_intelligence',
      severity: 'major',
    ...
    if (body === 'FDA') {
      checks.push(
        ...
        },
        {
          ...
          passed: ((report.complianceFrameworks as string[]) || []).some(
            f => f.includes('CFR') || f.includes('ICH')
          ),
          severity: 'major',
      ...
      checks.push(
        {
          ...
          passed: ((report.complianceFrameworks as string[]) || []).some(
            f => f.includes('MDR') || f.includes('EU') || f.includes('ICH')
          ),
          severity: 'critical',
        ...
        },
        {
          ...
          passed: ((report.riskDisclosures as any[]) || []).some(
            (r: any) => r.category === 'gdpr_compliance' || r.riskId?.includes('EMA')
          ),
          severity: 'major',
    ...
    if (report.reportDomain === 'device_regulatory') {
      checks.push({
        ...
        passed: ((report.sections as any[]) || []).some(
          (s: any) => s.sectionId === 'device_description'
        ),
        severity: 'critical',
  ...
  private async assembleExecutiveSummary(request: ReportGenerationRequest): Promise<ReportSection> {
      ...
      try {
        ...
        if (proj) {
          atomRefs.push({
            ...
            sourceRecordId: String(proj.id),
            sourceField: 'name',
            sourceValue: proj.name || '',
            sectionPath: 'executive_summary.projectName',
            fieldLabel: 'Project Name',
            reportedValue: proj.name || '',
          ...
          if (proj.description) {
            atomRefs.push({
              ...
              sourceValue: proj.description || '',
              sectionPath: 'executive_summary.projectDescription',
              fieldLabel: 'Project Description',
              reportedValue: proj.description || '',
              transformationType: 'direct_copy',
              confidence: 1.0,
            });
          }
    ...
    return {
      ...
      content: {
        ...
        targetRegulatory: request.targetRegulatory
          ? REGULATORY_FRAMEWORKS[request.targetRegulatory]?.name
          : 'Multi-regional',
        generatedAt: new Date().toISOString(),
        project: projectData
          ? {
  ...
  private assembleRegulatoryContext(request: ReportGenerationRequest): ReportSection {
    ...
    const frameworks =
      request.complianceFrameworks || DOMAIN_BLUEPRINTS[request.domain].defaultComplianceFrameworks;
    ...
    return {
      ...
      content: {
        ...
        signatureRequirements:
          fw?.signatureRequirements || 'Electronic signature per applicable regional law',
        languageRequirement: fw?.languageRequirement || 'English',
        applicableRegulations: regs,
        complianceFrameworks: frameworks,
        allTargetBodies: !body
          ? Object.keys(REGULATORY_FRAMEWORKS).filter(k => k !== 'multi_regional')
          : [body],
      },
      atomRefs: [],
      complianceNotes: [
    ...
    return {
      ...
      content: {
        ...
        signatureRequirement:
          bp.indemnificationTier === 'full_audit_trail'
        ...
        retentionPolicy: request.targetRegulatory
          ? `${REGULATORY_FRAMEWORKS[request.targetRegulatory]?.retentionYears || 10} years per ${
              REGULATORY_FRAMEWORKS[request.targetRegulatory]?.name || 'applicable regulations'
            }`
  ...
  private async assembleClinicalSection(
    sectionKey: string,
    request: ReportGenerationRequest
  ): Promise<ReportSection> {
    const orgId = request.organizationId;
    ...
    for (const csr of csrs.slice(0, 3)) {
      if (csr.title) {
        atomRefs.push({
          sourceTable: 'csr_reports',
          sourceRecordId: String(csr.id),
          sourceField: 'title',
          sourceValue: csr.title || '',
          sectionPath: `${sectionKey}.csrTitle`,
          fieldLabel: 'CSR Title',
          reportedValue: csr.title || '',
          transformationType: 'direct_copy',
          confidence: 1.0,
        });
      }
      if (csr.indication) {
        atomRefs.push({
          sourceTable: 'csr_reports',
          sourceRecordId: String(csr.id),
          sourceField: 'indication',
          sourceValue: csr.indication || '',
          sectionPath: `${sectionKey}.indication`,
          fieldLabel: 'Indication',
          reportedValue: csr.indication || '',
          transformationType: 'direct_copy',
          confidence: 1.0,
        });
      }
    ...
    try {
      atoms = await db
        .select()
        .from(lumenDataAtoms)
        .where(and(eq(lumenDataAtoms.organizationId, orgId), eq(lumenDataAtoms.status, 'active')))
    ...
    const sectionBuilders: Record<string, () => ReportSection> = {
      study_overview: () => ({
        ...
        atomRefs,
        complianceNotes: [
          `${csrs.length} CSR records queried`,
          `${atoms.length} data atoms sourced`,
        ],
      }),
      methodology: () => ({
        ...
        content: {
          studyDesigns: details.map(d => ({
            ...
            statisticalMethods: d.statisticalMethods,
            sampleSize: d.sampleSize,
            blinding: d.blinding,
            randomization: d.randomization,
          })),
      ...
      results: () => ({
        ...
        title: 'Results',
        content: {
          efficacyResults: details
            .map(d => ({
              reportId: d.reportId,
              efficacyResults: d.efficacyResults,
              endpoints: d.endpoints,
              results: d.results,
            }))
            .filter(d => d.efficacyResults || d.results),
          safetyResults: details
            .map(d => ({
              reportId: d.reportId,
              safetyResults: d.safetyResults,
      ...
      safety_analysis: () => ({
        ...
        content: {
          ...
          totalStudiesWithSafetyData: details.filter(d => d.adverseEvents || d.safetyResults)
            .length,
        },
        atomRefs: [],
        ...
        content: {
          methods: details
            .map(d => ({
              ...
              statisticalMethods: d.statisticalMethods,
              primaryEndpoint: d.primaryEndpoint,
              secondaryEndpoints: d.secondaryEndpoints,
      ...
      conclusions: () => ({
        ...
        content: {
          ...
          completedStudies: csrs.filter(c => c.status === 'approved' || c.status === 'submitted')
            .length,
          dataPointsTracked: atomRefs.length,
          summary:
            `Analysis based on ${csrs.length} clinical study reports and ${atoms.length} data atoms. ` +
  ...
  private async assembleDeviceSection(
    sectionKey: string,
    request: ReportGenerationRequest
  ): Promise<ReportSection> {
    const orgId = request.organizationId;
    ...
    for (const cer of cers.slice(0, 3)) {
      for (const field of [
        ...
        if (cer[field]) {
          atomRefs.push({
            sourceTable: 'cer_reports',
            sourceRecordId: String(cer.id),
            sourceField: field,
            sourceValue: String(cer[field]),
            sectionPath: `${sectionKey}.${field}`,
            fieldLabel: field.replace(/([A-Z])/g, ' $1').trim(),
            reportedValue: String(cer[field]),
            transformationType: 'direct_copy',
            confidence: 1.0,
          });
        }
    ...
    switch (sectionKey) {
      case 'device_description':
        content.devices = cers.map(c => ({
          ...
          type: c.deviceType,
          class: c.deviceClass,
          framework: c.regulatoryFramework,
          status: c.status || c.cerStatus,
          version: c.cerVersion,
        }));
      ...
      case 'indications_for_use':
        content.indications = cers.map(c => ({
          device: c.deviceName,
          description: (c.deviceDescription as any)?.intendedUse || 'See device description',
        }));
        break;
      ...
      case 'risk_analysis':
        content.riskBenefitAnalysis = cers.map(c => ({
          device: c.deviceName,
          riskBenefit: c.riskBenefitAnalysis,
          conclusions: c.conclusions,
        }));
        break;
      case 'conclusions':
        content.summary =
          `${cers.length} device evaluation reports analyzed. ` +
          `Device classes: ${
            [...new Set(cers.map(c => c.deviceClass).filter(Boolean))].join(', ') || 'N/A'
          }.`;
    ...
    return {
      ...
      atomRefs,
      complianceNotes: [
        `${cers.length} CER records queried`,
        `${atomRefs.length} provenance atoms linked`,
      ],
    };
  }
  ...
  private async assembleQualitySection(
    sectionKey: string,
    request: ReportGenerationRequest
  ): Promise<ReportSection> {
    const orgId = request.organizationId;
    ...
    try {
      qualityAudits = await db
        .select()
        .from(auditLogs)
        .where(and(eq(auditLogs.tenantId, orgId), ilike(auditLogs.action, '%quality%')))
    ...
    switch (sectionKey) {
      ...
      case 'root_cause':
        content.analysis = {
          method: 'Platform audit trail analysis',
          eventCount: qualityAudits.length,
        };
        break;
      case 'corrective_actions':
        content.qmpActions = qmps
      ...
      case 'effectiveness_check':
        ...
        content.completedQMPs = qmps.filter(
    ...
    return {
      ...
      atomRefs,
      complianceNotes: [
        `${qmps.length} QMPs queried`,
        `${qualityAudits.length} audit events analyzed`,
      ],
    };
  }
  ...
  private async assembleComplianceSection(
    sectionKey: string,
    request: ReportGenerationRequest
  ): Promise<ReportSection> {
    const orgId = request.organizationId;
    ...
    switch (sectionKey) {
      case 'scope':
        ...
        content.systemCapabilities = [
          ...
          'Immutable seal events',
        ];
        break;
      case 'methodology':
        content.assessmentMethod =
          'Automated platform capability analysis with real-time data verification';
        content.standardsEvaluated =
          request.complianceFrameworks ||
          DOMAIN_BLUEPRINTS[request.domain].defaultComplianceFrameworks;
        break;
      case 'findings':
      ...
      case 'gap_analysis':
        ...
        if (signatures.length === 0)
          content.gaps.push({
            ...
            severity: 'major',
            description: 'No electronic signatures found in the system',
          });
        if (auditTrail.length === 0)
          content.gaps.push({
            area: 'Audit Trail',
            severity: 'major',
            description: 'No document audit trail entries found',
          });
      ...
      case 'remediation_plan':
        ...
        if (signatures.length === 0)
          content.recommendations.push(
            'Implement electronic signature workflow for document approvals'
          );
        if (auditTrail.length < 10)
          content.recommendations.push(
            'Enable comprehensive audit trail logging for all document actions'
          );
        break;
      default:
        return this.assembleSectionFromAtoms(sectionKey, request);
    ...
    return {
      ...
      atomRefs: [],
      complianceNotes: [
        `${signatures.length} e-signatures analyzed`,
        `${auditTrail.length} audit entries reviewed`,
      ],
    };
  }
  ...
  private async assembleProvenanceSection(
    sectionKey: string,
    request: ReportGenerationRequest
  ): Promise<ReportSection> {
    const orgId = request.organizationId;
    ...
    return {
      ...
      atomRefs: [],
      complianceNotes: [
        `${lineage.length} lineage records`,
        `${versions.length} document versions`,
      ],
    };
  }
  ...
  private async assemblePharmacovigilanceSection(
    sectionKey: string,
    request: ReportGenerationRequest
  ): Promise<ReportSection> {
    ...
    const safetyDetails = details.filter(
      d => d.adverseEvents || d.seriousEvents || d.safetyResults
    );

    for (const sd of safetyDetails.slice(0, 5)) {
      if (sd.adverseEvents) {
        atomRefs.push({
          sourceTable: 'csr_details',
          sourceRecordId: String(sd.id),
          sourceField: 'adverseEvents',
          sourceValue: String(sd.adverseEvents).slice(0, 500),
          sectionPath: `${sectionKey}.adverseEvents`,
          fieldLabel: 'Adverse Events',
  ...
  private async assembleRegulatorySubmissionSection(
    sectionKey: string,
    request: ReportGenerationRequest
  ): Promise<ReportSection> {
    const orgId = request.organizationId;
    ...
    switch (sectionKey) {
      ...
      case 'risk_assessment':
        content.documentCompleteness =
          docs.filter(d => d.status === 'approved' || d.status === 'effective').length /
          Math.max(docs.length, 1);
        content.pendingDocuments = docs.filter(
  ...
  private async assembleCMCSection(
    sectionKey: string,
    request: ReportGenerationRequest
  ): Promise<ReportSection> {
  ...
  private async assembleBiostatSection(
    sectionKey: string,
    request: ReportGenerationRequest
  ): Promise<ReportSection> {
    const orgId = request.organizationId;
    ...
    const statsDetails = details.filter(
      d => d.statisticalMethods || d.sampleSize || d.primaryEndpoint
    );

    const content: any = {};
    switch (sectionKey) {
      case 'objectives':
        content.studyObjectives = details
          .map(d => ({
            primary: d.primaryObjective,
            secondary: d.secondaryObjective,
          }))
          .filter(d => d.primary);
        break;
      case 'study_design':
        content.designs = details
          .map(d => ({
      ...
      case 'statistical_methods':
        content.methods = statsDetails.map(d => ({
          methods: d.statisticalMethods,
          endpoints: d.endpoints,
        }));
        break;
      case 'sample_size':
        content.sampleSizes = details
          .map(d => ({
            sampleSize: d.sampleSize,
            dropoutRate: d.dropoutRate,
          }))
      ...
      case 'analysis_populations':
        content.populationCount = details.filter(
          d => d.inclusionCriteria || d.exclusionCriteria
        ).length;
        content.criteria = details
          .map(d => ({
            inclusion: d.inclusionCriteria,
            exclusion: d.exclusionCriteria,
          }))
          .filter(d => d.inclusion);
        break;
      case 'results':
        content.results = details
          .map(d => ({ results: d.results, efficacy: d.efficacyResults }))
          .filter(d => d.results || d.efficacy);
        break;
      default:
        return this.assembleSectionFromAtoms(sectionKey, request);
    }
  ...
  private async assembleStrategicSection(
    sectionKey: string,
    request: ReportGenerationRequest
  ): Promise<ReportSection> {
  ...
  private generateExecutiveSummary(
    ...
    return (
      ...
      `Compliance frameworks: ${
        (request.complianceFrameworks || bp.defaultComplianceFrameworks).join(', ') ||
        'none specified'
      }.`
    );
  }
  ...
  private buildRiskDisclosures(domain: ReportDomain, body?: RegulatoryBody): any[] {
    const disclosures: any[] = [
      {
        ...
        description:
          'Report reflects data state at generation time. Source data may have been updated after report generation.',
        mitigation:
          'Verify report provenance atoms for drift using the integrity verification endpoint.',
      },
      {
        riskId: 'RD-002',
        category: 'ai_limitation',
        description:
          'AI-assisted content should be reviewed by qualified regulatory professionals before submission.',
        mitigation:
          'All AI-generated sections are flagged and require human review before sealing.',
      },
      {
        riskId: 'RD-003',
        category: 'regulatory_change',
        description:
          'Regulatory requirements evolve. Guidance cited may be superseded by newer versions.',
    ...
    if (body === 'FDA') {
      disclosures.push({
        ...
        description:
          '21 CFR Part 11 compliance requires validated system, audit trails, and electronic signatures.',
        mitigation:
          'Platform validation status should be confirmed via IQ/OQ/PQ records before FDA-facing use.',
      });
    }
  ...
  private calculateComplianceScore(sections: ReportSection[], frameworks: string[]): number {
    ...
    const sectionScore =
      (sections.filter(s => s.content && s.content.status !== 'awaiting_content').length /
  ...
  private async getLatestHash(organizationId: number, projectId?: number): Promise<string | null> {
    try {
      ...
      const [latest] = await db
        .select({ contentHash: immutableReportRecords.contentHash })
        .from(immutableReportRecords)
        .where(and(...conditions))
        .orderBy(desc(immutableReportRecords.createdAt))
        .limit(1);
  ...
  private async generateAttestations(
    ...
    const [dataIntegrity] = await db
      .insert(indemnificationAttestations)
      .values({
        reportId: record.id,
        organizationId: request.organizationId,
        ...
        requirementDescription:
          'All electronic records include computer-generated, time-stamped audit trails.',
        complianceStatus: 'compliant',
        complianceScore: 95,
        findings: [
          { finding: 'SHA-256 hash chain established for all report content', severity: 'info' },
        ],
        evidenceReferences: [
          { type: 'hash', id: record.contentHash, description: 'Content SHA-256 hash' },
        ],
        disclaimerText: INDEMNIFICATION_TEMPLATES[bp.indemnificationTier],
        attestationStatement:
          'Data integrity verified through cryptographic hash chain at time of generation.',
        scopeLimitations:
          'Covers report content integrity only. Source data accuracy is the responsibility of the data originator.',
        indemnificationScope: bp.indemnificationTier === 'full_audit_trail' ? 'full' : 'limited',
        verifiedBySystem: true,
        attestationHash: this.hashContent(
          this.canonicalize({
            type: 'data_integrity',
            reportId: record.id,
    ...
    const [provenance] = await db
      ...
      .values({
        ...
        requirementDescription:
          'All data points are traceable to their original source with complete provenance chains.',
        complianceStatus: 'compliant',
        complianceScore: 90,
        findings: [
          {
            finding: 'Atom-level provenance tracking enabled for all report sections',
            severity: 'info',
          },
        ],
        evidenceReferences: [
          { type: 'merkle_root', id: record.merkleRoot, description: 'Section-level Merkle root' },
        ],
        disclaimerText: INDEMNIFICATION_TEMPLATES[bp.indemnificationTier],
        attestationStatement:
          'Full provenance chain established from report content to source atoms.',
        scopeLimitations:
          'Provenance covers data fields referenced in report sections. External data sources not covered.',
        indemnificationScope: bp.indemnificationTier === 'full_audit_trail' ? 'full' : 'limited',
        verifiedBySystem: true,
        attestationHash: this.hashContent(
          this.canonicalize({
    ...
    const [methodology] = await db
      ...
      .values({
        ...
        findings: [
          {
            finding: `Generated using ${bp.label} domain blueprint with ${bp.requiredSections.length} required sections`,
            severity: 'info',
          },
        ],
        disclaimerText: INDEMNIFICATION_TEMPLATES[bp.indemnificationTier],
        ...
        scopeLimitations:
          'Methodology covers report structure and generation process. Content accuracy requires human review.',
        indemnificationScope: bp.indemnificationTier === 'full_audit_trail' ? 'full' : 'limited',
        verifiedBySystem: true,
        attestationHash: this.hashContent(
          this.canonicalize({
    ...
    const [aiTransparency] = await db
      ...
      .values({
        ...
        disclaimerText:
          'This report was generated with AI assistance. All content requires qualified human review before regulatory use.',
        attestationStatement:
          'AI involvement fully disclosed. Human review gate enforced before immutable seal.',
    ...
    for (const framework of complianceFrameworks.slice(0, 5)) {
      const [fwAttestation] = await db
        ...
        .values({
          ...
          findings: [
            {
              finding: `${framework} framework requirements mapped to report sections`,
              severity: 'info',
            },
          ],
          disclaimerText: INDEMNIFICATION_TEMPLATES[bp.indemnificationTier],
