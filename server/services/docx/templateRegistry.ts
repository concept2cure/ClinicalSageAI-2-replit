...
const indTemplate: DocumentTemplate = {
  ...
  sections: [
    ...
    { sectionCode: '1.2', title: 'FDA Form 1571', required: true, instructionalText: 'Complete FDA Form 1571 with sponsor details, drug information, and regulatory classification.' },
    { sectionCode: '1.3', title: 'FDA Form 1572', required: true, instructionalText: 'Complete investigator statement with qualifications, facilities, and commitments.' },
    { sectionCode: '1.4', title: 'FDA Form 3674', required: true, instructionalText: 'Certify compliance with ClinicalTrials.gov registration requirements.' },
    { sectionCode: '1.5', title: 'Table of Contents', required: true, instructionalText: 'Generate comprehensive table of contents for all modules.' },
    // Module 2
    { sectionCode: '2.2', title: 'Introduction', required: true, instructionalText: 'Introduce the drug, its pharmacological class, mechanism of action, and proposed indication.' },
    { sectionCode: '2.3', title: 'Quality Overall Summary', required: true, instructionalText: 'Summarize drug substance manufacturing, characterization, controls, and drug product formulation.' },
    { sectionCode: '2.4', title: 'Nonclinical Overview', required: true, instructionalText: 'Provide integrated assessment of pharmacology, pharmacokinetics, and toxicology data.' },
    { sectionCode: '2.5', title: 'Clinical Overview', required: true, instructionalText: 'Summarize product development rationale, clinical pharmacology, efficacy, and safety.' },
    { sectionCode: '2.6', title: 'Nonclinical Summaries', required: true, instructionalText: 'Written and tabulated summaries for pharmacology, PK, and toxicology.' },
    { sectionCode: '2.7', title: 'Clinical Summary', required: false, instructionalText: 'Biopharmaceutics, clinical pharmacology, efficacy, safety summaries.' },
    // Module 3
    { sectionCode: '3.2.S', title: 'Drug Substance', required: true, instructionalText: 'General information, manufacture, characterization, control, reference standards, stability.' },
    { sectionCode: '3.2.P', title: 'Drug Product', required: true, instructionalText: 'Description, pharmaceutical development, manufacture, control, stability.' },
    { sectionCode: '3.2.A', title: 'Appendices', required: false, instructionalText: 'Facilities, adventitious agents, novel excipients.' },
    // Module 4
    { sectionCode: '4.2.1', title: 'Pharmacology', required: true, instructionalText: 'Primary and secondary pharmacodynamics, safety pharmacology.' },
    { sectionCode: '4.2.2', title: 'Pharmacokinetics', required: true, instructionalText: 'Absorption, distribution, metabolism, excretion studies.' },
    { sectionCode: '4.2.3', title: 'Toxicology', required: true, instructionalText: 'Single-dose, repeat-dose, genotoxicity, reproductive toxicity studies.' },
    // Module 5
    { sectionCode: '5.3', title: 'Clinical Study Reports', required: false, instructionalText: 'ICH E3 compliant clinical study reports for prior human experience.' },
    { sectionCode: '5.4', title: 'Literature References', required: true, instructionalText: 'Published evidence supporting the clinical development program.' },
  ],
};
