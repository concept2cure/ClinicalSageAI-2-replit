...
const CFR: Record<string, CfrRef> = {
...
const CLASSIFY_CITATIONS: Citation[] = [
...
const PATHWAY_CITATIONS: Citation[] = [
...
const CLINICAL_CITATIONS: Citation[] = [
...
const SUBMISSION_CITATIONS: Citation[] = [
