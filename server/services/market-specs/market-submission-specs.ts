...
export const MARKET_SUBMISSION_SPECS: MarketSubmissionSpec[] = [
  ...
  // ── Brazil — drug/biologic eCTD ─────────────────────────────────────────────
  {
    ...
    authorityId: 'ANVISA',
    family: 'ectd',
    submissionFormat: 'ANVISA eCTD (Brazil Module 1)',
    gateway: 'ANVISA electronic petition / Solicita',
    productScope: ['drug', 'biologic', 'generic'],
    language: {
      primary: 'pt',
      productInfoLanguages: 'Labelling and product information (bula) in Portuguese.',
      translationRequired: true,
      note: 'Module 1 and labelling in Brazilian Portuguese; sworn translations of foreign documents.',
    },
    formatting: {
      fileFormats: ['PDF'],
      pdfVersions: ['1.4', '1.5', '1.6', '1.7'],
      pdfA: 'accepted',
      encryptionAllowed: false,
      fileNaming: 'Lowercase a–z, 0–9, hyphens and periods; ≤ 64 characters (eCTD convention).',
      fileNamePattern: '^[a-z0-9.-]{1,64}$',
      maxFileNameLength: 64,
      maxPathLength: 180,
      maxFileSizeMb: null,
      maxSubmissionSizeMb: null,
      checksumAlgorithm: 'MD5',
      folderConvention: 'CTD m1–m5 tree; Module 1 under m1/br/.',
    },
    backbone: {
      indexXml: true,
      regionalXmlPath: 'm1/br/br-regional.xml',
      module1Folder: 'm1/br',
      studyTaggingFiles: false,
      note: 'ICH index.xml + ANVISA br-regional.xml (Brazil M1).',
    },
    governance: {
      eSignature: { required: true, basis: 'ANVISA electronic submission rules; ICP-Brasil digital signature' },
      sequenceNumbering: 'Four-digit zero-padded (0000, 0001, …)',
      lifecycleOperations: ['new', 'replace', 'append', 'delete'],
      validationBeforeDispatch: true,
      immutabilityAfterSubmission: true,
    },
    forms: [{ name: 'ANVISA petition form (peticionamento)', required: true }],
    templates: ['regional-ctd-templates:FDA_TEMPLATE'],
    sources: [ICH, 'ANVISA eCTD guidance (RDC); Brazil M1 specification'],
  },

  // ── Saudi Arabia — drug/biologic eCTD ───────────────────────────────────────
  {
    id: 'sa-ectd',
    market: 'sa',
    authority: 'SFDA',
    authorityId: 'SFDA',
    family: 'ectd',
    submissionFormat: 'SFDA eCTD (Saudi Module 1; GCC harmonised)',
    gateway: 'SFDA electronic submission portal',
    productScope: ['drug', 'biologic', 'generic'],
    language: {
      primary: 'en',
      productInfoLanguages: 'Labelling in Arabic and English.',
      translationRequired: true,
      note: 'Dossier in English; labelling/patient information in Arabic and English.',
    },
    formatting: {
      fileFormats: ['PDF'],
      pdfVersions: ['1.4', '1.5', '1.6', '1.7'],
      ...
      maxSubmissionSizeMb: null,
      checksumAlgorithm: 'MD5',
      folderConvention: 'CTD m1–m5 tree; Module 1 under m1/sa/.',
    },
    backbone: {
      indexXml: true,
      regionalXmlPath: 'm1/sa/sa-regional.xml',
      module1Folder: 'm1/sa',
      studyTaggingFiles: false,
      note: 'ICH index.xml + SFDA sa-regional.xml (Saudi/GCC M1).',
    },
    governance: {
      eSignature: { required: true, basis: 'SFDA electronic submission requirements' },
      sequenceNumbering: 'Four-digit zero-padded (0000, 0001, …)',
      lifecycleOperations: ['new', 'replace', 'append', 'delete'],
      validationBeforeDispatch: true,
      immutabilityAfterSubmission: true,
    },
    forms: [{ name: 'SFDA application form', required: true }],
    templates: ['regional-ctd-templates:EMA_TEMPLATE'],
    sources: [ICH, 'SFDA eCTD specification; GCC harmonised M1'],
  },

  // ── South Korea — drug/biologic eCTD ────────────────────────────────────────
  {
    id: 'kr-ectd',
    market: 'kr',
    authority: 'MFDS',
    authorityId: 'MFDS',
    family: 'ectd',
    submissionFormat: 'MFDS eCTD (Korea Module 1)',
    gateway: 'MFDS electronic submission system',
    productScope: ['drug', 'biologic', 'generic'],
    language: {
      primary: 'ko',
      productInfoLanguages: 'Labelling and product information in Korean.',
      translationRequired: true,
      note: 'Module 1 and labelling in Korean; Korean translations of foreign data expected.',
    },
    formatting: {
      fileFormats: ['PDF'],
      pdfVersions: ['1.4', '1.5', '1.6', '1.7'],
      ...
      maxSubmissionSizeMb: null,
      checksumAlgorithm: 'MD5',
      folderConvention: 'CTD m1–m5 tree; Module 1 under m1/kr/.',
    },
    backbone: {
      indexXml: true,
      regionalXmlPath: 'm1/kr/kr-regional.xml',
      module1Folder: 'm1/kr',
      studyTaggingFiles: false,
      note: 'ICH index.xml + MFDS kr-regional.xml (Korea M1).',
    },
    governance: {
      eSignature: { required: true, basis: 'MFDS electronic submission requirements' },
      sequenceNumbering: 'Four-digit zero-padded (0000, 0001, …)',
      lifecycleOperations: ['new', 'replace', 'append', 'delete'],
      validationBeforeDispatch: true,
      immutabilityAfterSubmission: true,
    },
    forms: [{ name: 'MFDS application form', required: true }],
    templates: ['regional-ctd-templates:FDA_TEMPLATE'],
    sources: [ICH, 'MFDS eCTD specification (Korea M1)'],
  },
