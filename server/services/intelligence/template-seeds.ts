...
const SEED_TEMPLATES: SeedTemplate[] = [
  ...
  // starts empty and the author writes it; no fabricated prose.
  {
    ...
    sections: [
      ...
      { sectionCode: '2.5.6', sectionTitle: 'Benefits and Risks Conclusions', ordering: 600, required: true, criticality: 'blocking', contentGuidance: 'Integrated benefit–risk assessment supporting the proposed indication and labeling: therapeutic context, key benefits, key risks, risk management, and the explicit conclusion. Many reviewers read this section first.', requiredElements: ['therapeutic context', 'benefit summary', 'risk summary and management', 'explicit benefit-risk conclusion'] },
  ...
  },
  {
    ...
    sections: [
      { sectionCode: '3.2.S.1', sectionTitle: 'General Information', ordering: 100, required: true, criticality: 'important', contentGuidance: 'Nomenclature, structure, and general properties of the drug substance. Feeds from the substance register; the Module 3 operating system compiles this key.', requiredElements: ['nomenclature', 'structure', 'physicochemical properties'] },
