...
export const REPORT_TYPE_SEED: ReportTypeDefinition[] = [
  ...
  {
    // Time-&-effort certification register (2 CFR 200.430; effort-certification add-on).
    typeId: 'effort.certification_register',
    label: 'Effort Certification Register',
    family: 'effort_certification',
    allowedScopes: ['program', 'project', 'account'],
    allowedPersonas: ['compliance_officer', 'ra_lead', 'finance'],
    allowedClientSegments: ['academic', 'biotech', 'pharma'],
    dataDependencies: ['effort_certifications', 'effort_lines'],
    artifactDependencies: ['concept2cure_artifacts'],
    workflowDependencies: ['governance_boundary'],
    anaModules: ['ana-ri'],
    exportTemplate: 'effort-certification-register',
    governanceRequirements: { part11: true, auditTrail: true },
    truthfulnessRules: { allowPartial: true, requireBlockers: true, forbidFinalIfMissingCritical: true },
  },
  {
    // Research-security / FCOI disclosure register (NSPM-33 / NOT-OD-26-017; research-security add-on).
    typeId: 'research_security.coi_register',
    label: 'Research Security & COI Disclosure Register',
    family: 'research_security',
    allowedScopes: ['program', 'project', 'account'],
    allowedPersonas: ['compliance_officer', 'ra_lead', 'research_security'],
    allowedClientSegments: ['academic', 'biotech', 'pharma'],
    dataDependencies: ['coi_disclosures', 'research_personnel'],
    artifactDependencies: ['concept2cure_artifacts'],
    workflowDependencies: ['governance_boundary'],
    anaModules: ['ana-ri'],
    exportTemplate: 'research-security-coi-register',
    governanceRequirements: { part11: true, auditTrail: true },
    truthfulnessRules: { allowPartial: true, requireBlockers: true, forbidFinalIfMissingCritical: true },
  },
];
