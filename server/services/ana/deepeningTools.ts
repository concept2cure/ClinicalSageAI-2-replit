  ...
  input_schema: {
    ...
    properties: {
      register: {
        ...
        enum: ['stability', 'method', 'specification', 'batch', 'qc_result', 'container_closure', 'reference_standard', 'impurity_profile', 'dissolution_profile', 'material_spec', 'formulation_record'],
      },
      search: {
        type: 'string',
