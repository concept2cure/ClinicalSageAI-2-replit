...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const { deviceName, predicateDevice, predicateK, similarities = [], differences = [] } =
        validation.data;
...
router.get('/templates/:docType', authMiddleware, requireEditorAccess, (req: Request, res: Response) => {
