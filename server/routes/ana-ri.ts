...
// Response envelope helpers live in ./ana-ri/shared.ts so per-route modules
// (./ana-ri/plan.ts and any future split modules) can import the same shapes.
import { sendSuccess, sendError } from './ana-ri/shared.js';
...
// /plan + /plan/:planRunId/* endpoints live in ./ana-ri/plan.ts. Mounting here
// keeps the same /api/ana-ri/plan* paths active without duplicating handlers.
