...
router.post('/upload-protocol', upload.single('file'), async (req, res) => {
  try {
    ...
    const design = {
      protocol:
        'Based on analysis of similar trials, we recommend simplifying inclusion criteria and increasing sample size by 20% to improve power for secondary endpoints.',
      justification: [
