 ...
 * keys the v2 IndLifecycle surface consumes ({ submissionId, code, drugName, productName,
 * indication, sponsorName, submissionType, targetReceiptDate, forms[], sections[] }),
 * assembled
