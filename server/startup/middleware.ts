...
export function applyCoreMiddleware(app: Express, debugLog: DebugLogger): void {
  ...
  // 6b. Prototype-pollution scrub. MUST run after the body parsers — Express
  //     does not populate req.body until express.json/urlencoded execute, so
  //     mounting this any earlier (as applySecurityMiddleware used to) made
  //     the body-side scrub a silent no-op.
