 ...
 *
 * Matches the path exactly or as a strict subpath (route + '/'). Bare prefix
 * matching is intentionally avoided so a crafted path like '/auth/loginEvil'
 * cannot inherit the '/auth/login' exemption and bypass authentication.
 */
const publicRoutes = [
  '/api/health',
  '/health',
