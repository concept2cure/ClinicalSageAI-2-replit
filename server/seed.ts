...
// The seed targets the default/demo organization (id 1), which the bootstrap
// org seed creates before this dev routine runs.
const SEED_ORG_ID = 1;
...
async function seed() {
  ...
  // Sample CSR Reports — mapped onto the real csr_reports columns. The legacy
  // seed's summary/fileName/fileSize fields have no real columns; the summary
  // is preserved inside the metadata JSON and the file details are dropped.
  const reports = [
    {
      organizationId: SEED_ORG_ID,
      reportId: 'aducanumab-phase3',
      reportTitle: 'Aducanumab Phase 3 Study',
    ...
    {
      organizationId: SEED_ORG_ID,
      reportId: 'tirzepatide-surpass1',
      reportTitle: 'Tirzepatide SURPASS-1 Trial',
      title: 'Tirzepatide SURPASS-1 Trial',
      sponsor: 'Eli Lilly',
      indication: 'Diabetes Type 2',
      phase: 'Phase 3',
      status: 'Processed',
      reportDate: '2022-12-04',
    ...
    {
      organizationId: SEED_ORG_ID,
      reportId: 'tofersen-als-phase1-2',
      reportTitle: 'Tofersen SOD1-ALS Phase 1/2',
  ...
  const details = [
    {
      ...
      // studyDescription/treatmentArms/studyDuration/safety/processed have no
      // dedicated columns; preserved inside the metadata JSON.
      metadata: {
        studyDescription:
    ...
    },
    {
      ...
      metadata: {
        ...
        safety: {
          ...
          severeEvents:
            'Low rates of severe hypoglycemia were reported across all treatment groups.',
