...
class AuditTrailPDF(FPDF):
    ...
    def footer(self):
        ...
        self.set_text_color(*_GRAY)
        self.cell(0, 4, "Concept2Cure - 21 CFR Part 11 Compliant Audit Trail - Confidential", align="L")
...
def _build_event_table(pdf: AuditTrailPDF, pp_row: dict[str, Any]):
    ...
    if len(events) == 0:
        ...
        pdf.multi_cell(0, 4, _sanitize(
            ...
            "through the Concept2Cure platform. This proof pack may have been "
...
def _build_attestation(pdf: AuditTrailPDF, pp_row: dict[str, Any]):
    ...
    pdf.set_text_color(*_BLACK)
    pdf.multi_cell(0, 4, _sanitize(
        "This audit trail was generated automatically by Concept2Cure. "
