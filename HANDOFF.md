...
- **Status:** Draft PR #550 opened in `concept2cure/ClinicalSageAI-2-replit` — `docs/legacy/PDEV_IND_DESIGN_BRIEF.md` (691 lines) imported to this project root.
...
- **2026-05-20** — PDEV → IND design brief inbound (PR #550). Imported `docs/legacy/PDEV_IND_DESIGN_BRIEF.md` (691 lines) to project root. Awaiting designer review of 8 open questions (§9) before Phase 7 kit construction begins. See "Inbound work — PDEV → IND" above for the surface inventory + acceptance contract.
