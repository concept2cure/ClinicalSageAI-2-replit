...
const EXEMPTED_FILES: Record<string, string> = {
  ...
  'export-control.ts':
    'No downloadable file output — ITAR/EAR/OFAC export-control screening API returning JSON assessments and determinations via res.json, not governed file downloads',
