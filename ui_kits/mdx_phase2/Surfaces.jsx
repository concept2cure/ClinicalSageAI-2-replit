/* global React, I, MDX_PROGRAMS, MDX_HEALTH, K510_STAGES, K510_PREDICATES, K510_SE_ROWS, K510_ESTAR, PMA_PHASES, PMA_MODULES, PMA_TRIAL_METRICS, CER_SIGNALS, CER_LITERATURE, CER_EXPORT */
...
/* ═══════════ PMA ═══════════ */
function PMASurface({ onOpenEditor }) {
  return (
    <>
      <div className="section-hdr">
        <div>
