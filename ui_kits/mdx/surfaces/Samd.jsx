/**
 * SaMD workspace — Phase 7 · doc-first.
 *
...
const { SAMD_KPIS, SAMD_CLASSES, SAMD_REQS, SAMD_OTS, SAMD_ANOMALIES, SAMD_PCCP, SAMD_DOCUMENTS, SAMD_DOC_FRAMEWORKS } = window;

function SamdSurface({ program, onAskAna, onOpenEditor }) {
...
window.SamdSurface = SamdSurface;
