/**
 * Clinical study management — Phase 7 · doc-first + funnel + site grid.
 */

(() => {

const { I, DocumentsPanel } = window;
const { CLIN_KPIS, CLIN_FUNNEL, CLIN_SITES, CLIN_DEVIATIONS, CLIN_ADJUDICATION, CLIN_DOCUMENTS, CLIN_DOC_FRAMEWORKS } = window;

function ClinicalSurface({ program, onAskAna, onOpenEditor }) {
...
window.ClinicalSurface = ClinicalSurface;
