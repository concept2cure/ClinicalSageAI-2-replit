...
window.UDI_AGENCIES = UDI_AGENCIES;
window.UDI_DEVICES = UDI_DEVICES;
window.UDI_LABELS = UDI_LABELS;
window.UDI_SYMBOLS = UDI_SYMBOLS;
window.UDI_ISSUES = UDI_ISSUES;
window.UDI_MRI = UDI_MRI;
