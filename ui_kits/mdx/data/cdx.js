...
window.CDX_KPIS = CDX_KPIS;
window.CDX_TIMELINE = CDX_TIMELINE;
window.CDX_CONCORDANCE = CDX_CONCORDANCE;
window.CDX_XREF = CDX_XREF;

const CDX_DOC_FRAMEWORKS = [
...
window.CDX_DOC_FRAMEWORKS = CDX_DOC_FRAMEWORKS;
window.CDX_DOCUMENTS = CDX_DOCUMENTS;
