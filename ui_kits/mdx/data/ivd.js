...
window.IVD_ANALYTES = IVD_ANALYTES;
window.IVD_KPIS = IVD_KPIS;
window.IVD_ANALYTICAL = IVD_ANALYTICAL;
window.IVD_CLINICAL = IVD_CLINICAL;
window.IVD_REFMATS = IVD_REFMATS;

/* IVD docs — analytical reports, clinical reports, CLIA waiver, performance summary */
const IVD_DOC_FRAMEWORKS = [
...
window.IVD_DOC_FRAMEWORKS = IVD_DOC_FRAMEWORKS;
window.IVD_DOCUMENTS = IVD_DOCUMENTS;
