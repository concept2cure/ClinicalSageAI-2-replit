/**
 * Phase 7 · Clinical study management workspace.
 *
 * Pivotal trial workspace for PMA + 510(k) clinical when needed. Protocol
 * editor with IRB amendments, site list + activation, subject screening
 * funnel, deviation tracking, AE capture, endpoint adjudication queue,
 * SAP version control, BIMO readiness.
 *
...
window.CLIN_KPIS = CLIN_KPIS;
window.CLIN_FUNNEL = CLIN_FUNNEL;
window.CLIN_SITES = CLIN_SITES;
window.CLIN_DEVIATIONS = CLIN_DEVIATIONS;
window.CLIN_ADJUDICATION = CLIN_ADJUDICATION;

const CLIN_DOC_FRAMEWORKS = [
...
const CLIN_DOCUMENTS = [
  { id: 'doc-clin-protocol', framework: 'protocol', type: 'Protocol — pivotal',    title: 'CV-330 pivotal trial protocol (CL-330-PIV-001)',           ver: 'v3.2', status: 'locked',  completion: 100, blocker: false, owner: 'MW', reviewers: ['JC', 'CRO-Camille'], lastEdit: '2024-08-12', esigRequired: true, esigState: 'signed', signedBy: 'MW · 2024-08-10', sections: 28, sectionsComplete: 28, editor: 'engineering' },
  { id: 'doc-clin-amend', framework: 'protocol', type: 'Protocol amendment',       title: 'CL-330-PIV-001 Amendment v2.1 — extended age window for cohort B', ver: 'v2.1', status: 'review',  completion: 92, blocker: false, owner: 'MW', reviewers: ['JC'], lastEdit: '2d ago', esigRequired: true, esigState: 'pending', sections: 4, sectionsComplete: 4, editor: 'engineering' },
  { id: 'doc-clin-sap',  framework: 'sap',      type: 'Statistical Analysis Plan', title: 'CL-330-PIV-001 SAP v2.0 — primary + secondary endpoints',  ver: 'v2.0', status: 'review',  completion: 88, blocker: false, owner: 'RA', reviewers: ['MW'], lastEdit: '8d ago', esigRequired: true, esigState: 'pending', sections: 22, sectionsComplete: 20, editor: 'engineering' },
  { id: 'doc-clin-dsmb', framework: 'dsmb',     type: 'DSMB charter',              title: 'CV-330 DSMB charter v1.4',                                   ver: 'v1.4', status: 'draft',   completion: 42, blocker: true,  owner: 'MW', reviewers: [], lastEdit: '5h ago', esigRequired: true, esigState: 'na', sections: 11, sectionsComplete: 5, blockerNote: 'CRO sign-off pending · interim analysis criteria still in debate', editor: 'engineering' },
  { id: 'doc-clin-bimo', framework: 'bimo',     type: 'BIMO readiness pack',       title: 'BIMO inspection-readiness packet — CV-330',                  ver: 'v0.6', status: 'draft',   completion: 48, blocker: false, owner: 'JC', reviewers: [], lastEdit: '1d ago', esigRequired: false, esigState: 'na', sections: 14, sectionsComplete: 7, editor: 'engineering' },
];

window.CLIN_DOC_FRAMEWORKS = CLIN_DOC_FRAMEWORKS;
window.CLIN_DOCUMENTS = CLIN_DOCUMENTS;
