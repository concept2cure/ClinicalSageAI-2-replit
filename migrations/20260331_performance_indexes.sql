...
DO $$ BEGIN
  IF to_regclass('public.csr_reports') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'csr_reports' AND column_name IN ('organization_id', 'status')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.concept2cure_artifacts') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'concept2cure_artifacts' AND column_name IN ('organization_id', 'project_id')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.concept2cure_artifacts') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'concept2cure_artifacts' AND column_name IN ('organization_id', 'artifact_type')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.projects') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'projects' AND column_name IN ('organization_id', 'status')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.documents') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'documents' AND column_name IN ('organization_id', 'project_id')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.concept2cure_review_tasks') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'concept2cure_review_tasks' AND column_name IN ('organization_id', 'status')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.workflow_approvals') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'workflow_approvals' AND column_name IN ('organization_id', 'status')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.concept2cure_notifications') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'concept2cure_notifications' AND column_name IN ('organization_id', 'user_id')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.concept2cure_notifications') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'concept2cure_notifications' AND column_name IN ('user_id', 'is_read')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.project_memory_entries') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'project_memory_entries' AND column_name IN ('project_id', 'category')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.regulatory_audit_logs') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'regulatory_audit_logs' AND column_name IN ('organization_id', 'created_at')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.c2c_submission_packages') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'c2c_submission_packages' AND column_name IN ('organization_id', 'status')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.coauthor_documents') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'coauthor_documents' AND column_name IN ('organization_id', 'project_id')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.unified_tasks') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'unified_tasks' AND column_name IN ('organization_id', 'status')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.deep_research_jobs') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'deep_research_jobs' AND column_name IN ('organization_id', 'status')) = 2
  THEN
...
DO $$ BEGIN
  IF to_regclass('public.audit_logs') IS NOT NULL
     AND (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'audit_logs' AND column_name IN ('organization_id', 'created_at')) = 2
  THEN
