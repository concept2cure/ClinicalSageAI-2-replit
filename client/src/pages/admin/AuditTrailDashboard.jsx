...
export default function AuditTrailDashboard() {
 ...
 switch (actionType) {
 case 'Upload':
 return <DownloadCloud className="h-4 w-4 text-stone-500" />;
 case 'Download':
 ...
 <div className="h-12 w-12 border-4 border-t-stone-600 border-stone-200 rounded-full animate-spin"></div>
 ...
 <div className="h-10 w-10 border-4 border-t-stone-600 border-stone-200 rounded-full animate-spin"></div>
 </div>
 ) : logs.length === 0 ? (
