...
const SeverityIcon = ({ severity }) => {
 ...
 case 'minor':
 return <QuestionMarkCircledIcon className="w-5 h-5 text-stone-600" />;
 default:
...
const ValidationDashboard = () => {
 ...
 <div className="flex flex-col items-center p-2 bg-stone-50 rounded">
 <span className="text-xs text-stone-700">Minor</span>
 <span className="text-lg font-bold text-stone-700">{stats.minorCount}</span>
 </div>
 </div>
 ...
 <span className="text-stone-600 font-bold">{stats.minorCount}</span>
 </li>
 </ul>
 </div>
 </div>
 ...
 {stats.minorCount > 0 && (
 <div>
 <h3 className="text-lg font-medium text-stone-600 mb-2">Minor Issues</h3>
 <div className="space-y-2">
 {validationResults.issues
 .filter(issue => issue.severity === 'minor')
 .map((issue, index) => (
 <Card key={`minor-${index}`} className="border-stone-200">
 <CardContent className="p-4">
 <div className="flex items-start gap-3">
 ...
 <Card key={`suggestion-${index}`} className="border-stone-100">
 <CardContent className="p-4">
 <div className="flex items-start gap-3">
 <InfoCircledIcon className="w-5 h-5 text-stone-600 mt-0.5" />
 <div>
