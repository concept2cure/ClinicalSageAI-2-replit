...
const VaultBrowser = () => {
 ...
 moduleColor="from-stone-700 to-stone-800"
 />
 ...
 <Button variant="outline" className="bg-white hover:bg-stone-50" asChild>
 <Link href="/coauthor">
 <ArrowLeft className="h-4 w-4 mr-2 text-stone-600" />
 <span className="text-stone-600">Back to eCTD CoAuthor</span>
 </Link>
 </Button>
 </div>

 {/* Guidance banner explaining the two-way workflow */}
 <div className="bg-gradient-to-r from-stone-50 to-indigo-50 px-4 py-2 border-t border-b border-stone-200">
