        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex space-x-2 mt-1">
              ...
              <Button variant="outline" size="sm" className="flex-1 bg-blue-50 border-blue-200">
                Phase 2
              </Button>
              <Button variant="outline" size="sm" className="flex-1">
                Phase 3
                ...
                <Card>
                  <CardContent className="p-4">
                    ...
                    <div className="text-xs text-gray-500 flex items-center justify-between mt-2">
                      ...
                      <div>
                        Adoption Rate: <span className="text-blue-600 font-medium">High</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-4">
                    ...
                    <div className="text-xs text-gray-500 flex items-center justify-between mt-2">
                      ...
                      <div>
                        Adoption Rate: <span className="text-blue-600 font-medium">Medium</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-4">
                    ...
                    <div className="text-xs text-gray-500 flex items-center justify-between mt-2">
                      ...
                      <div>
                        Adoption Rate: <span className="text-blue-600 font-medium">Very High</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
