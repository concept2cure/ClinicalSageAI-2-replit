...
export default function AnaCortex() {
 ...
 <div>
 <h1 className="text-lg font-semibold text-stone-900">Regulatory Intelligence</h1>
 <p className="text-xs text-stone-500">Regulatory Intelligence Assistant</p>
 </div>
 </div>
 </div>
 <div className="text-sm text-stone-500">Powered by Concept2Cure RI</div>
 </div>
 </div>
 </header>
 ...
 <AnaCortexChat className="h-[calc(100vh-180px)] shadow-sm border border-stone-200/60 bg-white/80" />
 </div>
 </main>

 {/* Footer hint */}
 <footer className="fixed bottom-0 left-0 right-0 py-2 text-center text-xs text-stone-500 bg-white/80 backdrop-blur-sm border-t border-stone-200/60">
