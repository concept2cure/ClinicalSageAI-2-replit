...
<ectd:submission xmlns:ectd="http://www.ich.org/ectd" xmlns:xlink="http://www.w3c.org/1999/xlink">
 ...
 <FileText className="h-4 w-4 mr-1 text-stone-600 flex-shrink-0" />
 )}
 <span className={item.type === 'file' ? 'text-stone-600' : ''}>
 {item.name}
 </span>
 </div>
 ))}
 ...
 <pre className="font-mono text-sm text-stone-700 whitespace-pre-wrap">
 {xmlPreview}
 </pre>
 </div>
 </CardContent>
 ...
 <ArrowRight className="h-4 w-4 mr-2 mt-0.5 text-stone-600" />
 <span>
 ...
 <div className="border rounded p-4 bg-stone-50 border-stone-200">
 <h3 className="font-medium mb-2 text-stone-800">Recommendations</h3>
 ...
 <div className="border rounded p-4 bg-stone-50 border-stone-200">
 <h3 className="font-medium mb-2 text-stone-800">Next Steps</h3>
