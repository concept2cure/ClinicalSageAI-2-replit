...
export default function FulleCTDCoAuthor() {
 ...
 <div className="w-8 h-8 bg-stone-800 text-white rounded-full flex items-center justify-center text-sm font-medium">
 1
 </div>
 ...
 <Button variant="link" className="text-stone-600">
 View Full Tutorial
 </Button>
 </div>
 </CardContent>
 ...
 <Edit className="h-5 w-5 text-stone-600" />
 ...
 <Button
 className="bg-gradient-to-r from-stone-600 to-purple-600 hover:from-stone-700 hover:to-purple-700 text-white"
 ...
 <div className="flex items-center space-x-2">
 <Badge className="bg-stone-100 text-stone-800">ICH Compliant</Badge>
 </div>
 </div>
 </CardHeader>
 <CardContent>
