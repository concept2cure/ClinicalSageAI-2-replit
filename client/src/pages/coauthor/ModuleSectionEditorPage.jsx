...
export default function ModuleSectionEditorPage() {
 ...
 { id: 1, name: 'Dr. Sarah Chen', initials: 'SC', avatar: '👩‍⚕️', color: 'bg-stone-700' },
 ...
 return (
 <div className="min-h-screen bg-gradient-to-br from-gray-50 to-stone-50 p-4 md:p-8">
 ...
 <CardHeader className="bg-gradient-to-r from-stone-700 to-indigo-600 text-white">
 ...
 <CardDescription className="text-stone-200 mt-2">
