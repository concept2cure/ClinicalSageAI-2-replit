...
const DocumentTemplates = () => {
 ...
 <FileText className="h-5 w-5 mr-3 text-stone-600" />
 <div>
 ...
 <Card className="md:col-span-3 bg-stone-50 border-stone-200">
 <CardHeader>
 <CardTitle className="text-stone-800">Regulatory-Compliant Templates</CardTitle>
 ...
 <div>
 <h4 className="font-medium text-stone-800">Submission-Ready</h4>
 ...
 <div>
 <h4 className="font-medium text-stone-800">Module-Specific</h4>
 <p className="text-sm text-stone-700">
 ...
 <div className="flex items-start">
 <div className="bg-stone-100 p-2 rounded-full mr-3">
 <FileTerminal className="h-5 w-5 text-stone-600" />
 </div>
 <div>
 <h4 className="font-medium text-stone-800">Pre-Validated</h4>
 <p className="text-sm text-stone-700">
