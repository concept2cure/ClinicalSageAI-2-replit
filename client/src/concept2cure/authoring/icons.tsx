/**
 * Universal Authoring — Lucide-style icon set (Phase 9).
 * Ported verbatim from ui_kits/authoring/Icons.jsx. Lucide only.
 *
 * @module client/src/concept2cure/authoring/icons
 */
...
export type AuthIconKey = keyof typeof I;
