...
const MobileHeader: React.FC<MobileHeaderProps> = ({ onMenuClick }) => (
  <div className="flex h-14 items-center justify-between border-b border-stone-200 bg-white px-4 md:hidden">
    <button
      onClick={onMenuClick}
      className="p-2 -ml-2 rounded-md text-stone-500 hover:bg-stone-100 hover:text-stone-700"
        ...
        <MobileSidebar isOpen={mobileSidebarOpen} onClose={() => setMobileSidebarOpen(false)}>
          <div className="relative h-full">
            ...
            <button
              ...
              className="absolute top-3 right-3 z-10 p-2 rounded-md text-stone-500 hover:bg-stone-100 hover:text-stone-700"
