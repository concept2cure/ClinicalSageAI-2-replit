// Risk Lucide icon subset — mirrors labeling/icons.tsx. Lucide only.
...
const icons = {
  ...
  grid:      <Icon><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/></Icon>,
  ...
  pen:         <Icon><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4z"/></Icon>,
} as const;

export type RiskIconName = keyof typeof icons;

export function RiskIcon({ name, size }: { name: RiskIconName | string; size?: number }) {
