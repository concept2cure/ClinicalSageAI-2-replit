...
export const APPS_CATALOG: AppsCatalogGroup[] = [
  { group: 'Core workspace', note: 'The shared spine for every client type', apps: [
    ...
    { id: 'program-journey', tier: 'Core', on: true, desc: 'Interactive journey map: full program lifecycle from discovery through approval milestones.' },
    { id: 'evidence-search', tier: 'Core', on: true, desc: 'AI-powered semantic search across vault documents, literature, and clinical data sources.' },
  ] },
  { group: 'Authoring', note: 'Create and co-author the governed record', apps: [
    ...
    { id: 'authoring-engine', tier: 'Included', on: true, desc: 'AI co-authoring engine with governed drafting, regulatory context, and version control.' },
    { id: 'batch-draft', tier: 'Included', on: true, desc: 'Multi-section batch drafting -- queue sections for AI generation with consistent cross-section context.' },
    { id: 'inconsistency', tier: 'Included', on: true, desc: 'Cross-document contradiction detection -- flags conflicting claims, data, and terminology across the dossier.' },
    { id: 'source-tracer', tier: 'Included', on: true, desc: 'Source traceability -- every AI-drafted sentence linked to its evidence atoms and citations.' },
    { id: 'nonclinical', tier: 'Included', on: true, desc: 'Nonclinical study workspace: toxicology, pharmacology, ADME summaries, and Module 2.4/2.6.' },
    { id: 'doc-journey', tier: 'Included', on: true, desc: 'Document lifecycle dashboard -- draft to review to approval to filing status for every governed document.' },
    { id: 'ectd-compile', tier: 'Included', on: true, desc: 'eCTD sequence compiler: leaf validation, backbone assembly, region-specific packaging.' },
  ] },
  { group: 'Submissions & filing', note: 'Plan, assemble and transmit', apps: [
    ...
    { id: 'maa-cockpit', tier: 'Included', on: true, desc: 'EU MAA filing cockpit: CTD M1-5 readiness for EMA centralized and national authorities.' },
    { id: 'communication-center', tier: 'Included', on: true, desc: 'Agency correspondence hub -- IR responses, LoQ tracking, official meeting requests, timeline management.' },
    { id: 'pdev', tier: 'Included', on: true, desc: 'Pediatric development planner: iPSP/PIP strategy, extrapolation models, age-appropriate formulation.' },
    { id: 'crl-library', tier: 'Included', on: true, desc: 'Complete Response Letter library -- CRL analysis, response strategy, precedent matching.' },
  ] },
  ...
  { group: 'Science & analysis', note: 'Evidence-grade intelligence', apps: [
    ...
    { id: 'biostat-workbench', tier: 'Included', on: true, desc: 'Interactive biostatistics workbench: TLF shells, analysis datasets, efficacy and safety tables.' },
    { id: 'clinical-ops', tier: 'Included', on: true, desc: 'Clinical operations dashboard -- site management, enrollment tracking, study conduct oversight.' },
    { id: 'pharmacovigilance', tier: 'Included', on: true, desc: 'Pharmacovigilance signal detection: aggregate analysis, PBRER/PSUR generation, safety intelligence.' },
    { id: 'pv-cockpit', tier: 'Included', on: true, desc: 'PV cockpit: real-time safety signal monitoring, ICSR management, regulatory safety reporting.' },
    { id: 'decision-lineage', tier: 'Included', on: true, desc: 'Decision-lineage graph -- trace every regulatory and authoring decision to its evidence and rationale.' },
    { id: 'insights', tier: 'Included', on: true, desc: 'Portfolio intelligence insights -- cross-project analytics, trend detection, readiness scoring.' },
  ] },
  { group: 'Lifecycle & access', note: 'Post-approval and commercial', apps: [
    ...
    { id: 'lifecycle-mgmt', tier: 'Included', on: true, desc: 'Post-approval lifecycle management: variations, renewals, label updates, type II amendments.' },
    { id: 'pediatric', tier: 'Included', on: true, desc: 'Pediatric regulatory strategy: PIP/iPSP compliance, pediatric study plans, waivers and deferrals.' },
    { id: 'orphan', tier: 'Included', on: true, desc: 'Orphan drug designation management: market exclusivity tracking, annual reports, sponsor obligations.' },
  ...
  { group: 'Governance', note: 'Review, orchestrate, audit', apps: [
    ...
    { id: 'shadow-review', tier: 'Included', on: true, desc: 'AI shadow reviewer -- pre-submission simulation of FDA/EMA review to identify Refuse-to-File risk.' },
    { id: 'dispatch-readiness', tier: 'Included', on: true, desc: 'Submission dispatch readiness gate: final validation, completeness check, hold/release decision.' },
    { id: 'quality', tier: 'Included', on: true, desc: 'Quality management: CAPA, deviations, change control, GxP compliance dashboards.' },
  ] },
];
