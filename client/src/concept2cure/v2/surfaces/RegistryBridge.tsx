...
const REGISTRY_SOURCE: Record<string, Record<string, RegistryTuple[]>> = {
  ...
  medical_devices: {
    ...
    device_market_auth_eu: [
      ['eu_mdr_i', 'EU MDR Class I Self-declaration', 'EMA', 'EU', '—', '—', 'NeeS', 'Manufacturer self-declares conformity.', 'device'],
      ['eu_mdr_iia', 'EU MDR Class IIa', 'EMA', 'EU', '—', '—', 'NeeS', 'Notified Body assessment required.', 'device'],
      ['eu_mdr_iib', 'EU MDR Class IIb', 'EMA', 'EU', '—', '—', 'NeeS', 'Higher-risk device assessment.', 'device'],
      ['eu_mdr_iii', 'EU MDR Class III', 'EMA', 'EU', '—', '—', 'NeeS', 'Highest-risk implantable/life-sustaining devices.', 'device'],
  ...
  diagnostics_ivd: {
    ivd_market_auth: [
      ...
      ['eu_ivdr_a', 'EU IVDR Class A', 'EMA', 'EU', '—', '—', 'NeeS', 'Self-declared conformity for low-risk IVDs.', 'ivd'],
      ['eu_ivdr_b', 'EU IVDR Class B', 'EMA', 'EU', '—', '—', 'NeeS', 'Notified Body assessment for Class B IVDs.', 'ivd'],
      ['eu_ivdr_cd', 'EU IVDR Class C/D', 'EMA', 'EU', '—', '—', 'NeeS', 'High-risk IVD assessment (incl. self-testing, blood screening).', 'ivd'],
    ],
    ivd_companion_dx: [
      ['cdx_pma', 'Companion Dx PMA', 'FDA', 'US', 'eCTD', '—', 'eCTD', 'PMA for companion diagnostic device.'],
      ['cdx_ivdr_d', 'CDx EU IVDR Class D', 'EMA', 'EU', '—', '—', 'NeeS', 'EU companion diagnostic under IVDR.', 'ivd'],
    ...
    ivd_clinical_performance: [
      ['ivdr_perf_study', 'IVDR Performance Study', 'EMA', 'EU', '—', '—', 'NeeS', 'EU IVDR clinical performance study notification.', 'ivd'],
      ['ivd_clin_evidence', 'Clinical Evidence Summary', 'EMA', 'EU', '—', '—', 'NeeS', 'EU IVDR clinical evidence compilation.', 'ivd'],
      ['ivdr_pmpf', 'Post-market Performance Follow-up', 'EMA', 'EU', '—', '—', 'NeeS', 'Ongoing performance data collection plan.', 'ivd'],
    ...
    ivd_post_market: [
      ['ivd_pms_plan', 'Post-Market Surveillance Plan', 'EMA', 'EU', '—', '—', 'NeeS', 'EU IVDR post-market surveillance plan.', 'ivd'],
