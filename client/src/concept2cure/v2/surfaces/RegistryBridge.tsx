...
const REGISTRY_SOURCE: Record<string, Record<string, RegistryTuple[]>> = {
  pharma_biotech: {
    ...
    investigational: [
      ...
      ['cta_nmpa', 'Clinical Trial Application', 'NMPA', 'CN', 'CTD', 'M1–M5', 'CTD', 'NMPA CTA for first-in-human through Phase III.'],
  ...
  medical_devices: {
    device_pre_submission: [
      ['class_513g', '513(g) Classification Request', 'FDA', 'US', '—', '—', 'Letter', 'Request FDA classification and regulatory requirements.'],
      ['pre_sub_qsub', 'Pre-Submission (Q-Sub)', 'FDA', 'US', 'eSTAR', '—', 'eSTAR', 'Formal feedback meeting with CDRH.'],
      ['breakthrough_dev', 'Breakthrough Device Designation', 'FDA', 'US', '—', '—', 'Letter', 'Expedited development for life-threatening conditions.'],
      ['rfd_ocp', 'Request for Designation (RFD)', 'FDA', 'US', '—', '—', 'Letter', 'OCP determination for combination products.'],
      ['dev_nb_consult', 'Notified Body Consultation', 'EMA', 'EU', '—', '—', '—', 'EU Notified Body pre-submission consultation.'],
    ],
    device_market_auth_us: [
      ...
      ['fda_hde', 'Humanitarian Device Exemption (HDE)', 'FDA', 'US', 'eCTD', '—', 'eCTD', 'Device for < 8,000 patients/year.'],
    ...
    device_market_auth_eu: [
      ['eu_mdr_i', 'EU MDR Class I Self-declaration', 'EMA', 'EU', '—', '—', 'NeeS', 'Manufacturer self-declares conformity.'],
      ['eu_mdr_iia', 'EU MDR Class IIa', 'EMA', 'EU', '—', '—', 'NeeS', 'Notified Body assessment required.'],
      ['eu_mdr_iib', 'EU MDR Class IIb', 'EMA', 'EU', '—', '—', 'NeeS', 'Higher-risk device assessment.'],
      ['eu_mdr_iii', 'EU MDR Class III', 'EMA', 'EU', '—', '—', 'NeeS', 'Highest-risk implantable/life-sustaining devices.'],
      ['uk_ukca', 'UKCA Registration', 'MHRA', 'UK', '—', '—', '—', 'UK Conformity Assessment post-Brexit.'],
    ],
    device_market_auth_intl: [
      ['pmda_shonin', 'Shonin Approval', 'PMDA', 'JP', 'CTD', '—', 'CTD', 'PMDA new medical device approval.'],
      ['pmda_nintei', 'Nintei Certification', 'PMDA', 'JP', 'CTD', '—', 'CTD', 'PMDA certified medical device.'],
      ['nmpa_device', 'Device Registration', 'NMPA', 'CN', 'CTD', '—', 'CTD', 'NMPA medical device registration for China.'],
      ['tga_device', 'Device Inclusion', 'TGA', 'AU', '—', '—', 'ARTG', 'TGA inclusion in the ARTG.'],
      ['hc_mdl', 'Medical Device Licence', 'Health Canada', 'CA', '—', '—', '—', 'Health Canada device licensing.'],
      ['ch_device', 'Device Conformity', 'Swissmedic', 'CH', '—', '—', '—', 'Swissmedic conformity assessment.'],
      ['br_device', 'Device Registration', 'ANVISA', 'BR', '—', '—', '—', 'ANVISA device registration for Brazil.'],
    ],
    device_post_market: [
      ...
      ['eu_sig_change', 'Significant Change Notification', 'EMA', 'EU', '—', '—', 'NeeS', 'MDR Art 120 significant change to NB.'],
      ['dev_fsc', 'Field Safety Corrective Action (FSCA)', 'FDA', 'GLOBAL', '—', '—', '—', 'Global field safety action and recall.'],
    ],
    device_clinical: [
      ['ide', 'Investigational Device Exemption (IDE)', 'FDA', 'US', 'eCTD', '—', 'eCTD', 'Clinical investigation of a significant-risk device.', 'ide'],
      ['eu_clin_inv', 'Clinical Investigation (EU MDR)', 'EMA', 'EU', '—', '—', 'NeeS', 'EU MDR clinical investigation application.'],
      ['cip_iso', 'Clinical Investigation Plan (ISO 14155)', 'FDA', 'GLOBAL', '—', '—', '—', 'ISO 14155 clinical investigation plan.'],
  ...
  diagnostics_ivd: {
    ivd_market_auth: [
      ...
      ['eu_ivdr_a', 'EU IVDR Class A', 'EMA', 'EU', '—', '—', 'NeeS', 'Self-declared conformity for low-risk IVDs.'],
      ['eu_ivdr_b', 'EU IVDR Class B', 'EMA', 'EU', '—', '—', 'NeeS', 'Notified Body assessment for Class B IVDs.'],
      ['eu_ivdr_cd', 'EU IVDR Class C/D', 'EMA', 'EU', '—', '—', 'NeeS', 'High-risk IVD assessment (incl. self-testing, blood screening).'],
    ],
    ivd_companion_dx: [
      ['cdx_pma', 'Companion Dx PMA', 'FDA', 'US', 'eCTD', '—', 'eCTD', 'PMA for companion diagnostic device.'],
      ['cdx_ivdr_d', 'CDx EU IVDR Class D', 'EMA', 'EU', '—', '—', 'NeeS', 'EU companion diagnostic under IVDR.'],
      ['cdx_pmda', 'CDx Approval', 'PMDA', 'JP', 'CTD', '—', 'CTD', 'PMDA companion diagnostic device approval.'],
      ['cdx_codev', 'CDx Co-development Plan', 'FDA', 'US', '—', '—', 'Letter', 'Joint drug-diagnostic development plan.'],
    ],
    ivd_clinical_performance: [
      ['ivdr_perf_study', 'IVDR Performance Study', 'EMA', 'EU', '—', '—', 'NeeS', 'EU IVDR clinical performance study notification.'],
      ['ivd_clin_evidence', 'Clinical Evidence Summary', 'EMA', 'EU', '—', '—', 'NeeS', 'EU IVDR clinical evidence compilation.'],
      ['ivdr_pmpf', 'Post-market Performance Follow-up', 'EMA', 'EU', '—', '—', 'NeeS', 'Ongoing performance data collection plan.'],
      ['ivd_anal_val', 'Analytical Validation Report', 'FDA', 'US', '—', '—', 'eSTAR', 'Analytical and clinical validation study report.'],
    ],
    ivd_regional: [
      ['pmda_ivd', 'IVD Approval', 'PMDA', 'JP', 'CTD', '—', 'CTD', 'PMDA IVD medical device approval.'],
      ['nmpa_ivd', 'IVD Registration', 'NMPA', 'CN', 'CTD', '—', 'CTD', 'NMPA IVD registration for China.'],
      ['tga_ivd', 'IVD Inclusion', 'TGA', 'AU', '—', '—', 'ARTG', 'TGA IVD inclusion in the ARTG.'],
      ['hc_ivd', 'IVD Licence', 'Health Canada', 'CA', '—', '—', '—', 'Health Canada IVD device licence.'],
    ],
    ivd_post_market: [
      ['ivd_pms_plan', 'Post-Market Surveillance Plan', 'EMA', 'EU', '—', '—', 'NeeS', 'EU IVDR post-market surveillance plan.'],
      ['ivd_trend', 'Trend Reporting', 'FDA', 'US', '—', '—', '—', 'FDA MDR trend reporting for IVDs.'],
      ['ivd_vigilance', 'Vigilance Report', 'EMA', 'EU', '—', '—', 'NeeS', 'EU IVDR vigilance incident report.'],
    ],
  },
  cross_cutting: {
    ctd_ectd: [
