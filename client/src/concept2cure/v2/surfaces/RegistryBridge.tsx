...
const REGISTRY_SOURCE: Record<string, Record<string, RegistryTuple[]>> = {
  ...
  medical_devices: {
    ...
    device_post_market: [
      ...
      ['eu_sig_change', 'Significant Change Notification', 'EMA', 'EU', '—', '—', 'NeeS', 'MDR Art 120 significant change to NB.', 'device'],
    ...
    device_clinical: [
      ...
      ['eu_clin_inv', 'Clinical Investigation (EU MDR)', 'EMA', 'EU', '—', '—', 'NeeS', 'EU MDR clinical investigation application.', 'device'],
