// Tasking Lucide icon subset — mirrors risk/icons.tsx. Lucide only.
...
const icons = {
  ...
  columns:     <Icon><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="9" y1="3" x2="9" y2="21"/><line x1="15" y1="3" x2="15" y2="21"/></Icon>,
...
export type TaskingIconName = keyof typeof icons;

export function TaskingIcon({ name, size }: { name: TaskingIconName | string; size?: number }) {
