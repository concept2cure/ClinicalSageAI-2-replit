  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200">
        ...
        {onClose && (
          <button onClick={onClose} aria-label="Close template library" title="Close" className="p-1.5 text-slate-400 hover:text-slate-600 rounded-md hover:bg-slate-100 focus-visible:ring-2 focus-visible:ring-stone-400 outline-none">
            <X className="h-4 w-4" />
          </button>
        )}
      </div>
      ...
      <div className="flex flex-1 min-h-0">
            ...
            filtered.map(t => (
              ...
              >
                <div className="flex items-start justify-between mb-1">
                  <h3 className="text-sm font-semibold text-slate-800 leading-tight">{t.name}</h3>
        ...
        {/* Detail panel */}
        <div className="w-80 flex-shrink-0 border-l border-slate-100 overflow-y-auto">
          {selectedTemplate ? (
            <div className="p-4">
              <h3 className="text-sm font-semibold text-slate-800 mb-1">{selectedTemplate.name}</h3>
              ...
              {/* Template sections */}
              <h4 className="text-xs font-medium text-slate-600 mb-2">Template Sections</h4>
              <div className="space-y-1.5">
                {selectedTemplate.sections.map((s, i) => (
                  ...
                  >
                    <span className="text-[10px] font-mono text-slate-400 mt-0.5 w-4 text-right shrink-0">
                      {i + 1}.
                    </span>
              ...
              {/* Metadata */}
              <div className="mt-4 pt-3 border-t border-slate-100 space-y-1.5 text-[11px] text-slate-400">
