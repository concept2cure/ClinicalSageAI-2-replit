  ...
  return (
    <div
      className={cn(
        ...
        isPending && "bg-gray-100 text-gray-600 hover:bg-gray-200"
      )}
      onClick={onClick}
    >
      {/* Status icon */}
      ...
      {isPending && <Circle size={14} className="text-gray-400" />}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        !allPassed && !hasFailed && "bg-gray-100 text-gray-600 hover:bg-gray-200"
      )}
    >
      {allPassed ? (
