      ...
      <div className="p-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={onLink}
            disabled={isLinking}
            className="px-3 py-1 text-sm font-medium bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
