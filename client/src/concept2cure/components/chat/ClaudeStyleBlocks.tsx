    ...
    <div className="my-2">
      ...
      >
        ...
        {status === 'running' ? (
          ...
          <span className="w-3.5 h-3.5 flex items-center justify-center text-stone-900 flex-shrink-0">!</span>
        ) : (
      ...
      {steps.map((step, i) => (
        <div key={i} className="flex items-center gap-2 text-sm">
          {step.status === 'running' ? (
            ...
            <span className="w-3.5 h-3.5 text-stone-900 text-center">!</span>
          ) : (
