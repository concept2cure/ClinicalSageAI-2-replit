                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <>
                          <div
                            className="prose prose-sm prose-stone max-w-none mt-0.5
                              ...
                              prose-code:text-[#C4623F] prose-code:bg-[#FBF0EB] prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:text-xs prose-code:before:content-none prose-code:after:content-none
                              prose-pre:bg-[#141413] prose-pre:text-[#F5F4EF] prose-pre:rounded-xl prose-pre:p-3 prose-pre:text-xs
                              prose-blockquote:border-l-[#E8967A] prose-blockquote:text-[#6B6962]
                              prose-ul:text-[#4D4B45] prose-ol:text-[#4D4B45]
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                              {msg.images.map((img, idx) => (
                                <img
                                  ...
                                  className="rounded-lg border border-[#E8E6DC] max-w-sm shadow-sm"
                                />
                              ))}
                            </div>
                          )}
                      ...
                      {!isUser && (
                        <div className={cn(
                          ...
                          <button className="p-1 text-[#B0AEA5] hover:text-[#4D4B45] hover:bg-[#F5F4EF] rounded transition-colors" title="Good"><ThumbsUp className="w-3 h-3" /></button>
                          <button className="p-1 text-[#B0AEA5] hover:text-[#4D4B45] hover:bg-[#F5F4EF] rounded transition-colors" title="Bad"><ThumbsDown className="w-3 h-3" /></button>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              <button
                ...
                className={cn(
                  ...
                  chatMode === 'deep-research'
                    ? 'bg-[#FBF0EB] text-[#C4623F] hover:bg-[#F5E0D6]'
                    : chatMode === 'nano-banana'
                      ? 'bg-amber-50 text-amber-700 hover:bg-amber-100'
                      : 'text-[#8A8880] hover:bg-[#F5F4EF] hover:text-[#4D4B45]'
                )}
              >
                {chatMode === 'deep-research' ? (
