...
const AnaPersistentPanel: React.FC<AnaPersistentPanelProps> = ({
  ...
  const [decisionStatus, setDecisionStatus] =
    useState<DecisionStatusRailState>(EMPTY_DECISION_STATUS);
  // AnA RI state
  ...
  useEffect(() => {
    ...
    const STANDARD_THINKING = ['Thinking...', 'Working on it...', 'Preparing response...'];
        ...
        {hasMessages && (
          ...
          >
            {messages.map(msg => {
              ...
              return (
                <div key={msg.id} className={cn('group px-4 py-3', 'bg-white')}>
                  <div
                    className={cn(
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-white">
            ...
            <div className="max-w-2xl w-full space-y-10">
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-[14px] text-stone-500 leading-relaxed max-w-lg mx-auto">
                  Regulatory intelligence platform for medical devices, diagnostics, pharma, and
                  biotech. From first submission to market approval.
                </p>
              </div>
                    ...
                    {projects.slice(0, 6).map(proj => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[11px] text-stone-400 mt-0.5 uppercase tracking-wide font-medium">
                            {proj.type}
                          </p>
                        </div>
                  ...
                  {[
                    {
                      ...
                      prompt:
                        'Help me start a 510(k) submission for my medical device. Walk me through what I need.',
                    },
                    {
                      icon: BookOpen,
                      ...
                      sub: 'IND, NDA, BLA, MAA',
                      prompt:
                        'Help me plan an IND or NDA submission for my drug product. What should I prepare first?',
                    },
                    {
                      icon: BarChart2,
                      ...
                      prompt:
                        'Help me design a clinical trial protocol for my study. I need endpoint strategy and statistical design.',
                    },
                  ].map(card => {
                    ...
                    <section key={group.domain}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
                        {group.prompts.map(p => (
                          ...
                          >
                            <p className="text-[12px] text-stone-700 leading-snug">{p.label}</p>
                          </button>
                        ))}
                      </div>
                    </section>
      ...
      <div className="flex-shrink-0 px-4 py-3 border-t border-[#F5F4EF] bg-white">
        <div className={cn('max-w-3xl mx-auto relative', !hasMessages && 'max-w-3xl')}>
          ...
          {hasMessages && (
            <p className="mt-1.5 pl-1 text-[11px] text-[#B0AEA5]">
              ...
              <span className="font-semibold text-[#6B6962]">↑</span> on an empty input to recall
              your last prompt.
              {onNavigate ? (
                <>
                  {' '}
