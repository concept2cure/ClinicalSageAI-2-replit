    ...
    <div className={cn('flex flex-col h-full bg-white border-l border-zinc-200', className)}>
      ...
      <div className="p-3 border-b border-zinc-200 bg-zinc-50">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <button
            onClick={onUpload}
            className="flex items-center gap-1 px-2 py-1 text-xs rounded border border-zinc-200 text-zinc-600 hover:bg-zinc-50 ml-auto"
          >
                    ...
                    <div className="px-3 pb-3 border-t border-zinc-200">
                          ...
                          {source.metadata.keyFindings && source.metadata.keyFindings.length > 0 && (
                            <div>
                              ...
                              {source.metadata.keyFindings.map((f, i) => (
                                <p key={i} className="text-xs text-zinc-500 ml-2">
                                  {f}
                                </p>
                              ))}
                            </div>
                      ...
                      <div className="flex items-center gap-2 mt-2 pt-2 border-t border-zinc-200">
                        <button
                          ...
                          className="text-xs text-zinc-600 hover:text-blue-600 flex items-center gap-1"
                        >
