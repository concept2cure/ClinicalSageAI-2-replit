    ...
    <div className={cn('flex flex-col h-full bg-white border-l border-zinc-200', className)}>
      ...
      <div className="p-3 border-b border-zinc-200 bg-zinc-50">
        ...
        <button
          ...
          disabled={loading}
          className="mt-2 flex items-center gap-1 text-[10px] text-zinc-600 hover:text-zinc-800"
        >
          {loading ? (
      ...
      <div className="flex-1 overflow-y-auto">
        {loading && visibleAffected.length === 0 ? (
          ...
          <div className="p-2 space-y-2">
            {/* Change summary */}
            <div className="px-3 py-2 bg-zinc-50 rounded-lg text-[10px] text-zinc-600">
                ...
                >
                  ...
                  {isExpanded && (
                    <div className="px-3 pb-3 border-t border-current/10">
                      ...
                      <div className="mt-2 px-2 py-1.5 bg-white/60 rounded text-[10px] font-mono">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <button
                          ...
                          className="flex items-center gap-1 px-2 py-1 text-[10px] rounded bg-white/60 hover:bg-white transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 px-2 py-1 text-[10px] rounded bg-white/60 hover:bg-white transition-colors ml-auto"
                        >
                          <X className="w-3 h-3" />
                          Dismiss
                        </button>
