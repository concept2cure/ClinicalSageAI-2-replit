      ...
      {showInsertForm && (
        <div className="px-4 py-3 border-b border-zinc-200 bg-indigo-50/50 space-y-2">
          ...
          <button
            ...
            className="w-full text-xs font-medium py-1.5 rounded-md bg-indigo-600 text-white hover:bg-indigo-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
            Insert Reference
          </button>
        </div>
        ...
        {!hasScanned ? (
          <div className="flex flex-col items-center justify-center h-full px-6 text-center">
            ...
            <button
              onClick={scanDocument}
              disabled={isScanning}
              className="flex items-center gap-2 text-xs font-medium px-4 py-2 rounded-md bg-indigo-600 text-white hover:bg-indigo-700 disabled:opacity-50 transition-colors"
            >
              <RefreshCw
