            ...
            <div className="absolute left-0 top-full mt-1 w-52 bg-white border border-stone-200 rounded-lg shadow-sm z-50 py-1">
              {AI_TOOLBAR_ACTIONS.map(action => (
                <button
                  ...
                  className="w-full text-left px-3 py-2 hover:bg-stone-50 text-sm text-stone-700 flex items-center gap-2.5 transition-colors duration-150"
                >
                  <action.icon className="w-4 h-4 text-stone-500 shrink-0" />
                  <div>
                      ...
                      >
                        ...
                        {!isFilled && (
                          <button
                            ...
                            className="flex items-center gap-1 px-2 py-1 text-xs bg-stone-200 text-stone-600 rounded hover:bg-stone-300"
                          >
