        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1 flex-wrap">
              ...
              <span className="text-xs text-stone-500">v{source.version}</span>
              {source.citationCount !== undefined && (
                <span className="text-xs text-stone-400">{source.citationCount} citations</span>
              )}
            </div>
          </div>
        </div>
      ...
      <div className="px-3 pb-3">
        ...
        {isExpanded && (
          <div className="mt-2 space-y-2 text-xs">
            ...
            {source.excerpt && (
              <p className="text-stone-600 mt-2 line-clamp-3 italic">
                "{source.excerpt}"
              </p>
            )}
            {onPreview && (
        ...
        <>
          ...
          <div className="p-3 border-b border-stone-200 space-y-2">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 bg-stone-100 border-0 rounded-lg text-sm"
              />
            </div>
            <select
              value={documentTypeFilter}
              onChange={e => setDocumentTypeFilter(e.target.value as typeof documentTypeFilter)}
              className="w-full p-2 bg-stone-100 border-0 rounded-lg text-sm"
            >
          ...
          {selectedSource && selectedText && (
            <div className="p-4 border-t border-stone-200 bg-white space-y-3">
              <h3 className="text-sm font-medium text-stone-700">Citation Type</h3>
