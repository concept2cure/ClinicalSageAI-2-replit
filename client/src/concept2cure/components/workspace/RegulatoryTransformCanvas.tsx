  ...
  return (
    <div className="flex-1 flex flex-col bg-white min-h-0 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="grid grid-cols-5 gap-px bg-stone-100 min-h-full">
          {/* ── Lane 1: Inputs ── */}
            ...
            {selectedCtd ? (
              <>
                ...
                {templateStructure.length > 0 ? (
                  ...
                  <span className="text-xs text-stone-400">No template structure mapped</span>
                )}
              ...
              <>
                <span className="text-xs text-stone-400">Select a CTD section</span>
          ...
          <div className="bg-white p-3 flex flex-col gap-3">
            ...
            <div>
              <label className="text-xs text-stone-400 uppercase tracking-wider block mb-1">
                Artifact title
              </label>
              <input
                type="text"
...
function LaneStat({ label, value, sublabel }: { label: string; value: string; sublabel?: string }) {
  return (
    <div>
      ...
      <p className="text-sm text-stone-700 font-medium leading-tight">{value}</p>
