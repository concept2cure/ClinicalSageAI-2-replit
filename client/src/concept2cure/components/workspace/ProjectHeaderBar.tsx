...
> = {
  '510K': { label: '510(k)', color: 'text-stone-600', bg: 'bg-stone-100' },
  IND: { label: 'IND', color: 'text-stone-600', bg: 'bg-stone-100' },
  NDA: { label: 'NDA', color: 'text-stone-600', bg: 'bg-stone-100' },
  BLA: { label: 'BLA', color: 'text-stone-600', bg: 'bg-stone-100' },
  PMA: { label: 'PMA', color: 'text-stone-600', bg: 'bg-stone-100' },
  MAA: { label: 'MAA', color: 'text-stone-600', bg: 'bg-stone-100' },
  DE_NOVO: { label: 'De Novo', color: 'text-stone-600', bg: 'bg-stone-100' },
  EUA: { label: 'EUA', color: 'text-stone-600', bg: 'bg-stone-100' },
  IVDR: { label: 'IVDR', color: 'text-stone-600', bg: 'bg-stone-100' },
};
