  ...
  return (
    <div className="bg-white rounded-xl border border-zinc-200 overflow-hidden">
      <div className="p-4 border-b border-zinc-200 flex items-center justify-between">
        ...
        <button className="inline-flex items-center justify-center font-medium rounded-lg transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 outline-none text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 px-3 py-1.5 text-xs gap-1.5">
                    ...
                    <div className="px-4 pb-4 pl-14 space-y-3">
                      ...
                      <div className="flex items-center gap-2 pt-2">
                        <button
                          ...
                          className="inline-flex items-center justify-center font-medium rounded-lg transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 outline-none text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 px-3 py-1.5 text-xs gap-1.5"
                        >
        ...
        <div className="flex gap-1">
          {(['active', 'completed', 'all'] as const).map(f => (
            <button
              ...
              onClick={() => setFilter(f)}
              className={cn(
                'px-3 py-1.5 text-xs font-medium rounded-lg transition-colors duration-150 capitalize focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 outline-none',
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className={cn('inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium', typeConfig.color === 'text-red-600' ? 'bg-red-100' : typeConfig.color === 'text-blue-600' ? 'bg-blue-100' : 'bg-zinc-100', typeConfig.color)}>
                {typeConfig.label}
              </span>
              <span className={cn('inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium', statusConfig.bgColor, statusConfig.color)}>
                {statusConfig.label}
          ...
          <div className="flex gap-2">
            <button className="inline-flex items-center justify-center font-medium rounded-lg transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 outline-none bg-white text-zinc-700 border border-zinc-200 hover:bg-zinc-50 hover:border-zinc-300 px-4 py-2 text-sm gap-2">
              <Download className="w-4 h-4" />
              Export
            </button>
            <button className="inline-flex items-center justify-center font-medium rounded-lg transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 outline-none bg-blue-600 text-white hover:bg-blue-700 shadow-sm px-4 py-2 text-sm gap-2">
      ...
      <div className="flex-shrink-0 bg-white border-b border-zinc-200 p-4">
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="rounded-xl border border-zinc-200 bg-white px-5 py-4 shadow-sm">
            <span className="text-xs font-medium text-zinc-500 uppercase tracking-wide">Scheduled</span>
            <span className="text-2xl font-semibold mt-1 block text-blue-700">{metrics.scheduled}</span>
          </div>
          <div className="rounded-xl border border-zinc-200 bg-white px-5 py-4 shadow-sm">
            <span className="text-xs font-medium text-zinc-500 uppercase tracking-wide">Awaiting FDA</span>
            <span className="text-2xl font-semibold mt-1 block text-amber-700">{metrics.awaitingResponse}</span>
          </div>
          <div className="rounded-xl border border-zinc-200 bg-white px-5 py-4 shadow-sm">
            <span className="text-xs font-medium text-zinc-500 uppercase tracking-wide">Open Items</span>
            <span className="text-2xl font-semibold mt-1 block text-zinc-900">{metrics.openActionItems}</span>
          </div>
          <div className="rounded-xl border border-zinc-200 bg-white px-5 py-4 shadow-sm">
            <span className="text-xs font-medium text-zinc-500 uppercase tracking-wide">FDA Commitments</span>
