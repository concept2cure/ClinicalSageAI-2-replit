/**
 * Correspondence detail fixtures — ported verbatim from
 * `design-system/ui_kits/mdx/data-correspondence-detail.jsx`.
 *
 * Full agency / NB letters, deficiency decomposition, and AnA-drafted
 * responses keyed by row id. Attaches by id to the K510_CORRESP /
 * PMA_CORRESP / CER_CORRESP rows in `pathwayTabs.ts` so the AnA Drafter
 * has structured input.
 */

import type { CorrespondenceDetail } from '../types';
...
export const CORRESP_DETAIL: Record<string, CorrespondenceDetail> = {
    ...
    deficiencies: [
      {
        id:       'D1',
        n:        1,
        title:    'Stratified MARD by age decile',
        ...
        regs:     [
          { ref: '21 CFR 862.1345',                  title: 'Glucose test system — NBW special controls' },
      ...
      },
      {
        id:       'D2',
        n:        2,
        title:    'Raw paired CGM-YSI dataset (CSV)',
      ...
      },
      {
        id:       'D3',
        n:        3,
        title:    'Discussion of stratified differences + labeling reconciliation',
        ...
        refs:     [
          { section: 11, label: '§11.4 Accuracy' },
          { section: 7,  label: '§07 Indications for Use' },
        ],
      ...
      deficiencies: [
        {
          ...
          evidence: [
            { name: 'mard-by-age-band-stratified.xlsx', kind: 'xls', size: 184_320, source: 'Generated from Sources/clinical/BX204-PIVOT-paired.csv', new: true },
            { name: 'consensus-error-grid-by-band.png', kind: 'img', size: 412_334, source: 'Generated from Sources/clinical/BX204-PIVOT-paired.csv', new: true },
          ],
          updates: [
        ...
        },
        {
          ...
          evidence: [
            ...
            { name: 'data-dictionary-paired.pdf',         kind: 'pdf', size: 184_320,    source: 'Generated',           new: true },
          ],
          updates: [],
        },
        {
          ...
          evidence: [
            { name: 'IFU-final-locked.pdf', kind: 'pdf', size: 92_160, source: 'Files/Dossier/§07 Indications for Use/', new: false },
          ],
          updates: [
  ...
  'rta-2': {
    ...
    deficiencies: [
      {
        id: 'D1', n: 1,
        title: 'Side-by-side software architecture diagram + classifier delta',
        ...
        refs:  [
          { section: 10, label: '§10 Software' },
          { section: 5,  label: '§5 Predicate comparison' },
        ],
  ...
  'd100-2': {
    ...
    deficiencies: [
      {
        id: 'D1', n: 1,
        title: 'Re-analyze PE under SAP v3.0 (no Bayesian borrowing)',
        ...
        regs:  [
          { ref: '21 CFR 814.20(b)(3)(v)', title: 'Statistical analysis' },
          { ref: 'ICH E9',                  title: 'Statistical principles' },
        ],
        severity: 'major',
      },
      {
        id: 'D2', n: 2,
        title: 'Stratified subgroup analyses (age, baseline rhythm)',
        body:  'Provide sensitivity by age decile and baseline rhythm category.',
        refs:  [{ section: 'M273', label: 'Module 2.7.3 — Efficacy' }],
        regs:  [{ ref: 'ICH E9', title: 'Subgroup analyses' }],
        severity: 'major',
      },
      {
        id: 'D3', n: 3,
        title: 'CEC composition + voting procedure',
        body:  'Provide CEC member list, voting rules, blinding procedures.',
        refs:  [{ section: 'M274', label: 'Module 2.7.4 — AE summary' }],
        regs:  [{ ref: '21 CFR 814.20(b)(3)(vi)', title: 'Adverse event reporting' }],
        severity: 'minor',
      },
      {
        id: 'D4', n: 4,
        title: 'Extractables/leachables for hermetic seal materials',
        body:  'Provide ISO 10993-18:2020 § 8.4 semi-quantitative analysis.',
        refs:  [{ section: 'M325', label: 'Module 3.2.P.5 — Biocompatibility' }],
        regs:  [{ ref: 'ISO 10993-18:2020', title: 'Chemical characterization' }],
        severity: 'major',
      },
      {
        id: 'D5', n: 5,
        title: 'Updated SBOM + post-market patch threat model',
        ...
        regs:  [{ ref: 'FDA Cybersecurity Guidance (Sept 2023)', title: 'Premarket cybersecurity' }],
        severity: 'major',
      },
    ],
    draft: { status: 'unstarted' },
  ...
  'nbq-3': {
    ...
    deficiencies: [
      {
        id: 'D1', n: 1,
        title: 'Refresh literature search 2023–2024',
        body:  'Provide search strategy, PRISMA diagram, and CASP appraisals for new studies.',
        refs:  [
          { section: 'S2', label: '§2 State-of-the-art analysis' },
          { section: 'S3', label: '§3 Clinical data summary' },
        ],
        regs:  [
          { ref: 'MDCG 2020-13 § 6.4',     title: 'CER state-of-the-art expectations' },
          { ref: 'MDR Annex XIV Part A § 3', title: 'Clinical evaluation' },
        ],
        severity: 'major',
      },
    ],
