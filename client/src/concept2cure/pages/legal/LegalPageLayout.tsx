      ...
      <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden">
        ...
        <div className="px-10 pt-10 pb-6 border-b border-zinc-100">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h1 className="text-2xl font-bold text-zinc-900" style={{ fontFamily: "'Poppins', Arial, sans-serif" }}>
              {title}
            </h1>
          </div>
          ...
          <p className="text-sm text-zinc-500 mt-1" style={{ fontFamily: "'Poppins', Arial, sans-serif" }}>
            Concept2Cure, Inc. — AI-Powered Regulatory Intelligence Platform
          </p>
        </div>

        {/* Document body */}
        <div className="px-10 py-8 prose prose-zinc max-w-none">
          {children}
        </div>

        {/* Document footer */}
        <div className="px-10 py-6 bg-zinc-50 border-t border-zinc-100">
