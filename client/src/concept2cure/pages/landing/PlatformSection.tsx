...
function PlatformMockup() {
  return (
    <div className="relative mx-auto max-w-5xl">
      <div className="rounded-xl border border-zinc-200 bg-white shadow-2xl shadow-blue-900/8 overflow-hidden">
        {/* Browser chrome */}
        ...
        <div className="flex min-h-[320px]">
          {/* Sidebar */}
          <div className="w-52 bg-zinc-900 text-white p-4 hidden md:block">
            ...
            <div className="space-y-1 text-xs">
              {[
                ...
                <div
                  key={item}
                  className={`px-3 py-2 rounded-lg ${i === 0 ? 'bg-white/10 text-white' : 'text-zinc-500'}`}
                >
                  {item}
                </div>
              ))}
          ...
          <div className="flex-1 p-6 bg-[#FAFAF9]">
            <div className="flex items-center justify-between mb-5">
              <div>
                <h3 className="text-sm font-semibold text-zinc-900">Mission Control</h3>
                <p className="text-xs text-zinc-500">3 active submissions</p>
              </div>
            ...
            <div className="space-y-2.5">
              {[
                ...
                >
                  ...
                  <div className="text-xs font-medium text-zinc-600 w-8 text-right">
                    {s.progress}%
                  </div>
                </div>
              ))}
