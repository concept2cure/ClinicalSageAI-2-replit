...
const StudyRegulatoryIntelligenceSuite = lazy(() => import('./components/unified/StudyRegulatoryIntelligenceSuite'));
    ...
    <ModuleErrorBoundary>
      <ErrorBoundary>
        ...
        <Route path="/pre-submission-validation" component={() => import('./pages/PreSubmissionValidation')} />
                      ...
                      <Route path="/client-portal/protocol">
                        {() => <Redirect to="/unified-suite" />}
                      </Route>
                        ...
                        {() => {
                          const UnifiedSubmissionWorkflow = () => {
                            ...
                            const calculateOverallProgress = () => {
                              ...
                              const ectdProgress = (moduleStatus.ectd.complete / moduleStatus.ectd.total) * 25;
                            ...
                            const updateSharedData = (updates) => {
                              ...
                              window.dispatchEvent(new CustomEvent('submissionDataUpdate', {
                                detail: updates
                              }));
                            };
                                    ...
                                    <div className="px-8 py-6">
                                      ...
                                      <div className="mb-6">
                                        <div className="flex items-center justify-between mb-3">
                                          ...
                                          <div className="flex items-center gap-3">
                                            ...
                                            <code className="px-2 py-1 bg-gray-100 rounded text-xs font-mono">SUB-2025-001</code>
                                            <Badge 
                                              variant={overallProgress === 100 ? "success" : overallProgress > 50 ? "warning" : "secondary"}
                                              className="ml-2"
                                            >
                                              {overallProgress === 100 ? '✓ Ready' : `${overallProgress}% Complete`}
                                            </Badge>
                                          </div>
                                        </div>
                                        ...
                                        <div>
                                          <AnimatedPipeline 
                                            stages={[
                                              { name: 'Initiation', icon: PlayCircle, status: 'complete', description: 'Project started' },
                                              { name: 'Authoring', icon: Edit, status: moduleStatus.ind.complete > 0 ? 'active' : 'pending', description: 'Document creation' },
                                              { name: 'Review', icon: CheckCircle, status: moduleStatus.cmc.complete > 0 ? 'active' : 'pending', description: 'Quality review' },
                                              { name: 'Assembly', icon: Package, status: moduleStatus.ectd.complete > 0 ? 'active' : 'pending', description: 'eCTD assembly' },
                                              { name: 'Submission', icon: Send, status: overallProgress === 100 ? 'complete' : 'pending', description: 'Submit to FDA' }
                                            ]}
                                      ...
                                      <div className="grid grid-cols-6 gap-4 mb-4">
                                        <div className="bg-blue-50 rounded-lg p-3">
                                          ...
                                          <div className="text-xl font-bold text-blue-900">{moduleStatus.vault.documents}</div>
                                        </div>
                                        ...
                                        <div className="bg-indigo-50 rounded-lg p-3">
                                          <div className="text-xs text-indigo-600 font-medium">Compliance</div>
                                          <div className="text-xl font-bold text-indigo-900">{moduleStatus.compliance.score}%</div>
                                        </div>
                                      ...
                                      <div className="mt-4 relative">
                                        ...
                                        <div className="absolute top-0 left-0 w-full h-full flex items-center justify-between px-2">
                                          <div className="flex items-center gap-2">
                                            <div className={`w-2 h-2 rounded-full ${overallProgress > 0 ? 'bg-blue-600' : 'bg-gray-400'}`} />
                                            <span className="text-xs text-gray-700 font-medium">Start</span>
                                          </div>
                                          <div className="flex items-center gap-2">
                                            <span className="text-xs text-gray-700 font-medium">IND Ready</span>
                                            <div className={`w-2 h-2 rounded-full ${overallProgress >= 25 ? 'bg-blue-600' : 'bg-gray-400'}`} />
                                          </div>
                                          <div className="flex items-center gap-2">
                                            <span className="text-xs text-gray-700 font-medium">CMC Complete</span>
                                            <div className={`w-2 h-2 rounded-full ${overallProgress >= 50 ? 'bg-blue-600' : 'bg-gray-400'}`} />
                                          </div>
                                          <div className="flex items-center gap-2">
                                            <span className="text-xs text-gray-700 font-medium">Clinical Ready</span>
                                            <div className={`w-2 h-2 rounded-full ${overallProgress >= 75 ? 'bg-blue-600' : 'bg-gray-400'}`} />
                                          </div>
                                          <div className="flex items-center gap-2">
                                            <span className="text-xs text-gray-700 font-medium">Submission Ready</span>
                                            <div className={`w-2 h-2 rounded-full ${overallProgress === 100 ? 'bg-green-600' : 'bg-gray-400'}`} />
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                          ...
                                          >
                                            <CardHeader>
                                              <CardTitle className="flex items-center justify-between">
                                                ...
                                                <Badge variant={moduleStatus.ind.status === 'in-progress' ? 'default' : 'outline'}>
                                            ...
                                            <CardContent>
                                              <div className="space-y-2">
                                                <div className="flex justify-between text-sm">
                                                  <span>Progress</span>
                                                  <span>{moduleStatus.ind.complete} of {moduleStatus.ind.total} steps</span>
                                                </div>
                                                <Progress value={(moduleStatus.ind.complete / moduleStatus.ind.total) * 100} />
                                                {sharedData.drugName && (
                                          ...
                                          >
                                            <CardHeader>
                                              <CardTitle className="flex items-center justify-between">
                                                ...
                                                <Badge variant={moduleStatus.cmc.status === 'in-progress' ? 'default' : 'outline'}>
                                            ...
                                            <CardContent>
                                              <div className="space-y-2">
                                                <div className="flex justify-between text-sm">
                                                  ...
                                                  <span>{moduleStatus.cmc.complete} of {moduleStatus.cmc.total}</span>
                                                </div>
                                                <Progress value={(moduleStatus.cmc.complete / moduleStatus.cmc.total) * 100} />
                                                <Button 
                                          ...
                                          >
                                            <CardHeader>
                                              <CardTitle className="flex items-center justify-between">
                                                ...
                                                <Badge variant={moduleStatus.csr.status === 'in-progress' ? 'default' : 'outline'}>
                                            ...
                                            <CardContent>
                                              <div className="space-y-2">
                                                <div className="flex justify-between text-sm">
                                                  ...
                                                  <span>{moduleStatus.csr.complete} of {moduleStatus.csr.total}</span>
                                                </div>
                                                <Progress value={(moduleStatus.csr.complete / moduleStatus.csr.total) * 100} />
                                          ...
                                          >
                                            <CardHeader>
                                              <CardTitle className="flex items-center justify-between">
                                                ...
                                                <Badge variant={moduleStatus.ectd.status === 'in-progress' ? 'default' : 'outline'}>
                                            ...
                                            <CardContent>
                                              <div className="space-y-2">
                                                <div className="flex justify-between text-sm">
                                                  ...
                                                  <span>{moduleStatus.ectd.complete} of {moduleStatus.ectd.total}</span>
                                                </div>
                                                <Progress value={(moduleStatus.ectd.complete / moduleStatus.ectd.total) * 100} />
                                                <Button 
                                                  className="w-full mt-2" 
                                                  size="sm"
                                                  variant="outline"
                                            ...
                                            <CardContent>
                                              <div className="space-y-2">
                                                <div className="flex justify-between text-sm">
                                                  ...
                                                  <span className="font-semibold">{moduleStatus.vault.documents}</span>
                                                </div>
                                                <Button 
                                                  className="w-full mt-2" 
                                                  size="sm"
                                            ...
                                            <CardContent>
                                              <div className="space-y-2">
                                                <div className="flex justify-between text-sm">
                                                  ...
                                                  <span className="font-semibold">{moduleStatus.compliance.score}%</span>
                                                </div>
                                                ...
                                                <Button 
                                                  ...
                                                  onClick={() => toast({
                                                    ...
                                                    description: "View detailed compliance report in the Regulatory Intelligence Hub"
                                                  })}
                                                >
                                                  View Details
                                                </Button>
                                            ...
                                            <div className="space-y-4">
                                              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                                <div className="flex items-center gap-3">
                                                  ...
                                                  <div>
                                                    ...
                                                    <div className="text-sm text-gray-600">Drug: {sharedData.drugName || 'Not set'}</div>
                                                  </div>
                                                </div>
                                                ...
                                                <div className="flex items-center gap-3">
                                                  ...
                                                  <div>
                                                    ...
                                                    <div className="text-sm text-gray-600">Manufacturing data</div>
                                                  </div>
                                                </div>
                                                <ArrowRight className="w-5 h-5 text-gray-400" />
                                                <div className="flex items-center gap-3">
                                                  ...
                                                  <div>
                                                    ...
                                                    <div className="text-sm text-gray-600">Final assembly</div>
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                                <div className="flex items-center gap-3">
                                                  ...
                                                  <div>
                                                    <div className="font-medium">IND Wizard</div>
                                                    <div className="text-sm text-gray-600">Clinical protocol</div>
                                                  </div>
                                                </div>
                                                <ArrowRight className="w-5 h-5 text-gray-400" />
                                                <div className="flex items-center gap-3">
                                                  ...
                                                  <div>
                                                    ...
                                                    <div className="text-sm text-gray-600">Study analysis</div>
                                                  </div>
                                                </div>
                                                <ArrowRight className="w-5 h-5 text-gray-400" />
                                                <div className="flex items-center gap-3">
                                                  ...
                                                  <div>
                                                    <div className="font-medium">eCTD Co-Author</div>
                                                    <div className="text-sm text-gray-600">Clinical sections</div>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                          ...
                                          <IndWizardLayout 
                                            onDataUpdate={(data) => {
                                              ...
                                              setModuleStatus(prev => ({
                                                ...prev,
                                                ind: { ...prev.ind, complete: data.stepsComplete || prev.ind.complete }
                                              }));
                                            }}
                                          />
                                        </CardContent>
                                      ...
                                      <Card className="shadow-lg border-t-4 border-green-500">
                                        <CardContent className="p-6">
                                          <div className="text-center">
                                            <h2 className="text-2xl font-bold mb-4">CMC Platform Integration</h2>
                                            ...
                                            {sharedData.drugName && (
                                              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                                                ...
                                                <div className="mt-2 text-left space-y-1">
                                                  <div className="text-sm"><strong>Drug:</strong> {sharedData.drugName}</div>
                                                  <div className="text-sm"><strong>Indication:</strong> {sharedData.indication}</div>
                                                </div>
                                              </div>
                                            )}
                                          </div>
                                        ...
                                        <CardContent className="p-0">
                                          <CSRIntelligence 
                                            ...
                                            onDataUpdate={(data) => {
                                              ...
                                              setModuleStatus(prev => ({
                                                ...prev,
                                                csr: { ...prev.csr, complete: data.reportsAnalyzed || prev.csr.complete }
                                              }));
                                            }}
                                          />
                                        </CardContent>
                                          ...
                                          <FileProvider>
                                            <CoAuthor 
                                              ...
                                              onDocumentUpdate={(status) => {
                                                setModuleStatus(prev => ({
                                                  ...prev,
                                                  ectd: { ...prev.ectd, complete: status.documentsComplete || prev.ectd.complete }
                                                }));
                                              }}
                                            />
                                          </FileProvider>
