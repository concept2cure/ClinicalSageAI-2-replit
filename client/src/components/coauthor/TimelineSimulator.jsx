...
export default function TimelineSimulator() {
 ...
 <Calendar className="h-5 w-5 mr-2 text-stone-600" />
 ...
 <div
 className="absolute h-full bg-stone-700"
 ...
 {/* Current day marker */}
 <div
 className="absolute w-4 h-4 bg-white border-2 border-stone-700 rounded-full -top-1"
 ...
 variant="ghost"
 size="sm"
 className="h-8 text-xs flex items-center text-stone-600"
