...
export default function AskDataRoomPanel({ 
 ...
 {/* Header */}
 <div className="p-4 border-b bg-gradient-to-r from-stone-50 to-white">
 ...
 <Icon className="h-4 w-4 text-stone-600 mt-0.5" />
 ...
 >
 <FileText className="h-3 w-3 text-stone-600 mt-0.5" />
 <div className="flex-1">
