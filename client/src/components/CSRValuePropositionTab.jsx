...
const CSRValuePropositionTab = () => {
 ...
 <h2 className="text-3xl font-bold text-stone-900">High-Value Client Use Cases</h2>
 ...
 selectedUseCase === useCase.id ? 'ring-2 ring-stone-400 bg-stone-50' : 'hover:shadow-lg'
 }`}
 ...
 <p className="text-stone-800 text-lg font-bold">{currentUseCase.businessImpact}</p>
