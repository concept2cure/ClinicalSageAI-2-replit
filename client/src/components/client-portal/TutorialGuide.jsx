...
const TutorialGuide = () => {
 ...
 <Book className="h-8 w-8 text-stone-600" />
 ...
 <div className="text-center p-4 border rounded-lg">
 <div className="text-2xl font-bold text-stone-600">GxP Validated</div>
 ...
 <div className="w-8 h-8 bg-stone-800 text-white rounded-full flex items-center justify-center font-semibold text-sm">
 {item.step}
 </div>
