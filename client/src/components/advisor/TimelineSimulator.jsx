...
export default function TimelineSimulator({ readinessData, onSimulate, simulationData, onReset }) {
 ...
 <div className="bg-stone-50 border border-stone-100 rounded-lg p-6 text-center">
 <h3 className="text-lg font-medium text-stone-800 mb-2">Run Your First Simulation</h3>
