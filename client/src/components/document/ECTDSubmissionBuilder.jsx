...
import {
  FileText, FolderTree, LayoutGrid, List, Check, AlertCircle, Folder, File, Plus, RefreshCw, PackageOpen, Download, Upload, FileUp, X, Info, HelpCircle, ArrowRight } from 'lucide-react'
