...
export default function SemanticSearchResults({
 ...
 switch (type) {
 case 'report':
 return { icon: FileText, color: 'text-stone-500', bg: 'bg-stone-50' };
 case 'protocol':
 ...
 case 'regulatory':
 return { color: 'text-stone-600 bg-stone-50 border-stone-200', label: 'Regulatory' };
 case 'quality':
 ...
 if (relevance > 0.7) return 'text-stone-600';
 ...
 case 'in-progress':
 return (
 <Badge variant="outline" className="bg-stone-50 text-stone-800 hover:bg-stone-100">
 In Progress
 </Badge>
 );
 case 'approved':
 ...
 {/* Region */}
 <Badge variant="outline" className="bg-stone-50 text-stone-800">
