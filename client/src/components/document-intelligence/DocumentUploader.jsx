...
const DocumentUploader = ({ regulatoryContext = '510k', onDocumentsProcessed }) => {
 ...
 <div className="flex items-center">
 <Info className="h-4 w-4 mr-1 text-stone-500" />
 ...
 <div className="mt-6">
 {processedDocuments.length === 0 ? (
 <div className="flex items-start p-3 bg-stone-50 rounded-md">
 <Info className="h-5 w-5 text-stone-500 mr-2 flex-shrink-0 mt-0.5" />
 <div>
