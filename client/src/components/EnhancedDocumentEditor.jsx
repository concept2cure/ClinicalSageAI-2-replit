...
This version has been successfully restored to the editor.`;
 ...
 <textarea
 ref={textAreaRef}
 className="w-full h-96 p-4 border border-gray-300 rounded-md focus:ring-2 focus:ring-stone-400 focus:border-stone-400 resize-none"
 value={content}
 ...
 className="text-xl font-bold text-slate-900 leading-tight bg-transparent border-0 focus:outline-none focus:ring-2 focus:ring-stone-400 rounded px-2 py-1"
 ...
 <Badge
 variant="outline"
 className="bg-stone-100 text-stone-800 rounded-full px-3 py-1 text-sm font-semibold"
 >
 ...
 className={`px-2 py-1 text-sm border border-slate-300 rounded ${showPreview ? 'bg-stone-100 text-stone-700' : 'bg-white'}`}
 ...
 <div className="mt-4 p-4 bg-stone-50 border-l-4 border-stone-400 text-stone-700 text-sm mx-6 mb-6 rounded">
 <p>
 ...
 <summary className="text-xs cursor-pointer text-stone-600">
 ...
 : 'bg-white border-slate-200 hover:border-stone-300'
 }`}
 ...
 {version.isCurrent ? (
 <>
 <span className="bg-stone-100 text-stone-800 px-2 py-0.5 rounded text-xs font-semibold">
 CURRENT
 </span>
 Working Version
 </>
 ...
 <p className="text-stone-700">Document follows FDA guidelines</p>
 </div>
