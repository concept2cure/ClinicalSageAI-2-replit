...
const DeviceIntakeForm = ({ initialData, onSubmit, onCancel }) => {
 ...
 <div className="bg-white p-4 rounded-md border border-stone-100 border-l-4">
 <div className="flex items-center mb-3">
 <FilePlus className="h-5 w-5 text-stone-500 mr-2" />
 <h3 className="font-medium text-stone-800">Intelligent Document Import</h3>
 </div>
 ...
 <div className="flex items-center mb-3">
 <FileText className="h-5 w-5 text-stone-500 mr-2" />
 <h3 className="font-medium text-stone-800">Administrative Information</h3>
 </div>
 <p className="text-sm text-gray-600 mb-4">
 ...
 <div className="flex items-center mb-3">
 <FileText className="h-5 w-5 text-stone-500 mr-2" />
 <h3 className="font-medium text-stone-800">Device Classification</h3>
 </div>
 <p className="text-sm text-gray-600 mb-4">
 ...
 <SelectContent className="bg-white border border-gray-200 shadow-md z-50">
 <SelectItem value="Traditional" className="hover:bg-stone-50">
 Traditional 510(k)
 </SelectItem>
 <SelectItem value="Abbreviated" className="hover:bg-stone-50">
 Abbreviated 510(k)
 </SelectItem>
 <SelectItem value="Special" className="hover:bg-stone-50">
 Special 510(k)
 </SelectItem>
 </SelectContent>
 </Select>
 ...
 className="text-stone-600 underline ml-1 inline-flex items-center"
 >
 ...
 <div className="flex items-center mb-3">
 <FileText className="h-5 w-5 text-stone-500 mr-2" />
 <h3 className="font-medium text-stone-800">Device Information</h3>
 </div>
 <p className="text-sm text-gray-600 mb-4">
 ...
 {deviceClass === 'II' && (
 <div className="bg-stone-50 p-3 border border-stone-100 rounded-md">
 <div className="flex items-start">
 <Info className="h-5 w-5 text-stone-500 mr-2 mt-0.5" />
 ...
 <div className="flex items-center mb-3">
 <FileText className="h-5 w-5 text-stone-500 mr-2" />
 <h3 className="font-medium text-stone-800">Technical Characteristics</h3>
 </div>
 <p className="text-sm text-gray-600 mb-4">
 ...
 <SelectContent className="bg-white border border-gray-200 shadow-md z-50">
 <SelectItem value="minor" className="hover:bg-stone-50">
 Minor Level of Concern
 </SelectItem>
 <SelectItem value="moderate" className="hover:bg-stone-50">
 Moderate Level of Concern
 </SelectItem>
 <SelectItem value="major" className="hover:bg-stone-50">
 ...
 <div className="flex items-center mb-3">
 <FileText className="h-5 w-5 text-stone-500 mr-2" />
 <h3 className="font-medium text-stone-800">Predicate Device Information</h3>
 </div>
 <p className="text-sm text-gray-600 mb-4">
 ...
 <div className="bg-stone-50 p-3 border border-stone-100 rounded-md">
 <div className="flex items-start">
 <FileQuestion className="h-5 w-5 text-stone-500 mr-2 mt-0.5" />
 <div>
 ...
 <div className="flex items-center mb-3">
 <FileText className="h-5 w-5 text-stone-500 mr-2" />
 <h3 className="font-medium text-stone-800">Additional Information</h3>
 </div>
 <p className="text-sm text-gray-600 mb-4">
