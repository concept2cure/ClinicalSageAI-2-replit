...
const WorkflowEnabledReportGenerator = ({
 ...
 <div className="bg-gradient-to-r from-stone-700 to-stone-700 px-6 py-4 text-white">
 ...
 <AlertTitle className="text-stone-700">FDA Compliance Note</AlertTitle>
 ...
 <PackageCheck className="h-5 w-5 text-stone-600" />
 <h3 className="font-medium text-stone-800">FDA eSTAR Package Configuration</h3>
 </div>
 ...
 <div className="flex items-center justify-between pl-4 border-l-2 border-stone-300 ml-2 py-3">
 <div className="space-y-0.5">
 <Label
 htmlFor="validate-estar"
 className="text-sm font-medium flex items-center"
 >
 <CheckSquare className="h-4 w-4 mr-1 text-stone-600" />
 ...
 {generatedReportId ? (
 <>
 <div className="bg-stone-50 p-3 rounded-md mb-4 border border-stone-100">
 <div className="flex items-start">
 <div className="flex-grow">
 <h3 className="text-sm font-medium flex items-center">
 <PackageCheck className="h-4 w-4 mr-2 text-stone-600" />
 ...
 <a
 href={estarStatus.downloadUrl}
 className="text-stone-600 hover:underline flex items-center"
 target="_blank"
 rel="noopener noreferrer"
 >
