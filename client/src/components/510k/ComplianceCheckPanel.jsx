 ...
 */
 ...
 return (
 <Card className="w-full shadow-md border-stone-100">
 <CardHeader className="bg-gradient-to-r from-stone-50 to-stone-100 border-b pb-4">
 ...
 <div className="absolute inset-0 rounded-full border-4 border-stone-500 border-t-transparent animate-spin"></div>
 <div className="absolute inset-0 flex items-center justify-center">
 <ClipboardCheck className="h-10 w-10 text-stone-500" />
 </div>
 </div>
 ...
 <div className="flex items-center">
 <div className="w-3 h-3 rounded-full bg-stone-700 mr-1"></div>
 <span className="text-xs text-gray-600">
 Low (
