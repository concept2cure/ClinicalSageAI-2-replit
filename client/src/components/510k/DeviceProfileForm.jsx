...
const DeviceProfileForm = ({ initialData = {}, onSubmit, isEditing = false }) => {
 ...
 <Card className="border-stone-200 bg-gradient-to-r from-stone-50 to-indigo-50">
 <CardHeader>
 ...
 <div>
 <CardTitle className="text-stone-900">Cross-Format Harmonizer</CardTitle>
 ...
 className="h-4 w-4 text-stone-600 rounded"
