...
const WelcomeDialog = ({ open, onOpenChange, onContinue }) => {
 ...
 <div className="relative pl-8 pb-8 border-l-2 border-stone-200">
 <div className="absolute left-[-8px] top-0 bg-stone-800 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">
 1
 </div>
 <h3 className="font-medium text-lg text-stone-800">Create Device Profile</h3>
 ...
 <div className="bg-stone-50 p-3 rounded-md border border-stone-100 text-sm text-stone-700 flex items-start">
 <FileText className="h-4 w-4 mr-2 text-stone-500 mt-0.5 flex-shrink-0" />
 <span>
 ...
 <h3 className="font-medium text-lg text-stone-800">Find Predicate Devices</h3>
 <p className="text-gray-600 mt-1 mb-3">
 Search for and select appropriate predicate devices that your device can claim
 substantial equivalence to.
 </p>
 <div className="bg-stone-50 p-3 rounded-md border border-stone-100 text-sm text-stone-700 flex items-start">
 <Search className="h-4 w-4 mr-2 text-stone-500 mt-0.5 flex-shrink-0" />
 <span>
 ...
 <h3 className="font-medium text-lg text-stone-800">Build Substantial Equivalence</h3>
 <p className="text-gray-600 mt-1 mb-3">
 ...
 <div className="bg-stone-50 p-3 rounded-md border border-stone-100 text-sm text-stone-700 flex items-start">
 <ClipboardCheck className="h-4 w-4 mr-2 text-stone-500 mt-0.5 flex-shrink-0" />
 <span>
 ...
 <h3 className="font-medium text-lg text-stone-800">FDA Compliance Check</h3>
 <p className="text-gray-600 mt-1 mb-3">
 Validate your submission against FDA requirements to ensure completeness and
 regulatory compliance.
 </p>
 <div className="bg-stone-50 p-3 rounded-md border border-stone-100 text-sm text-stone-700 flex items-start">
 <FileCheck className="h-4 w-4 mr-2 text-stone-500 mt-0.5 flex-shrink-0" />
 <span>
 ...
 <h3 className="font-medium text-lg text-stone-800">Generate FDA Submission</h3>
 <p className="text-gray-600 mt-1 mb-3">
 Generate the final 510(k) submission package with all required documentation in
 FDA-compliant format.
 </p>
 <div className="bg-stone-50 p-3 rounded-md border border-stone-100 text-sm text-stone-700 flex items-start">
 <Download className="h-4 w-4 mr-2 text-stone-500 mt-0.5 flex-shrink-0" />
 <span>
 ...
 <div className="bg-stone-100 rounded-full p-1.5 mr-3 mt-0.5">
 <div className="bg-stone-800 rounded-full w-2.5 h-2.5"></div>
 </div>
 <div>
 <h4 className="font-medium text-stone-800">Preparation Phase</h4>
 ...
 <div>
 <h4 className="font-medium text-stone-800">Testing and Verification</h4>
 ...
 <div>
 <h4 className="font-medium text-stone-800">Submission Preparation</h4>
 <p className="text-sm text-gray-600 mt-1">2-4 weeks</p>
 <p className="text-sm text-gray-600 mt-1">
 ...
 <div>
 <h4 className="font-medium text-stone-800">FDA Review</h4>
