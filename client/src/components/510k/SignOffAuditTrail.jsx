...
const SignOffAuditTrail = ({ deviceName, exportable = false }) => {
 ...
 const stageIcons = {
 'Predicate Device Selection': <SearchCheck className="h-5 w-5 text-stone-600" />,
 ...
 <ShieldCheck className="h-5 w-5 text-stone-600 mr-2" />
 ...
 <div className="animate-spin h-5 w-5 border-2 border-stone-500 rounded-full border-t-transparent"></div>
 ...
 <div className="absolute left-2 top-1 w-4 h-4 rounded-full bg-stone-100 border-2 border-stone-500 z-10"></div>
 ...
 className="text-xs p-0 h-6 text-stone-600 hover:text-stone-800"
 >
 {isExpanded ? (
 <>
