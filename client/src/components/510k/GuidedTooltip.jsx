...
const GuidedTooltip = ({
 ...
 <TooltipContent className="max-w-md p-0 bg-white shadow-lg border border-stone-100 rounded-md">
 ...
 <Info className="h-4 w-4 mr-2 text-stone-600" />
 ...
 {steps.length > 0 && (
 <div className="p-2 flex justify-between border-t border-stone-100">
 <Button
 variant="ghost"
 size="sm"
