...
const DocumentTreePanel = ({ isOpen, onClose, documentId }) => {
 ...
 <FolderTree className="h-5 w-5 text-stone-600 mr-2" />
 ...
 <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-stone-500 mx-auto mb-2"></div>
 ...
 <div className="text-center">
 <FileText size={48} className="text-stone-500 mx-auto mb-2" />
