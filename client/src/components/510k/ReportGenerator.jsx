...
const ReportGenerator = ({
 ...
 <FileText className="h-12 w-12 text-stone-500 mx-auto" />
 ...
 <AlertTitle className="text-stone-700">510(k) Submission Package</AlertTitle>
 ...
 <FileText className="mr-2 h-4 w-4 text-stone-600" />
 510(k) Summary
 </CardTitle>
 </CardHeader>
 ...
 <AlertTitle className="text-stone-700">Submission Checklist</AlertTitle>
 <AlertDescription className="text-stone-600">
 ...
 <FileText className="mr-2 h-5 w-5 text-stone-600" />
