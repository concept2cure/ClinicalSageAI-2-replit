...
const CITATION_TYPES = [
 { value: 'standard', label: 'Standard', color: 'bg-stone-100 text-stone-700 border-stone-300' },
 {
 value: 'guidance',
 label: 'Guidance',
...
export default function CERV2CitationManager({
 ...
 {/* Add form */}
 {adding && (
 <div className="p-3 border-b bg-stone-50/50 space-y-2">
 ...
 className="text-[11px] text-stone-500 hover:text-stone-700 flex items-center gap-0.5 mt-0.5"
 >
 ...
 variant="ghost"
 size="sm"
 className={`h-6 px-1.5 text-[11px] ${isLinked ? 'text-stone-600' : 'text-slate-400'}`}
