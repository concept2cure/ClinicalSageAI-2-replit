...
export default function OverviewTab({ setActiveTab, dashboardMetrics, regulatoryData }) {
 ...
 {/* Metric Cards */}
 <Card className="rounded-2xl border-0 shadow-lg bg-gradient-to-br from-stone-50 to-white dark:to-gray-900">
 ...
 >
 <div className="text-2xl font-bold text-stone-600">{phase.count}</div>
