...
function TabLoadingFallback() {
 ...
 <Loader2 className="h-8 w-8 animate-spin text-stone-500 mx-auto" />
...
export default function StudyRegulatoryIntelligenceSuite() {
 ...
 <div className="p-3 bg-gradient-to-br from-stone-600 to-purple-600 rounded-2xl shadow-lg">
 <Brain className="h-7 w-7 text-white" />
 </div>
 <div>
 <h1 className="text-3xl font-bold bg-gradient-to-r from-stone-700 to-purple-600 bg-clip-text text-transparent">
 ...
 <Button
 className="rounded-xl bg-gradient-to-r from-stone-600 to-purple-600 hover:from-stone-700 hover:to-purple-700"
 ...
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-3">
 <div className="p-2 bg-gradient-to-br from-purple-500 to-stone-700 rounded-xl">
 ...
 <MessageSquare className="h-4 w-4 mt-1 text-stone-500" />
 ...
 size="icon"
 className="rounded-lg bg-gradient-to-r from-purple-500 to-stone-700 hover:from-purple-600 hover:to-stone-800"
