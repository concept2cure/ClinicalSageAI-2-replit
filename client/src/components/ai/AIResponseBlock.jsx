...
export function InlineCitation({ citation, index }) {
 ...
 bg-stone-100 text-stone-700 border border-stone-200 rounded-sm cursor-pointer
 hover:bg-stone-200 transition-colors align-super leading-none"
 ...
 <FileText className="h-4 w-4 text-stone-600 mt-0.5 shrink-0" />
 ...
 {citation.snippet && (
 <div className="bg-muted/50 rounded-md p-2 text-xs text-muted-foreground italic border-l-2 border-stone-300">
 &ldquo;
...
export function CitationList({ citations = [], className = '' }) {
 ...
 >
 <span className="inline-flex items-center justify-center h-4 min-w-[18px] px-1 text-[11px] font-bold bg-stone-100 text-stone-700 rounded-sm shrink-0 mt-0.5">
 {i + 1}
 </span>
