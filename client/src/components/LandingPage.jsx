...
export default function LandingPage() {
 ...
 className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-stone-900 opacity-40"
 />
 <motion.div
 initial={{ scale: 1 }}
 animate={{ scale: 1.2 }}
 transition={{ repeat: Infinity, duration: 20, ease: 'linear' }}
 className="absolute inset-0 bg-gradient-to-tr from-stone-800 via-transparent to-green-600 mix-blend-overlay"
 />
 </div>
 ...
 <Button
 size="lg"
 className="bg-gradient-to-r from-green-400 to-stone-600 text-black shadow-xl hover:scale-105 transform transition"
 >
 ...
 <Button
 size="lg"
 className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white shadow-xl hover:scale-105 transform transition"
 >
 ...
 size="lg"
 variant="outline"
 className="border-green-400 text-green-400 hover:bg-green-500 hover:text-black hover:border-transparent shadow-xl"
 >
 ...
 stat: '500+ pages',
 title: 'Static CSRs',
 desc: "PDFs nobody reads until it's too late.",
 icon: '/assets/icons/pdf.svg',
 },
 {
 stat: '$1M+',
 title: 'Consulting Fees',
 desc: 'Expensive, manual IND preparation.',
 icon: '/assets/icons/dollar.svg',
 },
 {
 stat: '4+ tools',
 title: 'Tool Silos',
 desc: 'No data flow, constant context switching.',
 icon: '/assets/icons/silo.svg',
 },
 {
 stat: '2.3x',
 title: 'Protocol Revisions',
 desc: 'Guesswork leads to costly amendments.',
 ...
 <Link
 to="/walkthroughs"
 className="text-white hover:text-stone-300 text-sm flex items-center"
 >
 ...
 <div className="absolute inset-0 bg-gradient-to-r from-stone-900 to-gray-900 opacity-70"></div>
 ...
 <Button
 size="lg"
 className="bg-gradient-to-r from-stone-600 to-teal-400 text-black shadow-2xl hover:scale-105 transform transition"
 >
