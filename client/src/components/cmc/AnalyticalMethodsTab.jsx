...
const AnalyticalMethodsTab = ({ openModal, onViewMethod }) => {
 ...
 <div className="animate-spin h-8 w-8 border-4 border-stone-200 border-t-stone-600 rounded-full mx-auto mb-4"></div>
 ...
 <h4 className="font-medium text-stone-800">CSV Data Import</h4>
 ...
 <div className="space-y-3">
 <h4 className="font-medium text-stone-800">Document Integration</h4>
 <div className="bg-white p-4 rounded-md border space-y-3">
 ...
 <h4 className="font-medium text-stone-800 mb-2">CSV Format Guide</h4>
 ...
 <div className="flex items-center gap-2">
 <div className="animate-spin h-4 w-4 border border-gray-300 border-t-stone-600 rounded-full"></div>
 Loading preview...
 </div>
 </div>
 ) : (
 ...
 {safety.numericOnly && (
 <Badge className="bg-stone-100 text-stone-800">Data Only</Badge>
 )}
 </div>
 ...
 <Badge
 variant="outline"
 className="border-stone-300 text-stone-700 hover:bg-stone-50 transition-colors"
 >
 <span className="mr-1">⚙</span>
 ...
 <Card
 key={method.id}
 className="shadow-sm hover:shadow-lg transition-all duration-300 hover:border-stone-200 cursor-pointer group"
 >
 <CardHeader className="pb-3">
 <div className="flex items-center justify-between">
 <div>
 <CardTitle className="text-lg font-semibold group-hover:text-stone-700 transition-colors">
 {method.code}
 </CardTitle>
 ...
 variant="outline"
 size="sm"
 className="transition-all duration-200 hover:bg-stone-50 hover:border-stone-300"
 >
 ...
 className="transition-all duration-200 hover:bg-stone-800"
 >
