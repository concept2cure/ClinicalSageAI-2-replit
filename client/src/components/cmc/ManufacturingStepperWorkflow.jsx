  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between relative">
        ...
        <div 
          className="absolute top-6 left-6 h-0.5 bg-blue-500 -z-10 transition-all duration-500"
          ...
          {WORKFLOW_PHASES.find(p => p.id === activePhase)?.sections.map(sectionId => {
            ...
            return (
              <button
                ...
                className="w-full p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-blue-300 hover:bg-blue-50 dark:hover:bg-blue-950 transition-colors text-left group"
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-sm group-hover:text-blue-700 dark:group-hover:text-blue-300">
