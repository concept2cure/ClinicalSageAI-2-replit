...
export function WorkflowCollaboration({ workflowId, currentUser = 'Current User' }) {
 ...
 notification.read ? 'bg-gray-50' : 'bg-stone-50 border-stone-200'
 }`}
 onClick={() => markNotificationRead(notification.id)}
 >
 <div className="flex items-start gap-3">
 <div
 className={`mt-1 ${notification.read ? 'text-gray-400' : 'text-stone-600'}`}
 >
 ...
 {!notification.read && (
 <div className="h-2 w-2 bg-stone-800 rounded-full mt-2" />
 )}
 </div>
 </div>
 ))}
