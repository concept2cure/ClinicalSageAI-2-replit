...
const SystemSuitabilityTrending = ({ methodId, onClose }) => {
 ...
 const parameters = {
 retentionTime: { label: 'Retention Time (min)', color: '#1c1917', unit: 'min' },
 ...
 peakArea: { label: 'Peak Area', color: '#1c1917', unit: 'counts' },
 rsdArea: { label: 'Area RSD (%)', color: '#292524', unit: '%' },
 ...
 <Scatter dataKey="value" fill="#78716c" />
 ...
 switch (trend) {
 case 'INCREASING':
 return <TrendingUp className="h-4 w-4 text-stone-600" />;
 case 'DECREASING':
 ...
 selectedParameter === key ? 'ring-2 ring-stone-400 bg-stone-50' : ''
 }`}
