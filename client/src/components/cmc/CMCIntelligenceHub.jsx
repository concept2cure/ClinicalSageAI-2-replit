...
const CMCIntelligenceHub = ({ organizationId = 7 }) => {
 ...
 <div className="text-center">
 <div className="text-2xl font-bold text-stone-600">94%</div>
 <p className="text-sm text-stone-700">Compliance Score</p>
 <Badge variant="outline" className="mt-1 text-xs bg-stone-100 text-stone-700">
 Above Target
 </Badge>
 </div>
 <div className="text-center">
 ...
 <div className="border rounded-lg p-4 bg-gradient-to-r from-purple-50 to-stone-50">
...
3. Update project timeline ➤`);
 ...
 {aiResponse && (
 <div className="p-4 border rounded-lg bg-gradient-to-r from-purple-50 to-stone-50 border-purple-200">
 ...
 <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-gradient-to-r from-green-50 to-stone-50 rounded-lg border border-green-200">
 <div className="text-center">
 ...
 <div className="text-center">
 <div className="text-2xl font-bold text-stone-600">96%</div>
 <p className="text-sm text-stone-700">After Gap Resolution</p>
 <Badge variant="outline" className="mt-1 text-xs bg-stone-100 text-stone-700">
 ...
 <p className="text-2xl font-bold text-stone-600">23</p>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-2xl font-bold text-stone-600">12</p>
