...
const ProcessTab = () => {
 ...
 <CardTitle className="text-sm font-medium text-stone-700">Stage 1: Design</CardTitle>
 </CardHeader>
 <CardContent>
 <div className="text-2xl font-bold text-stone-900">{validationData.overview.stage1}</div>
 <p className="text-xs text-stone-600 mt-1">Active processes</p>
 <Button 
 size="sm" 
 variant="ghost" 
 className="mt-2 w-full text-stone-700 hover:bg-stone-200"
 onClick={() => {
 setActiveTab('stage1');
 ...
 <Clipboard className="h-6 w-6 text-stone-600" />
 ...
 <div className="text-sm text-stone-600">Cp Index</div>
 <div className="text-2xl font-bold text-stone-900">1.67</div>
 <p className="text-xs text-stone-600 mt-1">Process capability</p>
 </CardContent>
 </Card>
 ...
 <Card className="bg-gradient-to-r from-stone-50 to-stone-100">
 <CardHeader className="pb-2">
 ...
 <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-gradient-to-r from-stone-50 to-green-50 rounded-lg border border-stone-200">
 <div className="text-center">
 <div className="text-2xl font-bold text-stone-600">28 days</div>
 <p className="text-sm text-stone-700">Critical Path Duration</p>
 <Badge variant="outline" className="mt-1 bg-stone-100 text-stone-800 border-stone-300">
 ...
 dep.status === 'in_progress' ? 'bg-stone-50 border-stone-200' :
