            ...
            <CardContent>
              {readinessLoading ? (
                ...
                <div className="space-y-6">
                  ...
                  {/* CTD Section Mapping */}
                  <div className="bg-blue-50 dark:bg-blue-100 rounded-lg p-4">
                    <h4 className="font-medium text-blue-900 mb-3">CTD Section Mapping</h4>
              ...
              {oeeLoading ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-100 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-blue-600" data-testid="oee-availability">
                  ...
                  {oeeData.recommendations && (oeeData.recommendations.immediate?.length > 0 || oeeData.recommendations.planned?.length > 0) && (
                    <div className="bg-blue-50 dark:bg-blue-100 rounded-lg p-4">
                      <h4 className="font-medium text-blue-900 mb-3">Quick Recommendations</h4>
                      <div className="space-y-2">
            ...
            <CardContent>
              {matrixLoading ? (
                ...
                <div className="space-y-6">
                  ...
                  {controlStrategy && (
                    <div className="bg-blue-50 dark:bg-blue-100 rounded-lg p-4">
                      <h4 className="font-medium text-blue-900 mb-3">Generated Control Strategy [CTD: {controlStrategy.ctdMapping}]</h4>
                      
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                          <h5 className="font-medium text-blue-800 mb-2">Monitoring Plan</h5>
                        ...
                        <div>
                          <h5 className="font-medium text-blue-800 mb-2">Alarm Actions</h5>
                          <ul className="text-sm space-y-1">
            ...
            <CardContent>
              {bomLoading ? (
                ...
                <div className="space-y-4">
                  ...
                  {/* Alternates Display */}
                  {alternates && (
                    <div className="bg-blue-50 dark:bg-blue-100 rounded-lg p-4 mt-4">
                      <h4 className="font-medium text-blue-900 mb-3">Alternative Suppliers</h4>
                      <div className="space-y-2">
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-white dark:bg-gray-50">
            ...
            <CardContent>
              {ebrTimeline ? (
                <div className="space-y-4">
                  <div className="bg-blue-50 dark:bg-blue-100 rounded-lg p-3 mb-4">
                    <h4 className="font-medium text-blue-900">Batch: {ebrTimeline.timeline[0]?.batchId}</h4>
                  </div>
              ...
              {stabilityLoading ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="bg-blue-50 dark:bg-blue-100 rounded-lg p-4">
                      <h4 className="font-medium text-blue-900 mb-3">Trends & Projection</h4>
              ...
              {loading ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-100 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {deltaMatrix.comparisonSites.map((site) => (
                        <div key={site.id} className={`p-4 rounded-lg border-2 ${site.status === 'Reference Site' ? 'border-blue-300 bg-blue-50' : 'border-green-300 bg-green-50'}`}>
                          <div className="flex items-center justify-between mb-2">
                        ...
                        <tbody>
                          {deltaMatrix.deltaAnalysis.map((item, index) => (
                            <tr key={index} className="border-b hover:bg-gray-50">
                              ...
                              <td className="p-3 text-sm text-blue-700">{item.ppqRecommendation}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                  ...
                  <div className="bg-blue-50 dark:bg-blue-100 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h5 className="font-medium text-blue-800 mb-2">PPQ Strategy</h5>
                        <p className="text-sm text-blue-700 mb-3">{deltaMatrix.aiRecommendations.ppqStrategy}</p>
                        
                        <h5 className="font-medium text-blue-800 mb-2">Critical Parameters</h5>
                      ...
                      <div>
                        <h5 className="font-medium text-blue-800 mb-2">Additional Studies</h5>
                        ...
                        <h5 className="font-medium text-blue-800 mb-2">Timeline</h5>
                        <p className="text-sm text-blue-700">{deltaMatrix.aiRecommendations.timeline}</p>
                      </div>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                      {rcaData.capaRecommendations.map((capa) => (
                        <div key={capa.id} className="bg-white rounded-lg p-4 border border-blue-200">
                          <div className="flex items-start justify-between mb-3">
                            <div>
                              <h5 className="font-medium text-blue-800">{capa.id}</h5>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
                            ...
                            <div>
                              ...
                              <div className="text-blue-600">{capa.ctdSection}</div>
                            </div>
                          </div>
                        </div>
                      ))}
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-100 rounded-lg p-4">
                    ...
                    {regionPresets[selectedRegion].serialization.required && (
                      <div className="mt-4 p-3 bg-blue-50 rounded">
                        <h5 className="font-medium text-blue-800 mb-2">Serialization</h5>
                  ...
                  {generatedLabels && (
                    <div className="bg-green-50 rounded-lg p-4">
                      ...
                      <div className="mt-4 p-3 bg-blue-50 rounded">
                        <h5 className="font-medium text-blue-900 mb-2">Validation Results</h5>
                    ...
                    {deficiencyLetter.deficiencies.map((deficiency) => (
                      <div key={deficiency.id} className="border rounded-lg p-4">
                        ...
                        <div className="bg-blue-50 rounded p-3">
                          ...
                          <p className="text-sm text-blue-700">{deficiency.recommendation}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                      ...
                      <div key={task.id} className="border rounded-lg p-4 hover:bg-gray-50">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-sm mb-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-blue-600">{task.ctdSection}</div>
                          </div>
                          <div>
                      ...
                      <div key={entry.id} className="border rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm mb-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-blue-600">E-Sign: {entry.electronicSignature}</div>
                          </div>
                        </div>
                        ...
                        <div className="bg-gray-50 rounded p-3 mb-3">
                          ...
                          {entry.section && (
                            <div className="text-xs text-blue-600 mt-1">CTD Section: {entry.section}</div>
                          )}
                        </div>
                              ...
                              {entry.approvals.map((approval, idx) => (
                                <div key={idx} className="flex items-center justify-between">
                                  ...
                                  <div className="text-right">
                                    ...
                                    <div className="text-xs text-blue-600">{approval.signature}</div>
                                  </div>
                                </div>
                              ))}
                            </div>
                ...
                {['design', 'validate', 'publish'].map(phase => (
                  <button
                    ...
                    className={`w-full p-3 rounded-lg text-left transition-all ${
                      activePhase === phase 
                        ? 'bg-blue-100 dark:bg-blue-100 border-2 border-blue-300 dark:border-blue-400' 
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {activePhase === phase && <CheckCircle2 className="w-4 h-4 text-blue-600" />}
                    </div>
                  </button>
                ))}
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    {activeSection_obj?.icon && (
                      <activeSection_obj.icon className="w-6 h-6 text-blue-600 dark:text-blue-400" />
                    )}
                    <div>
