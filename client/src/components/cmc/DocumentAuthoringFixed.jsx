          ...
          {items.map(it => (
            <li key={it.item_id} className="border rounded p-2 text-sm">
              ...
              <div className="mt-1 flex items-center gap-2">
                ...
                {it.evidence_cite && (
                  <button className="text-xs text-blue-600" onClick={() => jump(it.evidence_cite)}>
                    View Evidence
                  </button>
                )}
              </div>
      ...
      <div className="absolute right-0 top-0 h-full w-[600px] bg-white shadow-xl p-4 overflow-y-auto">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex gap-2">
            <button
              className="border px-3 py-1 rounded text-sm bg-blue-50"
              onClick={() => onCreateNew()}
            >
              + New CR
            </button>
          ...
          {crs.map(cr => (
            <li key={cr.cr_id} className="border rounded p-3">
              ...
              <div className="flex gap-1">
                ...
                {cr.status === 'APPROVED' && (
                  <button
                    className="border px-2 py-0.5 rounded text-xs bg-blue-50"
    ...
    <div className="fixed inset-0 z-50 bg-black/30 flex items-center justify-center">
      <div className="bg-white rounded-lg p-4 w-[500px] max-h-[80vh] overflow-y-auto">
        ...
        <div className="flex justify-end gap-2 mt-4">
          ...
          <button className="border px-4 py-2 rounded bg-blue-50" onClick={submit}>
            Create Request
          </button>
        </div>
      </div>
