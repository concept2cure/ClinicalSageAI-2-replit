...
const CMCAuditAndDocumentation = ({ organizationId = 7 }) => {
 ...
 <div className="flex space-x-2">
 <Button className="bg-stone-800 hover:bg-stone-900" data-testid="button-new-document">
 ...
 {[
 { category: 'Method Development', count: 156, color: 'bg-stone-100 text-stone-700' },
 ...
 <div>
 <p className="text-2xl font-bold text-stone-600">127</p>
