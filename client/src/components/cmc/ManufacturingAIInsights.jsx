...
function FindingCard({ finding, onEditResponse }) {
 ...
 <span className="w-1.5 h-1.5 bg-stone-700 rounded-full flex-shrink-0 mt-2"></span>
 <span>{action}</span>
 </li>
 ))}
 </ul>
...
function DeficiencyCard({ deficiency }) {
 ...
 <div className="border-l-4 border-stone-500 pl-4 py-2 bg-stone-50 dark:bg-stone-50 rounded-r-md">
 <h4 className="text-sm font-medium text-stone-900 dark:text-stone-800 mb-2">Draft Response:</h4>
 <p className="text-sm text-stone-800 dark:text-stone-700 leading-relaxed whitespace-pre-line">
 {deficiency.draftResponse}
 </p>
 </div>
 )}
...
export default function ManufacturingAIInsights() {
 ...
 <Card>
 <CardContent className="p-4 text-center">
 <div className="text-2xl font-bold text-stone-600">{stats.avgConfidence}%</div>
 ...
 <RefreshCw className="w-8 h-8 animate-spin mx-auto mb-4 text-stone-600" />
