        ...
        <Container className="relative z-10 text-center px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/persona/regops">
              <Button
                size="lg"
                className="bg-gradient-to-r from-green-400 to-blue-500 text-black shadow-xl hover:scale-105 transform transition"
              >
      ...
      <section className="relative py-24">
        ...
        <Container className="relative z-10 flex flex-col lg:flex-row items-center justify-between">
          ...
          <Link to="/persona/clinops">
            <Button
              size="lg"
              className="bg-gradient-to-r from-blue-500 to-teal-400 text-black shadow-2xl hover:scale-105 transform transition"
            >
