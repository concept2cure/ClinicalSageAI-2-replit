...
export default function ModuleSectionEditor({
 ...
 <Card
 className={`border-2 ${syncPulse ? 'animate-pulse border-stone-500' : 'border-gray-200'} transition-all duration-500`}
 >
 <CardHeader className="pb-3">
 <div className="flex items-center justify-between">
 <CardTitle className="text-lg flex items-center gap-2">
 <Activity
 className={`h-5 w-5 ${syncPulse ? 'text-stone-500 animate-pulse' : 'text-gray-500'}`}
 />
 ...
 <span className="h-2 w-2 bg-stone-700 rounded-full mt-1 animate-pulse" />
 <div>
