...
export default function VaultConciergeAI() {
    ...
    try {
      ...
      setMessages(prev => [
        ...prev,
        {
          role: 'assistant',
          content:
            "I apologize, but I'm having trouble connecting to my knowledge base at the moment. Please try again in a moment or contact our team directly at support@trialsage.com.",
        },
      ]);
      setSuggestions(['Try again', 'Contact support', 'Learn more about Vault']);
    } finally {
      setIsTyping(false);
    }
  };
  ...
  const renderMessageContent = content => {
    ...
    return parts.map((part, index) => {
      ...
      return part.split(/(\*\*.*?\*\*)/g).map((text, i) => {
          ...
          >
            ...
            <div className="bg-gradient-to-r from-green-700 to-green-600 px-4 py-3 flex justify-between items-center">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-white font-medium text-sm">Vault™ Concierge</h3>
