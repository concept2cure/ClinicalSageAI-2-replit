...
Contact system administrator if the problem persists.` });
 ...
 <div className="animate-spin h-8 w-8 border-2 border-stone-500 border-t-transparent rounded-full"></div>
 ...
 <CardHeader>
 <CardTitle className="flex items-center text-lg">
 <BarChart3 className="h-5 w-5 mr-2 text-stone-600" />
 ...
 <div className="text-sm text-stone-600">Prevention Value</div>
 </div>
 ...
 <div className="animate-spin h-12 w-12 border-4 border-stone-500 border-t-transparent rounded-full"></div>
 ...
 <div className="flex-shrink-0 w-6 h-6 bg-stone-100 text-stone-600 rounded-full flex items-center justify-center text-sm font-medium">
 {index + 1}
 </div>
