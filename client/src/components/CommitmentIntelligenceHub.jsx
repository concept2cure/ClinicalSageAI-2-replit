...
const CommitmentIntelligenceHub = ({ open, onOpenChange }) => {
 ...
 <Brain className="h-6 w-6 mr-3 text-stone-600" />
 ...
 className={`${activeTab === 'extract' ? 'bg-stone-50 border-stone-200' : ''}`}
 >
 ...
 className={`${activeTab === 'results' ? 'bg-stone-50 border-stone-200' : ''}`}
 >
 ...
 className={`${activeTab === 'tracking' ? 'bg-stone-50 border-stone-200' : ''}`}
 >
 ...
 className={`${activeTab === 'intelligence' ? 'bg-stone-50 border-stone-200' : ''}`}
 >
 ...
 <Zap className="h-5 w-5 mr-2 text-stone-600" />
 ...
 <div className="mt-2 p-6 border-2 border-dashed border-gray-300 rounded-lg text-center hover:border-stone-400 transition-colors">
 <input
 type="file"
 ...
 {uploadedFile && (
 <div className="mt-3 p-2 bg-stone-50 rounded">
 ...
 <RefreshCw className="h-6 w-6 animate-spin text-stone-600 mr-2" />
 ...
 <FileText className="h-4 w-4 mr-3 text-stone-600 flex-shrink-0" />
 ...
 <Badge
 variant="outline"
 className="ml-3 flex-shrink-0 text-xs bg-stone-50 text-stone-700 border-stone-200"
 >
 {file.type}
 </Badge>
 </div>
 ...
 className="w-full bg-gradient-to-r from-stone-700 to-purple-600 hover:from-stone-800 hover:to-purple-700 text-white"
 size="lg"
 >
 {isProcessing ? (
 <>
 ...
 <svg
 className="animate-spin h-6 w-6 text-stone-600"
 xmlns="http://www.w3.org/2000/svg"
 fill="none"
 viewBox="0 0 24 24"
 >
 ...
 className="border-l-4 border-l-stone-500 transition-all duration-300 ease-in-out hover:shadow-lg hover:scale-[1.02] bg-white shadow-md"
 >
 ...
 <div className="mt-2 p-3 bg-stone-50 border border-stone-200 rounded-lg text-sm">
 ...
 <div className="mb-4 p-4 bg-gradient-to-r from-stone-50 to-indigo-50 rounded-lg border border-stone-200">
 ...
 >
 <SelectTrigger className="w-full h-10 text-sm transition-all duration-200 ease-in-out border-2 border-stone-300 hover:border-stone-500 focus:border-stone-700">
 <SelectValue
 className={`font-bold ${
 ...
 <AlertCircle className="h-4 w-4 mr-2 text-stone-600" />
 ...
 <h5 className="font-semibold text-stone-800 mb-2 flex items-center">
 ...
 <button
 onClick={() => setActiveTab('results')}
 className="text-stone-600 hover:underline ml-2 text-xs font-medium"
 >
 ...
 <div className="p-4 bg-stone-50 rounded-lg border border-stone-200 shadow-sm">
 <h4 className="font-semibold text-stone-800 mb-3 flex items-center">
 ...
 (strategy, idx) => (
 <div key={idx} className="flex items-start text-sm text-stone-700">
 <CheckCircle className="h-4 w-4 mr-2 mt-1 flex-shrink-0 text-stone-500" />
 <div className="flex-1">
 <span>{strategy}</span>
 <button
 onClick={() => {
 ...
 <div className="text-xs text-stone-700">Analyzed Commitments</div>
 </div>
 <div className="text-center">
 <div className="text-2xl font-bold text-green-600">
 ...
 {enhancedAnalytics.overview && (
 <>
 <div className="flex items-start p-3 bg-stone-50 rounded">
 <TrendingUp className="h-4 w-4 text-stone-500 mr-2 mt-1 flex-shrink-0" />
 ...
 <div className="bg-gradient-to-r from-stone-50 to-purple-50 p-4 rounded-lg border border-stone-200">
 <div className="flex items-center justify-between">
 <div>
 <h5 className="font-semibold text-stone-800">Analytics Summary</h5>
 ...
 <div className="text-xs text-stone-600">Overall Health Score</div>
 </div>
 </div>
 </div>
 </div>
 ...
 <BarChart3 className="h-8 w-8 text-stone-500 mr-3 animate-pulse" />
 <RefreshCw className="h-8 w-8 text-stone-500 animate-spin" />
 </div>
 ...
 <h3 className="font-semibold text-stone-800 mb-2">🎯 Commitment Being Analyzed</h3>
