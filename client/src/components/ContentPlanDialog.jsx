...
const ContentPlanDialog = ({ isOpen, onClose, contentPlanData, isLoading }) => {
 ...
 >
 <div className="flex-shrink-0 w-6 h-6 bg-stone-100 rounded-full flex items-center justify-center text-sm font-medium text-stone-600">
 {index + 1}
 </div>
 ...
 <div
 key={index}
 className="flex items-start gap-2 p-2 bg-stone-50 rounded text-sm"
 >
 <CheckCircle className="h-4 w-4 text-stone-600 mt-0.5 flex-shrink-0" />
 {rec}
 </div>
 )
 )}
