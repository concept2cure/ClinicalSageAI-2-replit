...
const ExecutiveDashboard = () => {
 ...
 <Card className="bg-gradient-to-br from-stone-50 to-white border-stone-100 shadow-sm">
 <CardHeader className="pb-2">
 <CardTitle className="text-lg flex items-center text-stone-700">
 ...
 <span className="text-3xl font-bold text-stone-700">85%</span>
 </div>
 </div>
 </div>
 ...
 <ShieldCheck className="h-5 w-5 mr-2 text-stone-600" />
 ...
 <div className="w-full bg-gray-200 h-2 rounded-full">
 <div className="bg-stone-700 h-2 rounded-full" style={{ width: '67%' }}></div>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="border rounded p-2 bg-stone-50 border-stone-100">
 <div className="flex justify-between">
 <span className="font-medium text-sm">Update Literature Review</span>
 <span className="text-stone-600 text-xs bg-stone-100 px-1.5 py-0.5 rounded">
 Low
 </span>
 </div>
 <p className="text-xs text-gray-600 mt-1">
