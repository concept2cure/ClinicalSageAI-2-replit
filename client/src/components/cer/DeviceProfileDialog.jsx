...
const DeviceProfileDialog = ({
 ...
 <Badge className="bg-stone-800 text-white text-xs px-2 py-1 rounded-full">
 Step 1
 </Badge>
 </div>
 )}
 ...
 <DialogTitle className="text-xl font-semibold text-stone-900">{dialogTitle}</DialogTitle>
 {existingData && (
 <Badge
 variant="outline"
 className="flex items-center gap-1 text-stone-600 border-stone-200 px-2 py-1 w-fit"
 >
 ...
 <DialogDescription className="mt-2 text-stone-700">{dialogDescription}</DialogDescription>
 {existingData && (
 ...
 <div className="animate-spin h-8 w-8 border-4 border-stone-700 border-t-transparent rounded-full mb-2"></div>
 <p className="text-stone-800 font-medium">Saving device profile...</p>
 </div>
 </div>
 )}
 </DialogContent>
