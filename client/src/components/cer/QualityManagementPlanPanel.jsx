...
`
 ...
 objectiveRefs.current[targetObjective.id].style.borderTop = '3px dashed #292524';
 }
 };
 ...
 <h3 className="text-lg font-semibold text-[#292524]">{planMetadata.planName}</h3>
 ...
 size="sm"
 variant="outline"
 className="flex items-center text-sm ml-2 bg-[#292524] text-white hover:bg-[#292524]/90 hover:text-white"
 >
 ...
 <FileText className="mr-2 h-5 w-5 text-[#292524]" />
 Plan Metadata
 ...
 <BarChart3 className="mr-2 h-5 w-5 text-[#292524]" />
 ...
 <Card className="shadow-none border-l-4 border-l-stone-500">
 <CardHeader className="p-3 pb-0">
 <CardTitle className="text-sm text-[#141413]">Quality Objectives</CardTitle>
 </CardHeader>
 <CardContent className="p-3 pt-1">
 <div className="text-2xl font-bold text-[#292524]">{metrics.totalObjectives}</div>
 ...
 <Card className="shadow-none border-l-4 border-l-[#292524]">
 <CardHeader className="p-3 pb-0">
 <CardTitle className="text-sm text-[#141413]">Critical-to-Quality Factors</CardTitle>
 </CardHeader>
 <CardContent className="p-3 pt-1">
 <div className="text-2xl font-bold text-[#292524]">{metrics.totalCtqFactors}</div>
 ...
 key={section}
 variant="outline"
 className="bg-[#faf0ec] text-[#292524] border-[#292524] text-xs"
 >
 {section}
 </Badge>
 ))}
 ...
 <div className="text-xs text-[#6b6963] mt-1 flex items-center">
 <LinkIcon className="h-3 w-3 mr-1 text-[#292524]" />
 ...
 <div className="text-xs text-[#6b6963] mt-1 flex items-center">
 <FileCheck className="h-3 w-3 mr-1 text-[#292524]" />
 ...
 <Shield className="h-4 w-4 mr-1 text-[#292524]" />
 ...
 {isGenerating ? (
 <>
 <div className="animate-spin rounded-full h-3 w-3 border-b-2 border-[#292524] mr-1"></div>
 Generating...
 </>
 ) : (
 <>
 ...
 <div className="bg-[#faf0ec] rounded-md px-3 py-1 text-sm inline-flex items-center gap-1 text-[#292524]">
 ...
 <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#292524]"></div>
 </div>
 ) : (
 <>
 {objectives.length > 0 ? (
 ...
 <Button
 size="sm"
 className="w-full mt-2 h-7 text-xs bg-[#292524] text-white hover:bg-[#292524]/90"
 ...
 variant="ghost"
 size="sm"
 className="h-8 px-2 text-[#292524]"
 >
 ...
 variant="outline"
 size="sm"
 className="h-8 bg-transparent text-[#292524] border-[#292524]"
 >
 <Plus size={14} className="mr-1" />
 Add CtQ Factor
 </Button>
 ...
 currentObjective.scopeSections?.includes(section)
 ? 'bg-[#292524] hover:bg-[#0E5CA8] text-white'
 ...
 <Button onClick={handleSaveObjective} className="bg-[#292524] hover:bg-[#0E5CA8]">
 ...
 className="mt-4 bg-[#292524] hover:bg-[#0E5CA8]"
 >
 ...
 {associatedObjective && (
 <CardDescription className="text-xs text-[#292524]">
 ...
 <FileText className="h-3 w-3 mr-1 text-[#292524]" />
 <p className="text-xs font-medium text-[#292524]">
 ...
 <div className="bg-[#faf0ec] rounded-md px-2 py-0.5 text-xs text-[#292524]">
 Direct Link
 </div>
 </div>
 ...
 <Badge className="bg-stone-100 text-stone-800 px-2 py-0 text-xs">
 Verified
 </Badge>
 </div>
 </div>
 ...
 className="bg-[#292524] hover:bg-[#0E5CA8]"
 disabled={objectives.length === 0}
 >
 <Save size={16} className="mr-1" />
 Save CtQ Factor
 ...
 variant="outline"
 className="mr-2 bg-transparent text-[#292524] hover:bg-[#FDF6FA] border-[#F9D8E8]"
 disabled={objectives.length === 0 || isValidating}
 >
 {isValidating ? (
 <>
 <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-[#292524] mr-2"></div>
 Validating...
 </>
 ) : (
 <>
 ...
 variant="outline"
 className="mr-2 bg-transparent text-[#292524] hover:bg-[#faf0ec] border-[#D1E5FA]"
 >
