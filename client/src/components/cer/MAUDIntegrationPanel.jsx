...
const MAUDIntegrationPanel = ({ documentId = '123456' }) => {
 ...
 <Loader2 className="w-6 h-6 text-stone-600 animate-spin mr-2" />
 ...
 <ShieldCheck className="mr-2 h-5 w-5 text-stone-600" />
 ...
 <>
 <Card>
 <CardHeader className="bg-gradient-to-r from-stone-50 to-white pb-2">
 <div className="flex justify-between items-center">
 <CardTitle className="text-lg text-stone-700">MAUD Validation Summary</CardTitle>
 ...
 <div className="bg-stone-50 p-3 rounded-lg border-stone-100 border">
 ...
 <Loader2 className="w-12 h-12 text-stone-600 animate-spin mx-auto mb-4" />
 ...
 <CardHeader className="bg-gradient-to-r from-stone-50 to-white pb-2">
 <div className="flex justify-between items-center">
 <CardTitle className="text-lg text-stone-700">Validation History</CardTitle>
 <Button
 variant="outline"
 size="sm"
 className="text-xs"
 ...
 <Loader2 className="w-5 h-5 text-stone-600 animate-spin mr-2" />
 ...
 key={alg.id || alg}
 variant="outline"
 className="bg-stone-50 text-stone-800 text-xs px-1.5 py-0.5"
 >
 {alg.name || alg}
 {alg.version && (
 ...
 <div className="bg-stone-50 p-3 rounded-md border border-stone-100 text-sm text-stone-800">
 ...
 <div className="py-4">
 <div className="bg-stone-50 border border-stone-100 rounded-md p-3 mb-4">
 <h4 className="text-sm font-medium text-stone-800 mb-1">Certificate Details</h4>
 ...
 <FileText className="h-10 w-10 mx-auto text-stone-600 mb-3" />
