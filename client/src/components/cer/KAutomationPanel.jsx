...
export default function KAutomationPanel() {
 ...
 {sidebarCollapsed && <LayoutDashboard className="h-5 w-5 text-stone-700" />}
 </div>
 <Button
 variant="ghost"
 size="sm"
 ...
 className={`flex items-center justify-${sidebarCollapsed ? 'center' : 'start'} mb-1 ${selectedModule === '510k' ? 'bg-stone-100 text-stone-800' : ''}`}
 ...
 className={`flex items-center justify-${sidebarCollapsed ? 'center' : 'start'} mb-1 ${selectedModule === 'cer' ? 'bg-stone-100 text-stone-800' : ''}`}
 ...
 <Badge className="ml-auto text-xs bg-stone-100 text-stone-800 hover:bg-stone-200">
 ...
 <button
 className="w-full text-left px-2 py-1.5 rounded hover:bg-gray-50 text-sm flex items-center text-stone-600"
 onClick={() => {
 ...
 <div className="p-4 border-b border-gray-200">
 <h2 className="text-lg font-semibold text-gray-800 flex items-center">
 <ClipboardList className="h-5 w-5 mr-2 text-stone-600" />
 CER Generator
 </h2>
 </div>
 ...
 <AvatarFallback className="bg-stone-800 text-white">TR</AvatarFallback>
 </Avatar>
 </div>
 </div>
 ...
 <div className="border rounded-lg p-6 bg-stone-50 border-stone-100 text-center">
 ...
 <div className="border rounded-lg p-4">
 <h3 className="text-md font-medium text-gray-700 mb-3 flex items-center">
 <ClipboardList className="h-4 w-4 mr-2 text-stone-600" />
 ...
 className="bg-stone-800 hover:bg-stone-900 text-white ml-4"
 >
 ...
 <div className="border rounded-lg p-6 bg-stone-50 border-stone-100 text-center">
 <Search className="h-12 w-12 text-stone-500 mx-auto mb-3" />
 <h3 className="text-lg font-medium text-gray-800 mb-2">
 ...
 <div className="border rounded-lg p-6 bg-stone-50 border-stone-100 text-center">
 <ClipboardCheck className="h-12 w-12 text-stone-500 mx-auto mb-3" />
 <h3 className="text-lg font-medium text-gray-800 mb-2">
 ...
 <div className="bg-stone-800 h-2.5 rounded-full w-3/4"></div>
 </div>
 </div>
