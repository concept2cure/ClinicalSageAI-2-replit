 ...
 */
 ...
 return (
 <div className="space-y-6">
 <Alert className="mb-6 bg-stone-50 border-stone-200">
 <CheckCircle className="h-4 w-4 text-stone-500" />
 <AlertTitle className="text-stone-700">Real FDA Data Analysis</AlertTitle>
 ...
 */
 ...
 <div className="bg-stone-100 rounded-full p-1 mr-2 mt-0.5">
