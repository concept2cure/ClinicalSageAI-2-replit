...
const DeviceProfileList = ({ onSelectProfile }) => {
 ...
 const variants = {
 I: { variant: 'outline', color: 'text-stone-600 border-stone-200' },
 ...
 <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-stone-700 mb-2"></div>
 <p className="text-stone-600 font-medium">Loading device profiles...</p>
 </div>
 </div>
 </CardContent>
 </Card>
 ...
 <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 border-b bg-gradient-to-r from-stone-50 to-white">
 <div>
 ...
 <CardDescription>
 <span className="font-semibold text-stone-700">REQUIRED FIRST STEP:</span> Create or
 ...
 buttonClassName="bg-stone-800 hover:bg-stone-900 text-white"
 ...
 <Badge className="bg-stone-100 text-stone-800 border-stone-200 hover:bg-stone-100">
 ...
 key={classNum}
 variant="outline"
 className={`cursor-pointer ${filterClass === classNum ? 'bg-stone-100 border-stone-300' : ''}`}
 ...
 <div className="p-3 bg-stone-50 rounded-lg border border-stone-100 mb-5 max-w-xl mx-auto">
 <h4 className="font-medium text-stone-800 mb-2">FDA 510(k) Submission Process:</h4>
