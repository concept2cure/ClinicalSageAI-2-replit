...
export default function ApprovalsPanel() {
 ...
 <UserCheck className="mr-2 h-5 w-5 text-stone-600" />
 Approvals Workflow
 </h3>
 ...
 <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-stone-50 p-4 rounded-md">
 <div>
 <h4 className="font-medium text-stone-800">Document Approval Status</h4>
 ...
 {docType.pendingApprovals === 0 && (
 <Button className="bg-stone-900 hover:bg-stone-950">
 ...
 <div className="h-10 w-10 rounded-full bg-stone-100 flex items-center justify-center mr-3">
