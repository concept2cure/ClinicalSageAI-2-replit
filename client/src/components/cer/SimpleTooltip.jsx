...
const SimpleTooltip = ({
 ...
 <HelpCircle size={16} className="text-stone-500 cursor-help" />
 </div>
 ) : null;
 ...
 <TooltipContent
 side={placement}
 className={`${widthClasses[width]} p-0 overflow-hidden bg-white border-stone-100 shadow-lg`}
 >
 <div className="flex flex-col">
 {/* Header */}
 <div className="flex items-center justify-between bg-stone-50 p-2 border-b border-stone-100">
