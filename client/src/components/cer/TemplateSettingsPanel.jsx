...
export default function TemplateSettingsPanel() {
 ...
 : template.highlight
 ? 'border-stone-300 bg-stone-50/40 shadow-md hover:shadow-lg'
 : 'border-gray-200 hover:border-stone-300 hover:bg-stone-50/50'
 }`}
 ...
 {selectedTemplate === template.id && (
 <div className="bg-stone-700 text-white rounded-full p-1">
 ...
 <h4 className="font-medium text-stone-700 mb-2">Preview Updates</h4>
