...
/**
 * Micro Batch Import for TrialSage
 *
 * This script imports a very small batch of 25 Health Canada trials
...
Batches completed: ${trackingData.batchesCompleted}
Total imported: ${trackingData.totalImported}
Remaining: ${TARGET_TOTAL - newHCCount}
...
// Run the script
runMicroBatch().catch(console.error);
