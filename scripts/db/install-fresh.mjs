  ...
  await step('3/7 Complete schema — raw migration overlay', async () => {
    ...
    const CLASSIFIED_OVERLAY_SKIPS = new Map([
      ...
      ['20260730_workflow_doc_versions_org_id.sql',
        'ALTERs workflow_document_versions, whose create depends on unified_documents — same C-29 collision as 0004/0007; applies once unified_documents is provisioned (issue #1239)'],
      ['20260731_workflow_doc_versions_org_not_null.sql',
        'NOT NULL org scope on workflow_document_versions — same unified_documents C-29 dependency as 20260730_workflow_doc_versions_org_id (issue #1239)'],
