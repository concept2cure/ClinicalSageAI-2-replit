    ...
    return (
      ...
      >
        <div className="flex items-center gap-3 truncate">
          ...
          <span className="truncate font-medium text-gray-500">No Clients Available</span>
        </div>
            ...
            <CommandGroup>
              ...
              {filteredClientWorkspaces.map(client => (
                <CommandItem
                  ...
                  className="mx-2 mb-1 rounded-md px-3 py-2.5 text-sm cursor-pointer hover:bg-gray-50 data-[selected]:bg-blue-50 data-[selected]:text-blue-900"
                >
                  <div className="flex items-center gap-3 truncate flex-1">
                    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br from-blue-100 to-indigo-100 text-blue-600">
                      <Building2 className="h-4 w-4" />
                    </div>
                    <div className="flex flex-col truncate">
                      <span className="truncate font-medium text-gray-900">{client.name}</span>
